...
- `BridgeSeeder.cs` — Class: BridgeSeeder (~1638 tok)

## accelerators/bridge/Sunfish.Bridge/Authorization/

- `DemoTenantContext.cs` — DEMO ONLY. Provides a hardcoded tenant/user identity for local development. Replace with a real <see (~415 tok)
