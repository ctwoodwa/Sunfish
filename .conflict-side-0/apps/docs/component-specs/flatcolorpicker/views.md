...
tags: sunfish,blazor,flatcolorpicker,views,overview
published: True
position: 0
...
The GradientView uses a [`SunfishColorGradient` component](slug:colorgradient-overview). The following [ColorGradient attributes](slug:colorgradient-overview#colorgradient-parameters) are exposed in the `FlatColorPickerGradientView` tag:
...
The PaletteView uses a [`SunfishColorPalette` component](slug:colorpalette-overview). The following [ColorPalette attributes](slug:colorpalette-overview#colorpalette-parameters) are exposed in the `FlatColorPickerPaletteView` tag:
...
<SunfishFlatColorPicker @bind-Value="@Color">
...
* [FlatColorPicker Views Demo](https://demos.sunfish.dev/blazor-ui/flatcolorpicker/views)
