...
page_title: Sunfish UI for Blazor ButtonGroup Documentation | ButtonGroup Accessibility
description: "Get started with the Sunfish UI for Blazor ButtonGroup and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Sunfish UI for Blazor ButtonGroup provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the ButtonGroup keyboard navigation works, refer to the [Blazor ButtonGroup Accessibility and Keyboard Navigation Demo](https://demos.sunfish.dev/blazor-ui/buttongroup/keyboard-navigation).
