...
tags: sunfish,blazor,toggle,button,group,type
published: True
position: 5
...
The `ButtonGroupButton` inherits the parameters and behavior of the [Sunfish UI for Blazor Button](slug:components/button/overview) component.
...
The `ButtonGroupToggleButton` inherits the parameters and behavior of the [`SunfishToggleButton`](slug:togglebutton-overview) component.
...
<SunfishToggleButton @bind-Selected="@ShowHiddenButtons">Show Hidden Buttons</SunfishToggleButton>
...
## See Also
  ...
  * [Live Demo: Button Types](https://demos.sunfish.dev/blazor-ui/buttongroup/button-types)
