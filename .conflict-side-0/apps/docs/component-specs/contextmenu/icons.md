...
tags: sunfish,blazor,context menu,icon,iconclass,image
published: True
position: 15
...
You can add [Sunfish Font or SVG icons](slug:common-features-icons) to the ContextMenu items. The component also supports custom icons.
...
>caption How to use icons in Sunfish Context Menu
...
<SunfishContextMenu Data="@MenuData"
...
* [Online Demo: Context Menu Icons](https://demos.sunfish.dev/blazor-ui/contextmenu/icons)
