...
slug: fab-appearance
tags: sunfish,blazor,floating action button, appearance
published: True
position: 1
...
<div class="k-flex-basis-auto">
    <label>
        Theme Color
        <SunfishDropDownList Data="@ThemeColors" @bind-Value="@ThemeColor">
    ...
    <label>
        Rounded
        <SunfishDropDownList Data="@RoundedValues" @bind-Value="@Rounded">
            <DropDownListSettings>
                <DropDownButtonPopupSettings MaxHeight="auto" />
            </DropDownListSettings>
        </SunfishDropDownList>
    ...
    <label>
        Size
        <SunfishDropDownList Data="@Sizes" @bind-Value="@Size">
            <DropDownListSettings>
                <DropDownButtonPopupSettings MaxHeight="auto" />
            </DropDownListSettings>
        </SunfishDropDownList>
...
<SunfishFloatingActionButton ThemeColor="@ThemeColor"
                             Rounded="@Rounded"
                             Size="@Size"
...
* [Appearance - Design System Docs](https://sunfish.dev/design-system/docs/components/floatingactionbutton/#appearance)