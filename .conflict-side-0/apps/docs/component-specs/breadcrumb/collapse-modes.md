...
tags: sunfish,blazor,breadcrumb,collapse,modes
published: True
position: 20
...
<div style="width:400px">
    <SunfishBreadcrumb CollapseMode="@BreadcrumbCollapseMode.Wrap"
                       Data="@Items">
    </SunfishBreadcrumb>
</div>
...
* [Live Demo: Breadcrumb Collapse Modes](https://demos.sunfish.dev/blazor-ui/breadcrumb/collapse-modes)