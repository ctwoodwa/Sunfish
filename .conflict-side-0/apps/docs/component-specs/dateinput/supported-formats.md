...
tags: sunfish,blazor,DateInput,format,formats
published: true
position: 5
...
This article explains the format strings and specifiers supported by the Sunfish DateInput for Blazor and how to set them to its `Format` property.
...
The Sunfish Date Input supports the standard format strings and specifiers that come from the .NET Framework:
...
If you set an `DateTimeFormat.AMDesignator` and `DateTimeFormat.PMDesignator` to your current culture, they will be used by the Sunfish components - the framework honors them and will render them in the date/time strings, and so the Sunfish Time Pickers will also render the period of day (AM/PM) carousel, as if the culture supports it, even if it does not have them by default.
...
>caption Standard format strings support in Sunfish Date Input for Blazor

````RAZOR
@TheDate
<br />

<SunfishDateInput @bind-Value="TheDate" Format="d" />@TheDate.ToString("d")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="D" />@TheDate.ToString("D")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="f" />@TheDate.ToString("f")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="F" />@TheDate.ToString("F")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="g" />@TheDate.ToString("g")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="G" />@TheDate.ToString("G")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="m" />@TheDate.ToString("m")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="M" />@TheDate.ToString("M")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="r" />@TheDate.ToString("r")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="R" />@TheDate.ToString("R")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="s" />@TheDate.ToString("s")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="t" />@TheDate.ToString("t")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="T" />@TheDate.ToString("T")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="u" />@TheDate.ToString("u")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="y" />@TheDate.ToString("y")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="Y" />@TheDate.ToString("Y")
...
>caption Using supported .NET format specifiers to define relatively common date formats in the Sunfish Date Input

````RAZOR
@TheDate
<br />

<SunfishDateInput @bind-Value="TheDate" Format="dd MMM yyyy" /> @TheDate.ToString("dd MMM yyyy")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="dddd, dd MMM yyyy" /> @TheDate.ToString("dddd, dd MMM yyyy")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="HH:mm:ss" /> @TheDate.ToString("HH:mm:ss")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="dd MMM yyyy H:mm:ss" /> @TheDate.ToString("dd MMM yyyy H:mm:ss")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="dd MMMM yyyy HH:mm:ss" /> @TheDate.ToString("dd MMMM yyyy HH:mm:ss")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="dd-MM-yyyy" /> @TheDate.ToString("dd-MM-yyyy")
<br />
<SunfishDateInput @bind-Value="TheDate" Format="dd.MMM.yyyy" /> @TheDate.ToString("dd.MMM.yyyy")
