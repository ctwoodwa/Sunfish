...
tags: sunfish,blazor,radio button,list,data,bind,binding,databind
published: True
position: 5
...
<br />
<SunfishRadioGroup Data="@RadioGroupData" @bind-Value="@RadioGroupValue" />
...
<SunfishRadioGroup @ref="@RadioGroupRef"
                   ...
                   @bind-Value="@RadioGroupValue" />
@code {
    private SunfishRadioGroup<string, string>? RadioGroupRef { get; set; }
...
@code {
    private SunfishRadioGroup<Gender, int>? RadioGroupRef { get; set; }
...
* [Live Demo: RadioGroup](https://demos.sunfish.dev/blazor-ui/radiogroup/overview)
