...
tags: sunfish,blazor,animation,container
published: True
position: 0
...
````RAZOR
<SunfishButton OnClick="@ToggleAnimationContainer">Toggle Animation Container</SunfishButton>

<SunfishAnimationContainer @ref="@TAC"
                           AnimationType="@AnimationType.ZoomIn"
                           Width="300px"
                           Top="100px"
                           Left="100px">
    <div style="padding: 1em; color: #fff; background: #282f89; text-align: center;">
        Sunfish Blazor Animation Container
    </div>
</SunfishAnimationContainer>

@code {
    private SunfishAnimationContainer TAC { get; set; }
...
<label>
    Animation Type:
    <SunfishDropDownList Data="@AnimationTypes"
...
<label>
    Animation Duration:
    <SunfishNumericTextBox @bind-Value="@SelectedAnimationDuration"
                           Min="0"
                           Max="7000"
                           Width="100px" />
</label>
...
* [Live Demos: Animation Container](https://demos.sunfish.dev/blazor-ui/animationcontainer/overview)
* [AnimationContainer API Reference](slug:Sunfish.Blazor.Components.SunfishAnimationContainer)
