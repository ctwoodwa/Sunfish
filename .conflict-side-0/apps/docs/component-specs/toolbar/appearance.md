...
tags: sunfish,blazor,toolbar,appearance
published: True
position: 35
components: ["toolbar"]
---
...
````RAZOR
@{
    var fields = typeof(Sunfish.Blazor.ThemeConstants.ToolBar.FillMode)
    ...
    foreach (var field in fields)
    {
        ...
        <div style="float:left; margin: 20px;">
            <SunfishToolBar FillMode="@fillMode">
...
You can increase or decrease the size of the ToolBar by setting the `Size` parameter to a member of the `Sunfish.Blazor.ThemeConstants.ToolBar.Size` class:
...
````RAZOR
@{
    var fields = typeof(Sunfish.Blazor.ThemeConstants.ToolBar.Size)
        .GetFields(System.Reflection.BindingFlags.Public 
        | System.Reflection.BindingFlags.Static
        | System.Reflection.BindingFlags.FlattenHierarchy)
        .Where(field => field.IsLiteral && !field.IsInitOnly).ToList();
...
* [Live Demo: ToolBar Appearance](https://demos.sunfish.dev/blazor-ui/toolbar/appearance)
