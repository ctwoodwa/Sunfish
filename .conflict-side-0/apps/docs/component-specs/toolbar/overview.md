...
tags: sunfish,blazor,toolbar,tools,buttoncontainer
published: True
position: 0
components: ["toolbar"]
---
...
The <a href = "https://sunfish.dev/blazor-ui/toolbar" target="_blank">Blazor ToolBar component</a> is a container for buttons or other application-specific tools. This article explains the available features.

## Creating Blazor ToolBar

1. Add the `<SunfishToolBar>` tag to a Razor file.
...
| Parameter | Type | Description |
| --- | --- | --- |
| `Size` | `Sunfish.Blazor.ThemeConstants.ToolBar.Size` | Adjust the size of the ToolBar |
...
````RAZOR
<SunfishButton OnClick="ChangeWidth">Change Width!</SunfishButton>

<br />
<br />

<div class="toolbar-wrapper">
    <SunfishToolBar OverflowMode="@ToolBarOverflowMode.Menu">
...
* [Live ToolBar Demos](https://demos.sunfish.dev/blazor-ui/toolbar/overview)
* [ToolBar API Reference](slug:Sunfish.Blazor.Components.SunfishToolBar)
