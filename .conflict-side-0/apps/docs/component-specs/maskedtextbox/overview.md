...
tags: sunfish,blazor,masked,maskedtextbox,overview
published: True
position: 0
...
1. Add the `<SunfishMaskedTextBox>` tag to your razor page.
...
````RAZOR
<SunfishMaskedTextBox @bind-Value="@MaskedValue"
...
You can validate the content of the `SunfishMaskedTextBox` using the Data Annotation attributes. [See the Input Validation article for an example on how to validate the content of the MaskedTextBox](slug:common-features/input-validation#maskedtextbox).
...
See the [MaskedTextBox API Reference](slug:Sunfish.Blazor.Components.SunfishMaskedTextBox) for a full list of parameters, methods and events.
...
>tip To learn more about the appearance, anatomy, and accessibility of the MaskedTextBox, visit the [Progress Design System Kit documentation](https://sunfish.dev/design-system/docs/components/maskedtextbox/)—an information portal offering rich component usage guidelines, descriptions of the available style variables, and globalization support details.

## MaskedTextBox Reference and Methods


````RAZOR
<SunfishButton OnClick="@FocusTextBox">Focus TextBox</SunfishButton>

<SunfishMaskedTextBox @ref="@MaskedTextBoxRef"
                      @bind-Value="@MaskedValue"
                      Mask="0000-0000-0000-0000"
                      Width="300px" />

@code{
    private SunfishMaskedTextBox MaskedTextBoxRef { get; set; }
...
<SunfishMaskedTextBox Mask="(+999) 000-0000" @bind-Value="@Phone"></SunfishMaskedTextBox><br />
<SunfishMaskedTextBox Mask="0000-0000-0000-0000" @bind-Value="@CardNumber"></SunfishMaskedTextBox><br />
<SunfishMaskedTextBox Mask="000-00-0000" @bind-Value="@SSN"></SunfishMaskedTextBox><br />
<SunfishMaskedTextBox Mask="L0L 0LL" @bind-Value="@UkPostcode"></SunfishMaskedTextBox><br />
<SunfishMaskedTextBox Mask="00000" @bind-Value="@ZipCode"></SunfishMaskedTextBox><br />
<SunfishMaskedTextBox Mask="00000-0000" @bind-Value="@ZipPlus4Code"></SunfishMaskedTextBox><br />
...
<SunfishMaskedTextBox Mask="@PercentageMask"
                      IncludeLiterals="true"
                      PromptPlaceholder="null"
                      @bind-Value="@RawPercentage">
</SunfishMaskedTextBox>
...
<SunfishMaskedTextBox Mask="LA-\9\0\00000" @bind-Value="@invoiceNumber" IncludeLiterals="true"></SunfishMaskedTextBox>
...
* [Live Demo: MaskedTextbox](https://demos.sunfish.dev/blazor-ui/maskedtextbox/overview)
* [Live Demo: MaskedTextbox Validation](https://demos.sunfish.dev/blazor-ui/maskedtextbox/validation)
* [Add Floating Label](slug:inputs-kb-floating-label)
* [MaskedTextBox API Reference](slug:Sunfish.Blazor.Components.SunfishMaskedTextBox)
