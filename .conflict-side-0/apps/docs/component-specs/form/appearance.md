...
tags: sunfish,blazor,form,appearance
published: True
position: 35
components: ["form"]
---
...
You can increase or decrease the size of the Form by setting the `Size` parameter to a member of the `Sunfish.Blazor.ThemeConstants.Form.Size` class:
...
````RAZOR
@{
    var fields = typeof(Sunfish.Blazor.ThemeConstants.Form.Size)
...
## See Also
  ...
  * [Live Demo: Form Appearance](https://demos.sunfish.dev/blazor-ui/form/appearance)
