...
slug: form-overview
tags: sunfish,blazor,form,edit,form
published: True
position: 0
components: ["form"]
---
...
|-----------|----------|
| `string`  | [Sunfish TextBox](slug:components/textbox/overview) |
| `int`, `double`, `float`, `decimal`  | [Sunfish NumericTextBox](slug:components/numerictextbox/overview) |
| `Enum`  | [Sunfish DropDownList](slug:components/dropdownlist/overview) |
| `DateTime`  | [Sunfish DatePicker](slug:components/datepicker/overview) |
| `bool`  | [Sunfish CheckBox](slug:checkbox-overview) |
...
The [Blazor Form](https://demos.sunfish.dev/blazor-ui/form/overview) exposes multiple parameters that allow you to customize its layout. Besides the parameters below, the Form component also allows you to [define a completely custom layout with HTML markup and Razor components](slug:form-formitems-formitemstemplate).
...
The following parameters enable you to customize the appearance of the [Blazor Form](https://demos.sunfish.dev/blazor-ui/form/overview):
...
<SunfishForm Model="@TeamMate" @ref="@FormRef" Width="300px">
    <FormValidation>
...
@code {
    private SunfishForm FormRef { get; set; }
...
* [Live Demo: Form](https://demos.sunfish.dev/blazor-ui/form/overview)
* [Form API Reference](slug:Sunfish.Blazor.Components.SunfishForm)
