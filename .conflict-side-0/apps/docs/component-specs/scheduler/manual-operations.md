...
tags: sunfish,blazor,scheduler,read,navigate,manual,data,data source
published: false
position: 15
...
<SunfishGrid Data=@GridData TotalCount=@Total
...
>caption If you have all the data at once, the Sunfish .ToDataSourceResult(request) extension method can manage the operations for you
...
<SunfishGrid Data=@GridData TotalCount=@Total OnRead=@ReadItems
