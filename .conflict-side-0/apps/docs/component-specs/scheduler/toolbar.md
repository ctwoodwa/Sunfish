...
tags: sunfish,blazor,scheduler,toolbar
published: True
position: 2
...
The [Blazor Scheduler toolbar](https://demos.sunfish.dev/blazor-ui/scheduler/toolbar) can render built-in and custom tools. This article shows how to use and customize the toolbar.
...
Add a `<SchedulerToolBar>` tag inside `<SunfishScheduler>` to configure the toolbar, for example:
...
<SunfishScheduler Data="@Appointments"
    ...
    <SchedulerToolBar>
        ...
        <SchedulerToolBarCustomTool>
            <SunfishButton OnClick="@OnCustomToolClick">Show When the Trip to Hawaii Ends</SunfishButton>
        </SchedulerToolBarCustomTool>
    </SchedulerToolBar>
    <SchedulerViews>
        <SchedulerDayView />
...
* [Scheduler Live Demo](https://demos.sunfish.dev/blazor-ui/scheduler/overview)
* [Scheduler Toolbar Demo](https://demos.sunfish.dev/blazor-ui/scheduler/toolbar)