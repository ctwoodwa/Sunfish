...
tags: sunfish,blazor,DateTimePicker,events
published: true
position: 20
...
This article explains the events available in the Sunfish DateTimePicker for Blazor:
...
<SunfishDateTimePicker @bind-Value="@DateTimePickerValue"
...
As an argument, the event handler receives a [`DateTimePickerCalendarCellRenderEventArgs` object](slug:sunfish.blazor.components.datetimepickercalendarcellrendereventargs), which contains the following properties:
...
As an argument, the event handler receives a [`DateTimePickerCloseEventArgs` object](slug:sunfish.blazor.components.datetimepickercloseeventargs), which contains the following properties:
...
As an argument, the event handler receives a [`DateTimePickerOpenEventArgs` object](slug:sunfish.blazor.components.datetimepickeropeneventargs), which contains the following properties:
...
<SunfishDateTimePicker Value="@DateTimePickerValue" 
