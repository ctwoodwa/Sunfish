...
tags: sunfish,blazor,autocomplete,events
published: true
position: 35
...
This article explains the events available in the Sunfish AutoComplete for Blazor:
...
from model: @Role
<br />
<SunfishAutoComplete Data="@Suggestions" Value="@Role" ValueChanged="@( (string v) => MyValueChangeHandler(v) )">
</SunfishAutoComplete>
...
from model: @Role
<br />
<SunfishAutoComplete Data="@Suggestions" @bind-Value="@Role" OnChange="@MyOnChangeHandler" >
</SunfishAutoComplete>
...
@code {
    ...
    async Task ReadItems(AutoCompleteReadEventArgs args)
    {
        ...
        {
            Sunfish.DataSource.FilterDescriptor filter = args.Request.Filters[0] as Sunfish.DataSource.FilterDescriptor;
...
>caption Filter large local data through the Sunfish DataSource extensions
...
@code {
    ...
    {
        //using Sunfish extension methods to filter the data
...
<SunfishAutoComplete @bind-Value="@TheValue" Data="@Suggestions"
