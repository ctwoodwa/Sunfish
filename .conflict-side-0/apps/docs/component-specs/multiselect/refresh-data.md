...
tags: sunfish,blazor,multiselect,observable,data,new,collection
published: True
position: 30
...
You can refresh the data of the MultiSelect by using the `Rebind` method exposed to the reference of the SunfishMultiSelect. If you have manually defined the [OnRead event](slug:multiselect-events#onread) the business logic defined in its event handler will be executed. 
...
<SunfishButton OnClick="@RebindMultiSelect">Rebind the Multiselect</SunfishButton>

<SunfishMultiSelect TItem="@String"
                    TValue="@String"
                    @ref="@MultiSelectRef"
                    OnRead="@ReadItems"
...
@code{
    private SunfishMultiSelect<string, string> MultiSelectRef { get; set; }
...
<h4>Add option</h4>
<SunfishTextBox @bind-Value="@ValuetoAdd"></SunfishTextBox>

<SunfishButton OnClick="@AddOption">Add option</SunfishButton>
<br />

<h4>Remove the last option</h4>
<SunfishButton OnClick="@RemoveOption">Remove the last option</SunfishButton>
<br />

<h4>Options: @Options.Count</h4>

<SunfishMultiSelect Data="@Options" @bind-Value="@TheValues"
...
<SunfishTextBox @bind-Value="@ValuetoAdd"></SunfishTextBox>
<SunfishButton OnClick="@AddItem">Add new option</SunfishButton>
<br />

<h4>Remove the last option</h4>
<SunfishButton OnClick="@RemoveItem">Remove last item</SunfishButton>
<br />

<h4>Load a collection of new options</h4>
<SunfishButton OnClick="@LoadNewData">Load new options</SunfishButton>
<br />
...
<SunfishButton OnClick="@SetSelected">Set selected</SunfishButton>
<br />

<h4>Clear selected values</h4>
<SunfishButton OnClick="@ClearSelected">Clear selected</SunfishButton>
<br />
