...
tags: sunfish, blazor, grid, editing, inline
published: True
position: 1
components: ["grid"]
---
...
@[template](/_contentTemplates/grid/editing.md#advanced-example-toolbar)
        ...
        <SunfishGridColumn Field="@nameof(Product.Description)" EditorType="@GridEditorType.TextArea">
            <Template>
...
* [Live Demo: Grid Inline Editing](https://demos.sunfish.dev/blazor-ui/grid/editing-inline)
