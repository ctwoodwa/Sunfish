...
tags: sunfish,blazor,grid,ai,highlight,rows
published: True
position: 35
components: ["grid"]
---
...
<SunfishDataGrid @ref="@GridRef"
             ...
             Pageable="true"
             Sortable="true">
        <SunfishGridColumn Field="@nameof(PatientDto.PatientName)" Title="Patient Name" />
        <SunfishGridColumn Field="@nameof(PatientDto.Age)" Title="Age" />
        <SunfishGridColumn Field="@nameof(PatientDto.Department)" Title="Department" />
        <SunfishGridColumn Field="@nameof(PatientDto.Status)" Title="Status" />
</SunfishDataGrid>

@code {
    private SunfishDataGrid<PatientDto> GridRef { get; set; }
...
<SunfishDataGrid @ref="@GridRef">
    <GridToolBar>
        ...
        <GridToolBarCustomTool>
            <SunfishButton Icon="@nameof(SvgIcon.ArrowRotateCcw)" 
...
View the [complete live demo](https://demos.sunfish.dev/blazor-ui/grid/ai-highlight).
