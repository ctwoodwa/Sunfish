...
tags: sunfish,blazor,grid,aggreagates,aggregate
published: True
...
There are several available aggregate functions under the `Sunfish.Components.DataGrid.GridAggregateType` enum:
...
>caption Use Aggregates in the Sunfish Blazor Grid
...
<SunfishDataGrid Data=@GridData
    ...
    <GridAggregates>
        ...
        <SunfishGridColumn Field=@nameof(Employee.Salary) Title="Salary" Groupable="false" DisplayFormat="{0:C0}">
            <GroupFooterTemplate>
