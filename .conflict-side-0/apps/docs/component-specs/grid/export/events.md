...
tags: sunfish,blazor,grid,export,events
published: True
position: 15
components: ["grid"]
---
...
@using Sunfish.Documents.SpreadsheetStreaming

@* Required by GridExcelExportColumn in the OnExcelBeforeExport handler *@
@using Sunfish.Components.DataGrid

<SunfishDataGrid Data="@GridData" Pageable="true" Sortable="true"
    ...
    <GridToolBarTemplate>
        ...
        <label class="k-checkbox-label"><SunfishCheckBox @bind-Value="@ExportSelectedItemsOnly" />Export Selected Items Only</label>
    </GridToolBarTemplate>

    <GridExport>
        <GridExcelExport FileName="sunfish-grid-export" AllPages="@ExportAllPages" OnBeforeExport="@OnExcelBeforeExport" />
    </GridExport>

        <SunfishGridColumn Field="@nameof(SampleData.ProductId)" Title="ID" Width="100px" Visible="false" />
        ...
        <SunfishGridColumn Field="@nameof(SampleData.ReleaseDate)" Title="Release Date" Width="300px" />
</SunfishDataGrid>
...
@code {
    ...
    private void OnExcelBeforeExport(GridBeforeExcelExportEventArgs args)
    {
        ...
        // BuiltInNumberFormats is part of the Sunfish.Documents.SpreadsheetStreaming namespace
...
<SunfishDataGrid Data="@GridData" Pageable="true" Sortable="true"
    ...
    <GridExport>
        <GridCsvExport FileName="sunfish-grid-export" AllPages="@ExportAllPages" OnBeforeExport="@OnBeforeCsvExport" />
    </GridExport>

        <SunfishGridColumn Field="@nameof(SampleData.ProductId)" 
                    Title="ID"
                    Visible="false"
                    Width="100px" />
        <SunfishGridColumn Field="@nameof(SampleData.ProductName)" Title="Product Name" Width="300px" />
...
<SunfishDataGrid Data="@GridData"
    ...
    <GridExport>
        <GridPdfExport FileName="sunfish-grid-export" AllPages="@ExportAllPages" OnBeforeExport="@OnBeforePDFExport" />
    </GridExport>

        <SunfishGridColumn Field="@nameof(SampleData.ProductId)" Title="ID" Visible="false" />
        <SunfishGridColumn Field="@nameof(SampleData.ProductName)" Title="Product Name" Width="150px" />
        <SunfishGridColumn Field="@nameof(SampleData.UnitsInStock)" Title="In stock" Width="100px" />
        <SunfishGridColumn Field="@nameof(SampleData.Price)" Title="Unit Price" Width="100px" />
        <SunfishGridColumn Field="@nameof(SampleData.ReleaseDate)" Title="Release Date" Width="200px" />
</SunfishDataGrid>
...
<SunfishDataGrid Data="@GridData" Pageable="true" Sortable="true"
    ...
    <GridExport>
        <GridExcelExport FileName="sunfish-grid-export"
...
<SunfishDataGrid Data="@GridData"
    ...
    <GridExport>
        <GridPdfExport FileName="sunfish-grid-export"
                       AllPages="@ExportAllPages"
                       OnAfterExport="@OnAfterPDFExport" />
    </GridExport>

        <SunfishGridColumn Field="@nameof(SampleData.ProductId)" Title="ID" Width="50px" />
        <SunfishGridColumn Field="@nameof(SampleData.ProductName)" Title="Product Name" Width="150px" />
        <SunfishGridColumn Field="@nameof(SampleData.UnitsInStock)" Title="In stock" Width="100px" />
        <SunfishGridColumn Field="@nameof(SampleData.Price)" Title="Unit Price" Width="100px" />
        <SunfishGridColumn Field="@nameof(SampleData.ReleaseDate)" Title="Release Date" Width="200px" />
