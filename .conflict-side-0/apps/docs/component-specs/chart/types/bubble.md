...
tags: sunfish,blazor,chart,bubble
published: True
position: 0
components: ["charts"]
---
...
<SunfishChart>
    ...
    <ChartSeriesItems>
        <SunfishChartSeries Type="ChartSeriesType.Bubble"
                     Data="@Series1Data"
                     Name="North America"
...
To change the minimum and maximum bubble diameter, use the `MinSize` and `MinSize` parameters of `<SunfishChartSeries>`. In this case, the Chart component sets the diameter of the rendered bubbles based on:
...
````RAZOR
<SunfishChart Width="1000px" Height="420px">
...
* [Live Demo: Bubble Chart](https://demos.sunfish.dev/blazor-ui/chart/bubble-chart)
