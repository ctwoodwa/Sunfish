...
tags: sunfish,blazor,chart,rangearea
published: True
position: 0
components: ["charts"]
---
...
<SunfishChart>
    <ChartSeriesItems>
        <SunfishChartSeries Name="Sydney"
                     Data="@SydneyData"
                     Type="ChartSeriesType.RangeArea">
            <ChartSeriesLabels Visible="true" />
        </SunfishChartSeries>
        <SunfishChartSeries Name="Sofia"
                     Data="@SofiaData"
                     Type="ChartSeriesType.RangeArea">
            @*<ChartSeriesLabels>
...
<SunfishChart>
    <ChartSeriesItems>
        <SunfishChartSeries Name="Test Tube 1"
                     Data="@Tube1Data"
                     Type="ChartSeriesType.RangeArea"
        ...
        <SunfishChartSeries Name="Test Tube 2"
                     Data="@Tube2Data"
                     Type="ChartSeriesType.RangeArea"
                     FromField="@nameof(AreaDataPoint.LowValue)"
                     ToField="@nameof(AreaDataPoint.HighValue)"
...
You can control the color of the line itself separately by using the `Color` property of the nested `SunfishChartSeriesLine` tag.

@[template](/_contentTemplates/chart/link-to-basics.md#opacity-area-bubble)

### Missing Values

If both values in a range pair are missing or `null`, you can have the Chart work around this by setting the `MissingValues` property of the series to the desired behavior. Use a member of the `Sunfish.Blazor.ChartSeriesMissingValues` enum:
...
You can render the lines between the points with different styles. The supported styles can be set via the `Style` property of the child `ChartSeriesLine` tag—it takes a member of the `Sunfish.Blazor.ChartSeriesLineStyle` enum:
...
* [Live Demo: Range Area Chart](https://demos.sunfish.dev/blazor-ui/chart/range-area-chart)
