...
description: The DrillDown feature of the Sunfish Chart for Blazor allows users to explore hierarchical data by initially displaying summarized information and to drill down into specific categories or data points for more detailed insights.
slug: chart-drilldown
tags: sunfish,blazor,chart,drill,down,drilldown
published: true
position: 55
components: ["charts"]
---
...
The Sunfish UI for Blazor Chart supports drilldown functionality for exploring data.
...
1. Declare a `SunfishChartBreadcrumb` component.
...
````RAZOR
<SunfishChartBreadcrumb ChartId="@ChartId"></SunfishChartBreadcrumb>

<SunfishChart Id="@ChartId">
    <ChartSeriesItems>
        <SunfishChartSeries Type="ChartSeriesType.Column"
                     Name="Total Sales By Company"
                     Data="@Data"
...
````RAZOR
<SunfishButton OnClick="@ResetDrilldownLevel">Reset Drilldown level the Chart</SunfishButton>
...
@code {
    private SunfishChart ChartRef { get; set; } = null!;
...
* [Live Demo: DrillDown Charts](https://demos.sunfish.dev/blazor-ui/chart/drilldown-chart)
