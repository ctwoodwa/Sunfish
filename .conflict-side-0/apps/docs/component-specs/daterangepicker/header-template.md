...
tags: sunfish,blazor,daterangepicker,template
published: True
position: 15
...
````RAZOR
<SunfishDateRangePicker StartValue="@StartDate"
                        EndValue="@EndDate"
                        Format="dd MMMM yyyy"
    ...
    <HeaderTemplate>
        ...
        <span style="padding-right: .6em;">
            <SunfishSvgIcon Icon="@SvgIcon.ParameterDateTime" /> Showing
            <strong>
...
@code {
    SunfishDateRangePicker<DateTime?> Picker { get; set; }
