...
slug: sankey-legend
tags: sunfish,blazor,sankey,diagram,chart,legend
published: True
position: 11
components: ["sankey"]
---
...
The Sunfish Sankey Diagram for Blazor can show a legend, which is a visual guide with details about the nodes. This article explores how to customize the Sankey legend.

## Basic Customization

To customize the legend in the Sankey chart, declare a `<SankeyLegend>` tag as a direct child of `<SunfishSankey>`. The `<SankeyLegend>` tag has the following parameters:

| Parameter | Type and Default&nbsp;Value | Description |
| --------- | ---- | ----------- |
| `Align` | [`SankeyLegendAlign` enum](slug:sunfish.blazor.sankeylegendalign) <br/> (`Start`) | The alignment of the legend. |
...
| `Orientation` | [`SankeyLegendOrientation` enum](slug:sunfish.blazor.sankeylegendorientation) <br/> (`Horizontal`)  | The orientation of the legend. |
| `Position` | [`SankeyLegendPosition` enum](slug:sunfish.blazor.sankeylegendposition) <br/> (`Bottom`)| The position of the legend. |
...
* [`Border`](slug:sunfish.blazor.components.sankeylegendborder)
* [`Item`](slug:sunfish.blazor.components.sankeylegenditem)
* [`Labels`](slug:sunfish.blazor.components.sankeylegendlabels) - exposes additional nested options. The structure of the nested tags is `<SankeyLegendLabels*Specifics*>`, where the specifics can be:
    * [`Margin`](slug:sunfish.blazor.components.sankeylegendlabelsmargin)
    * [`Padding`](slug:sunfish.blazor.components.sankeylegendlabelspadding)
* [`Margin`](slug:sunfish.blazor.components.sankeylegendmargin)
* [`Padding`](slug:sunfish.blazor.components.sankeylegendpadding)
* [`Title`](slug:sunfish.blazor.components.sankeylegendtitle) - exposes additional nested options. The structure of the nested tags is `<SankeyLegendTitle*Specifics*>`, where the specifics can be:
    * [`Border`](slug:sunfish.blazor.components.sankeylegendtitleborder)
    * [`Margin`](slug:sunfish.blazor.components.sankeylegendtitlemargin)
    * [`Padding`](slug:sunfish.blazor.components.sankeylegendtitlepadding)  
...
* [Live Demo: Sankey Diagram Configuration](https://demos.sunfish.dev/blazor-ui/sankey/configuration)
