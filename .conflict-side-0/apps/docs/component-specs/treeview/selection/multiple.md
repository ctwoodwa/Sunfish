...
tags: sunfish,blazor,treeview,selection,multiple
published: True
position: 10
components: ["treeview"]
---
...
To use **multiple** node selection, set the `SelectionMode` parameter to `Sunfish.Blazor.TreeViewSelectionMode.Multiple`.
...
@if (SelectedItems.Any())
{
    ...
    foreach (var item in SelectedItems)
    {
        <div class="card" style="width: 15rem">
            <span><strong>Icon:</strong> <SunfishSvgIcon Icon="@((item as TreeItem).Icon)" /></span>
