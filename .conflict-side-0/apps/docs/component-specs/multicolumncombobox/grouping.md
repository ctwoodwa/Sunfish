...
tags: sunfish,blazor,multicolumncombobox,combobox,group,grouping
published: True
position: 15
...
<SunfishGrid Data="@MultiComboData" Pageable="true" Groupable="true">
    <GridColumns>
...
* A grouped MultiColumnComboBox will provide a `Groups` property with a single [`GroupDescriptor`](slug:Sunfish.DataSource.GroupDescriptor) in the [`DataSourceRequest`](slug:Sunfish.DataSource.DataSourceRequest) argument of its [OnRead event](slug:multicolumncombobox-events#onread). This will allow the developer to apply grouping with [manual data operations](slug:common-features-data-binding-onread).

## See Also

* [Live Demo: ComboBox Grouping](https://demos.sunfish.dev/blazor-ui/multicolumncombobox/grouping)
