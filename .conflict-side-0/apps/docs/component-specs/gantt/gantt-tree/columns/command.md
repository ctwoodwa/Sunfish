...
tags: sunfish,blazor,gantt,column,command
published: True
position: 1
components: ["gantt"]
---
...
The Blazor Gantt Command Column provides various parameters to configure the component. Also check the [Gantt public API](slug:Sunfish.Components.DataDisplay.SunfishGantt-1).
...
See also Appearance properties like `Icon`, `Class`, `Enabled` that are coming from the underlying [Sunfish UI for Blazor Button Component features](slug:components/button/overview).
...
## See Also
  ...
  * [Live Demo: Gantt Tree Command Column](https://demos.sunfish.dev/blazor-ui/gantt/editing-inline)
