...
tags: sunfish,blazor,gantt,ganttchart,templates,popup,edit,create
published: True
position: 50
components: ["gantt"]
---
                        ...
                        <FormItems>
                            ...
                            <FormItem Field="@(nameof(FlatModel.PercentComplete))" LabelText="Complete">
                                <Template>
                                    ...
                                    <SunfishNumericTextBox Id="complete" @bind-Value="@EditItem.PercentComplete" Format="P2" />
                                </Template>
                            </FormItem>
                        </FormItems>
                        <FormButtons>
...
@code {
    private SunfishGantt<FlatModel> GanttRef;
