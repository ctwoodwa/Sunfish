...
page_title: Sunfish UI for Blazor TabStrip Documentation | TabStrip Accessibility
description: "Get started with the Sunfish UI for Blazor TabStrip and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Sunfish UI for Blazor TabStrip provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the TabStrip keyboard navigation works, refer to the [Blazor TabStrip Accessibility and Keyboard Navigation Demo](https://demos.sunfish.dev/blazor-ui/tabstrip/keyboard-navigation).
