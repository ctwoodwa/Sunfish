...
tags: sunfish,blazor,dropdown,dropdownlist,group,grouping
published: True
position: 15
...
* A grouped DropDownList will provide a `Groups` property with a single [`GroupDescriptor`](slug:Sunfish.DataSource.GroupDescriptor) in the [`DataSourceRequest`](slug:Sunfish.DataSource.DataSourceRequest) argument of its [OnRead event](slug:components/dropdownlist/events#onread). This will allow the developer to apply grouping with [manual data operations](slug:components/grid/manual-operations).

## See Also

* [Live Demo: DropDownList Grouping](https://demos.sunfish.dev/blazor-ui/dropdownlist/grouping)
