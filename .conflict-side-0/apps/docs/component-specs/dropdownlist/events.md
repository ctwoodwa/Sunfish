...
tags: sunfish,blazor,dropdown,list,dropdownlist,events
published: true
position: 35
...
This article explains the events available in the Sunfish DropDownList for Blazor:
...
<br />
<SunfishDropDownList Data="@MyList" OnChange="@MyOnChangeHandler" @bind-Value="@MySelectedItem">
</SunfishDropDownList>
...
<SunfishDropDownList TItem="@String" TValue="@String"
                     OnRead="@ReadItems"
...
<SunfishDropDownList TItem="@Car" TValue="@(int?)"
                     OnRead="@ReadItems"
                     @bind-Value="@SelectedValue"
...
````RAZOR
<SunfishDropDownList Data="@Items"
...
<SunfishDropDownList Data="@DropDownListData"
...
<SunfishDropDownList @bind-Value="@TheValue" Data="@Suggestions"
