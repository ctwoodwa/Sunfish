namespace Sunfish.Blocks.Assets.Localization;

/// <summary>
/// Marker type for the blocks-assets shared localized strings — package-scoped
/// phrases shown in asset-catalog UI surfaces (assets, attributes, attachments,
/// the read-display catalog grid). Resolves
...
/// SharedResource when the asset-specific phrasing is more useful (e.g.,
/// "Saving asset record…" instead of plain "Save"). Plan 6 fills in the
