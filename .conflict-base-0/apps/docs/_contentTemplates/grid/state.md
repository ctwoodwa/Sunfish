...
<SunfishGrid @ref="@GridRef"
    ...
    <GridToolBarTemplate>
        <SunfishButton ThemeColor="@ThemeConstants.Button.ThemeColor.Primary"
                       OnClick="@SetGridSort">Sort Grid by HireDate</SunfishButton>
        <label>
            <SunfishCheckBox @bind-Value="@ShouldResetSortState" />
...
@code {
    private SunfishGrid<Employee>? GridRef { get; set; }
...
<SunfishGrid @ref="@GridRef"
             ...
             Height="400px">
    <GridToolBarTemplate>
        <SunfishButton ThemeColor="@ThemeConstants.Button.ThemeColor.Success"
                       OnClick="@( () => SetGridFilters(false) )">Filter Grid by Team</SunfishButton>
        <SunfishButton ThemeColor="@ThemeConstants.Button.ThemeColor.Primary"
                       OnClick="@( () => SetGridFilters(true) )">Filter Grid by Team and HireDate</SunfishButton>
        <span class="k-separator"></span>
        <SunfishButton OnClick="@RemoveGridFilters">Remove All Filters</SunfishButton>
    </GridToolBarTemplate>
    <GridColumns>
        <GridColumn Field="@(nameof(Employee.Name))" Title="Employee Name" />
        <GridColumn Field="@(nameof(Employee.Team))" Title="Team" />
...
<SunfishGrid @ref="@GridRef"
    ...
    <GridToolBarTemplate>
        <SunfishButton ThemeColor="@ThemeConstants.Button.ThemeColor.Success"
                       OnClick="@( () => SetTeamFilter(false) )">Filter Grid by Team 1</SunfishButton>
        <SunfishButton ThemeColor="@ThemeConstants.Button.ThemeColor.Primary"
                       OnClick="@( () => SetTeamFilter(true) )">Filter Grid by Team 1 or 3</SunfishButton>
        <span class="k-separator"></span>
        <SunfishButton OnClick="@RemoveGridFilters">Remove All Filters</SunfishButton>
    </GridToolBarTemplate>
    <GridColumns>
...
<SunfishGrid @ref="@GridRef"
    ...
    <GridToolBar>
        <GridToolBarCustomTool>
            <SunfishButton Icon="@SvgIcon.Search"
                        ThemeColor="@ThemeConstants.Button.ThemeColor.Primary"
                        OnClick="@OnSearchButtonClick">Search Programmatically</SunfishButton>
            <SunfishButton Icon="@SvgIcon.X"
                        OnClick="@OnClearButtonClick">Clear Search</SunfishButton>
        </GridToolBarCustomTool>
...
@code {
    private SunfishGrid<GridModel>? GridRef { get; set; }
...
<SunfishGrid @ref="@GridRef"
    ...
    <GridToolBarTemplate>
        <SunfishButton ThemeColor="@ThemeConstants.Button.ThemeColor.Success"
                       OnClick="@( () => SetGridGroups(false) )">Group Grid by Team</SunfishButton>
        <SunfishButton ThemeColor="@ThemeConstants.Button.ThemeColor.Primary"
                       OnClick="@( () => SetGridGroups(true) )">Group Grid by Team and IsOnLeave</SunfishButton>
        <span class="k-separator"></span>
        <SunfishButton OnClick="@RemoveGridGroups">Remove All Groups</SunfishButton>
    </GridToolBarTemplate>
    <GridColumns>
        <GridColumn Field="@(nameof(Employee.Name))" Title="Employee Name" />
    ...
    private async Task SetGridGroups(bool shouldGroupBySecondColumn)
    {
        if (GridRef != null)
        {
            ...
            gridState.GroupDescriptors.Add(new GroupDescriptor()
            {
                Member = nameof(Employee.Team),
                MemberType = typeof(string),
                // https://feedback.sunfish.dev/blazor/1544196-allow-sorting-the-grouped-column
...
<SunfishGrid @ref="@GridRef"
             ...
             PageSize="2">
    <GridToolBarTemplate>
        <SunfishDropDownList Data="@CategoryData"
                             @bind-Value="@DropDownListCategoryId"
                             TextField="@nameof(Category.Name)"
                             ValueField="@nameof(Category.Id)">
        </SunfishDropDownList>
        <SunfishButton ThemeColor="@ThemeConstants.Button.ThemeColor.Success"
                       OnClick="@ExpandCategory">Expand Category</SunfishButton>
        <span class="k-separator"></span>
        <SunfishButton ThemeColor="@ThemeConstants.Button.ThemeColor.Primary"
                       OnClick="@ExpandAll">Expand All Categories</SunfishButton>
        <span class="k-separator"></span>
        <SunfishButton OnClick="@CollapseAll">Collapse All Categories</SunfishButton>
    </GridToolBarTemplate>
    <GridColumns>
    ...
    <DetailTemplate Context="category">
        <SunfishGrid Data="@ProductData.Where(x => x.CategoryId == category.Id)">
            <GridColumns>
...
@code {
    private SunfishGrid<Category>? GridRef { get; set; }
...
<SunfishGrid @ref="@GridRef"
    ...
    <GridToolBarTemplate>
        <SunfishButton ThemeColor="@ThemeConstants.Button.ThemeColor.Success"
                       OnClick="@ReorderPriceAndQuantity">Reorder Price and Quantity</SunfishButton>
        <SunfishButton ThemeColor="@ThemeConstants.Button.ThemeColor.Success"
                       OnClick="@MakeIdColumnLast">Make Id Column Last</SunfishButton>
        <SunfishButton ThemeColor="@ThemeConstants.Button.ThemeColor.Success"
                       OnClick="@ResizeColumns">Resize Columns</SunfishButton>
        <span class="k-separator"></span>
        <SunfishButton OnClick="@ResetColumns">Reset Column Configuration</SunfishButton>
    </GridToolBarTemplate>
    <GridColumns>
...
@code {
    private SunfishGrid<Product>? GridRef { get; set; }
