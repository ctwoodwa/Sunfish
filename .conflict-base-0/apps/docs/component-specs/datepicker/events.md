...
tags: sunfish,blazor,DatePicker,events
published: true
position: 20
...
This article describes the events of the Sunfish DatePicker for Blazor.
...
<SunfishDatePicker @bind-Value="@DatePickerValue"
...
As an argument, the event handler receives a [`DatePickerCalendarCellRenderEventArgs` object](slug:sunfish.blazor.components.datepickercalendarcellrendereventargs), which contains the following properties:
...
The event handler receives as an argument an [`DatePickerCloseEventArgs` object](slug:sunfish.blazor.components.datepickercloseeventargs) that contains:
...
As an argument, the event handler receives a [`DatePickerOpenEventArgs` object](slug:Sunfish.Blazor.Components.DatePickerOpenEventArgs), which contains the following properties:
...
<SunfishDatePicker Value="@DatePickerValue" 
