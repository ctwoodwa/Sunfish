...
tags: sunfish,blazor,dropdownbutton,icons
published: True
position: 5
...
The `<SunfishDropDownButton>` and `<DropDownButtonItem>` provide an `Icon` parameter that allows you to add an icon to the main button and all secondary action items.
...
>caption How to use icons in Sunfish Blazor DropDownButton

````RAZOR
<SunfishDropDownButton Icon="@SvgIcon.User">
    ...
    <DropDownButtonItems>
        ...
        <DropDownButtonItem> <SunfishLoader /> Custom Markup </DropDownButtonItem>
    </DropDownButtonItems>
...
* [Live Demo: DropDownButton Overview](https://demos.sunfish.dev/blazor-ui/dropdownbutton/overview)
