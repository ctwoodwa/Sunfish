...
page_title: Sunfish UI for Blazor Button Documentation | Button Accessibility
description: "Get started with the Sunfish UI for Blazor Button and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Sunfish UI for Blazor Button provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the Button keyboard navigation works, refer to the [Blazor Button Accessibility and Keyboard Navigation Demo](https://demos.sunfish.dev/blazor-ui/button/keyboard-navigation).
