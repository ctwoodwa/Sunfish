...
tags: sunfish,blazor,sankey,diagram,chart,overview
published: True
position: 0
components: ["general"]
---
...
The Blazor Sankey diagram provides various parameters to configure the component. Also check the [Sankey public API](slug:Sunfish.Blazor.Components.SunfishSankey).
...
* [Live Demos: Sankey diagram](https://demos.sunfish.dev/blazor-ui/sankey/overview)
* [Sankey diagram API Reference](slug:Sunfish.Blazor.Components.SunfishSankey)
