...
tags: sunfish, blazor, dockmanager, docking
published: true
position: 10
...
`````RAZOR
<SunfishDockManager Height="80vh">
    <DockManagerPanes>
        ...
        <DockManagerSplitPane>
            <Panes>
                ...
                <DockManagerContentPane HeaderText="Pane 1" Dockable="@Pane1Dockable">
                    <Content>
                        <SunfishToggleButton @bind-Selected="@Pane1Dockable">Enable Docking Over Pane 1</SunfishToggleButton>
                    </Content>
                </DockManagerContentPane>

                <DockManagerContentPane HeaderText="Pane 2" Dockable="Pane2Dockable">
                    <Content>
                        <SunfishToggleButton @bind-Selected="@Pane2Dockable">Enable Docking Over Pane 2</SunfishToggleButton>
                    </Content>
                </DockManagerContentPane>
