...
tags: sunfish,blazor,chart,radar,Line
published: True
position: 0
components: ["charts"]
---
...
<SunfishChart>
    <ChartSeriesItems>
        <SunfishChartSeries Type="@ChartSeriesType.RadarLine" Name="Avg. High" Data="@series1Data" Color="red">
        </SunfishChartSeries>
        <SunfishChartSeries Type="@ChartSeriesType.RadarLine" Name="Avg. Low" Data="@series2Data" Color="blue">
        </SunfishChartSeries>
    </ChartSeriesItems>
...
You can render the lines between the points with different styles. The supported styles can be set via the `Style` property that takes a member of `Sunfish.Blazor.ChartSeriesStyle` enum:
...
## See Also
  ...
  * [Live Demo: Radar Line Chart](https://demos.sunfish.dev/blazor-ui/chart/radar-line-chart)
