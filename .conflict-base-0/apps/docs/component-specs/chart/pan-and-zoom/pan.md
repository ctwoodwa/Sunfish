...
description: Learn more about the Pan feature of the Sunfish UI for Blazor Chart component and explore the available examples.
...
The `Pan` feature allows you to navigate through the Sunfish Blazor Chart component. This functionality works with both `category` and `numeric` series.
