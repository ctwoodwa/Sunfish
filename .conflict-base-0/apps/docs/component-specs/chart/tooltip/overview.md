...
tags: sunfish,blazor,chart,tooltip,tooltips
published: True
position: 1
components: ["charts"]
---
# Tooltip for Sunfish Blazor Chart

The Sunfish Chart provides a tooltip for its data points. You can have settings specific to each `<SunfishChartSeries>`, common tooltip settings for all series, or a [shared](slug:chart-tooltip-shared) tooltip for all categories.
...
1. Inside the `<SunfishChartSeries>`, include the `<ChartSeriesTooltip>` tag.
...
<SunfishChart>
    <ChartSeriesItems>
        <SunfishChartSeries Type="ChartSeriesType.Column" Name="Series 1" Data="@data1">
        </SunfishChartSeries>

        <SunfishChartSeries Type="ChartSeriesType.Column" Name="Series 2" Data="@data2">
...
A tooltip set to a specific `<SunfishChartSeries>` will take precedence over the common tooltip settings.

To enable the same tooltip for all series:

1. Inside the `<SunfishChart>`, add the `<ChartTooltip>`.
1. Set its `Visible` parameter to `true`.
...
<SunfishChart>
    <ChartSeriesItems>
        <SunfishChartSeries Type="ChartSeriesType.Line" Name="Product 1 (bound to simple data)" Data="@simpleData">
        </SunfishChartSeries>
        <SunfishChartSeries Type="ChartSeriesType.Line" Name="Product 2 (bound to model)"
    ...
    <ChartLegend Position="Sunfish.Blazor.ChartPosition.Bottom">
    </ChartLegend>
</SunfishChart>
...
<SunfishChart>
    <ChartSeriesItems>
        ...
        <SunfishChartSeries Type="ChartSeriesType.Line" Name="Product 2 (bound to model)"
            ...
            <ChartSeriesTooltip Visible="true">
                <Template>
                    <SunfishSvgIcon Icon="SvgIcon.InfoCircle" />
