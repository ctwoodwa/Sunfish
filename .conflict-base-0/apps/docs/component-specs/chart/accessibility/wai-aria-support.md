...
page_title: Sunfish UI for Blazor Chart Documentation | Chart Accessibility
description: "Get started with the Sunfish UI for Blazor Chart and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Sunfish UI for Blazor Chart provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the Chart keyboard navigation works, refer to the [Blazor Chart Accessibility and Keyboard Navigation Demo](https://demos.sunfish.dev/blazor-ui/chart/keyboard-navigation).
