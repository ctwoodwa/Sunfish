...
tags: sunfish,blazor,grid,paging
published: True
position: 20
components: ["grid"]
---
...
>caption Enable paging in Sunfish Grid

````RAZOR
Enable paging and start on the second page.

<SunfishDataGrid Data="@MyData" Pageable="true" PageSize="15" Page="2" Height="500px">
		<SunfishGridColumn Field="ID"></SunfishGridColumn>
		<SunfishGridColumn Field="TheName" Title="Employee Name"></SunfishGridColumn>
</SunfishDataGrid>
...
<SunfishDataGrid Data="@MyData" Pageable="true" PageSize="@PageSize">
		<SunfishGridColumn Field="ID"></SunfishGridColumn>
		<SunfishGridColumn Field="TheName" Title="Employee Name"></SunfishGridColumn>
</SunfishDataGrid>
...
In addition to the nested `GridPagerSettings` approach shown below, `SunfishDataGrid` exposes a simpler root-level `PagerButtonCount` parameter that controls the maximum number of page buttons rendered in the pager without requiring any `GridSettings` configuration. This is the currently-implemented pager button count parameter on `SunfishDataGrid` directly.
...
>caption Set the root-level PagerButtonCount on SunfishDataGrid

````RAZOR
<SunfishDataGrid Data="@GridData" Pageable="true" PageSize="5" PagerButtonCount="7">
        <SunfishGridColumn Field="ID"></SunfishGridColumn>
        <SunfishGridColumn Field="TheName" Title="Employee Name"></SunfishGridColumn>
</SunfishDataGrid>
...
<SunfishDataGrid Data="@MyData" Pageable="true" @bind-PageSize="@PageSize" @bind-Page="@CurrentPage">
    <GridSettings>
...
* [How to Integrate Top and Bottom Pager](https://demos.sunfish.dev/blazor-ui/pager/integration)

## See Also

  * [Live Demo: Grid Paging](https://demos.sunfish.dev/blazor-ui/grid/paging)
