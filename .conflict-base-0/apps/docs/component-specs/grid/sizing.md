...
description: Adjust the size and modify the appearance of the Sunfish UI for Blazor Grid.
slug: grid-sizing
tags: sunfish,blazor,grid,size,compact, dense, small
published: true
position: 47
components: ["grid"]
---
...
You can increase or decrease the size of the Grid by setting the `Size` attribute to a member of the [`Sunfish.Components.DataGrid.ThemeConstants.Grid.Size`](slug:Sunfish.Components.DataGrid.ThemeConstants.Grid.Size).Size class:
...
@{ 
    var fields = typeof(Sunfish.Components.DataGrid.ThemeConstants.Grid.Size)
...
```CSHTML
<SunfishDataGrid Size="@ThemeConstants.Grid.Size.Small"
             Data="@GridData"
			 Height="350px">
    <GridToolBarTemplate>
...
## See Also
  ...
  * [Live Demo: Grid Sizing](https://demos.sunfish.dev/blazor-ui/grid/sizing)
