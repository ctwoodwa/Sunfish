...
tags: sunfish,blazor,grid,grouping
published: True
...
>caption Enable grouping in Sunfish Grid

````RAZOR
Drag the column header of the "Team" and/or "On Vacation" column to the group panel at the top

<SunfishDataGrid Data=@GridData Groupable="true" Pageable="true" Height="400px">
...
>caption How grouping works in the Sunfish grid
...
The Grid provides grouping configuration options via the [`GridGroupableSettings` tag](slug:Sunfish.Components.DataGrid.GridGroupableSettings), which is nested inside `GridSettings`.
...
## See Also
  ...
  * [Live Demo: Grid Grouping](https://demos.sunfish.dev/blazor-ui/grid/grouping)
