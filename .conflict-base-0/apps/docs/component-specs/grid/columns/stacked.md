...
tags: sunfish,blazor,grid,column,stacked
published: true
position: 37
components: ["grid"]
---
...
````RAZOR.skip-repl
<SunfishDataGrid DataLayoutMode="@GridDataLayoutMode.Stacked" />
````
...
<SunfishDataGrid DataLayoutMode="@GridDataLayoutMode.Stacked">
    <GridSettings>
        ...
        <SunfishGridColumn Field="@nameof(Product.Price)" />
        <SunfishGridColumn Field="@nameof(Product.Quantity)" />
        <SunfishGridColumn Field="@nameof(Product.StartDate)" />
        <SunfishGridColumn Field="@nameof(Product.IsActive)" />
...
<SunfishMediaQuery Media="(min-width:1200px)" OnChange="@( (bool matches) => IsLargeScreen = matches )" />
<SunfishMediaQuery Media="(min-width:800px)" OnChange="@( (bool matches) => IsMediumScreen = matches )" />
<SunfishMediaQuery Media="(max-width:500px)" OnChange="@( (bool matches) => IsSmallScreen = matches )" />
...
<SunfishDataGrid Data="@GridData"
    ...
    <GridToolBar>
        ...
        <SunfishGridColumn Field="@nameof(Product.StartDate)" DisplayFormat="{0:d}" />
        <SunfishGridColumn Field="@nameof(Product.IsActive)" />
        <SunfishGridCommandColumn Width="120px">
...
* [Live demo: Adaptive Grid](https://demos.sunfish.dev/blazor-ui/grid/adaptive)
* [Live demo: Grid and MediaQuery Integration](https://demos.sunfish.dev/blazor-ui/mediaquery/grid-integration)
