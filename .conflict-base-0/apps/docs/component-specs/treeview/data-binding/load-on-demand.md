...
tags: sunfish,blazor,treeview,data,bind,databind,databinding,load,demand
published: True
position: 3
components: ["treeview"]
---
...
<SunfishTreeView Data="@HierarchicalData" OnExpand="@LoadChildren">
    <TreeViewBindings>
...
<SunfishTreeView Data="@FlatData" OnExpand="@LoadChildren">
    <TreeViewBindings>
...
@code {
    ...
    private async Task LoadChildren(TreeViewExpandEventArgs args)
    {
        ...
        if (args.Expanded && args.Item is ProductCategoryItem)
        {
            ...
            // the AddRange() method comes from the Sunfish.DataSource.Extensions
...
## See Also
  ...
  * [Live Demo: TreeView Load on Demand](https://demos.sunfish.dev/blazor-ui/treeview/lazy-loading)
