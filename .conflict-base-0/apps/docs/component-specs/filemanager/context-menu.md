...
tags: sunfish,blazor,filemanager,contextmenu, menu, context
published: True
position: 3
...
The component uses the Sunfish UI for [Blazor ContextMenu](slug:contextmenu-overview) and provides the following commands:
