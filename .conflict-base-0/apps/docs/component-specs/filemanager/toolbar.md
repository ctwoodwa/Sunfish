...
tags: sunfish,blazor,filemanager,toolbar, commands
published: True
position: 15
...
Add a `<FileManagerToolBar>` tag inside `<SunfishFileManager>` to configure a custom toolbar, for example:
...
<SunfishFileManager @ref="@FileManagerRef"
    ...
    <FileManagerToolBar>
        ...
        <FileManagerToolBarCustomTool>
            <SunfishButton Icon="@SvgIcon.Trash"
                           ...
                           Enabled="@SelectedItems.Any()">Delete</SunfishButton>
        </FileManagerToolBarCustomTool>
    </FileManagerToolBar>
</SunfishFileManager>

@code {
    private SunfishFileManager<FlatFileEntry> FileManagerRef;
...
* [Live Demo: FileManager Toolbar](https://demos.sunfish.dev/blazor-ui/filemanager/toolbar)
