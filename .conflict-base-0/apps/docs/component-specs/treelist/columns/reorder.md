...
tags: sunfish,blazor,treelist,column,reorder,drag
published: True
position: 2
components: ["treelist"]
---
...
>caption Reordering columns in the Sunfish TreeList

![Reorder columns in the sunfish treelist](images/column-reorder.gif)



## See Also

  * [Live Demo: Column Reordering](https://demos.sunfish.dev/blazor-ui/treelist/column-reordering)
