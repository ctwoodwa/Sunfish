...
tags: sunfish,blazor,treelist,virtual,scrolling
published: True
position: 25
components: ["treelist"]
---
...
> The Sunfish TreeList uses Blazor's built-in `<Virtualize>` component internally. The `ItemHeight` value maps directly to `Virtualize.ItemSize`.
...
* [Live Demo: TreeList Virtual Scrolling](https://demos.sunfish.dev/blazor-ui/treelist/virtual-scrolling)
