...
tags: sunfish,blazor,treelist,observable,data,new,collection
published: True
position: 60
components: ["treelist"]
---
...
<SunfishButton OnClick="@AddRootItem">Add root item at the end of the collection</SunfishButton>
...
@code {
    private SunfishTreeList<Employee> TreeListRef;
...
<SunfishButton OnClick="@ClearData">Clear Data</SunfishButton>
