...
tags: sunfish,blazor,treelist,templates,popup,edit,create
published: True
position: 50
components: ["treelist"]
---
                ...
                <TreeListPopupEditFormSettings>
                    <FormTemplate>
                        @{
                            ...
                            <SunfishForm Model="@EditItem" OnValidSubmit="@OnValidSubmit">
                                <FormItems>
                                ...
                                <FormButtons>
                                    ...
                                    <SunfishButton Icon="@nameof(SvgIcon.Cancel)" ButtonType="@ButtonType.Button" OnClick="@OnCancel">Cancel</SunfishButton>
                                </FormButtons>
                            </SunfishForm>
                        }
                    </FormTemplate>
...
@code {
    ...
    public SunfishTreeList<HierarchicalModel> TreeListRef { get; set; }
 ...
 * [Live Demo: TreeList Popup Edit Form Template](https://demos.sunfish.dev/blazor-ui/treelist/popup-edit-form-template)