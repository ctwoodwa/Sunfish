...
tags: sunfish,blazor,treelist,templates,pager
published: True
position: 40
components: ["treelist"]
---
...
>caption Using the Sunfish UI for Blazor Slider to paginate the TreeList data

````RAZOR
@* Sunfish Blazor TreeList with Pager Template *@
...
<SunfishTreeList Data="@TreeListData"
    ...
    <TreeListPagerTemplate>
        <div style="padding:10px">
            <SunfishSlider @bind-Value="@CurrentPage"
                           Width="100%"
                           Min="1"
                           Max="@Total">
            </SunfishSlider>
