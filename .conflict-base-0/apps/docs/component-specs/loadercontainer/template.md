...
tags: sunfish,blazor,loader,container,loadercontainer,templates
published: True
position: 10
...
<SunfishLoaderContainer Visible="@(GridData == null ? true : false)">
    <Template>
        <SunfishLoader></SunfishLoader>
        <div>
            <span><SunfishSvgIcon Icon="@SvgIcon.InfoCircle"></SunfishSvgIcon></span>
...
<SunfishLoaderContainer Class="my-loader-container" Visible="@(GridData == null ? true : false)">
    <Template>
        <SunfishLoader ThemeColor="light"></SunfishLoader>
        <div>
            <span><SunfishSvgIcon Icon="@SvgIcon.InfoCircle"></SunfishSvgIcon></span>
