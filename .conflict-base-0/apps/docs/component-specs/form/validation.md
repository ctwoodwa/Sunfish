...
tags: sunfish,blazor,form,edit,form,validation
published: True
position: 5
components: ["form"]
---
...
To enable validation in the Sunfish Form for Blazor add the `<FormValidation>` tag inside the `<SunfishForm>`. The `<FormValidation>` is used to provide validation configuration such as a validator (for example the `<DataAnnotationsValidator>`) and other validation settings like `ValidationSummary`.

>caption Enable validation in the Sunfish Form for Blazor
...
<SunfishForm Model="@person" ValidationMessageType="@FormValidationMessageType.Tooltip">
    <FormValidation>
...
````RAZOR
@* Use the Sunfish Edit Form for Blazor to Validate a model *@
...
You can use the <a href="https://learn.microsoft.com/en-us/aspnet/core/blazor/forms/validation?view=aspnetcore-8.0#nested-models-collection-types-and-complex-types" target="_blank">ObjectGraphDataAnnotationsValidator</a> inside the Sunfish Form for Blazor to validate a nested model.
...
You can use third-party validation libraries that integrate with the standard `EditContext` such as [FluentValidation](https://fluentvalidation.net/) together with the Sunfish Form for Blazor.
...
<SunfishForm Model="@PersonToEdit"
        ...
        <FormItem Field="@nameof(Person.MiddleName)">
            <Template>
                ...
                <div class="k-form-field-wrap">
                    ...
                    <SunfishValidationMessage For="@( () => PersonToEdit.MiddleName )" />
                </div>
            </Template>
        </FormItem>
            ...
            <Template>
                ...
                <div class="k-form-field-wrap">
                    <TextBox Value="@PersonToEdit.LastName"
                             ...
                             Id="person-lastname" />
                    <SunfishValidationMessage For="@( () => PersonToEdit.LastName )" />
                </div>
            </Template>
        </FormItem>
    </FormItems>
