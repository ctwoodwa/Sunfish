...
tags: sunfish,blazor,Gantt,observable,data,new,collection
published: True
position: 20
components: ["gantt"]
---
...
<SunfishButton OnClick="@AddRootTask">Add root task</SunfishButton>

<SunfishButton OnClick="@RemoveTask">Remove Task 1</SunfishButton>
