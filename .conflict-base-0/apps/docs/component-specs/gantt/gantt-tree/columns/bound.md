...
tags: sunfish,blazor,gantt,bound,column
published: True
position: 0
components: ["gantt"]
---
...
The Blazor Gantt Bound Column provides various parameters to configure the component. Also check the [Gantt public API](slug:Sunfish.Components.DataDisplay.SunfishGantt-1).
