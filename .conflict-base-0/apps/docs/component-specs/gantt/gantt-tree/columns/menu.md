...
tags: sunfish,blazor,gantt,column,columns,menu
published: True
position: 20
components: ["gantt"]
---
...
To enable the Column Menu, set the `ShowColumnMenu` parameter of the `<SunfishGantt>` tag to `true`. This will enable the menu for each column of the Gantt.
...
## See Also
  * [Live Demo: Gantt Column Menu](https://demos.sunfish.dev/blazor-ui/gantt/column-menu)
  * [Live Demo: Gantt Custom Column Menu](https://demos.sunfish.dev/blazor-ui/gantt/custom-column-menu)