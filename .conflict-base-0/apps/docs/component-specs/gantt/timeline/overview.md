...
slug: gantt-timeline
tags: sunfish,blazor,gantt,chart,timeline
published: True
position: 0
components: ["gantt"]
---
...
|---|---|---|---|
| `--sunfish-gantt-bar-height` | `24px` | `24px` | Bar element height |
| `--sunfish-gantt-bar-bg` | `var(--colorBrandBackground, #0078d4)` | `var(--bs-primary, #0d6efd)` | Bar fill colour |
| `--sunfish-gantt-bar-radius` | `4px` | `var(--bs-border-radius-sm, 0.25rem)` | Bar corner rounding |
| `--sunfish-gantt-bar-color` | `var(--colorNeutralForegroundOnBrand, #fff)` | `#fff` | Bar text/icon colour |
| `--sunfish-gantt-bar-font-size` | `12px` | `12px` | Bar label size |
| `--sunfish-gantt-row-height` | `36px` | `36px` | Vertical space per bar row |
