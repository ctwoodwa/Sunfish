...
tags: sunfish,blazor,autocomplete,combo,overview
published: True
position: 0
...
<br />
<SunfishAutoComplete Data="@Suggestions"
...
````RAZOR
<SunfishAutoComplete Data="@AutoCompleteData"
...
Add a reference to the component instance to use the [AutoComplete's methods](slug:Sunfish.Blazor.Components.SunfishAutoComplete-1). Note that the [AutoComplete is a generic component](slug:common-features-data-binding-overview#component-type).

@[template](/_contentTemplates/dropdowns/methods.md#methods-list)

````RAZOR
<SunfishAutoComplete @ref="@AutoCompleteRef"
                     Data="@Suggestions"
                     @bind-Value="@AutoCompleteValue" 
                     Width="300px"/>
...
* [Live Demo: AutoComplete](https://demos.sunfish.dev/blazor-ui/autocomplete/overview)
* [Live Demo: AutoComplete Validation](https://demos.sunfish.dev/blazor-ui/autocomplete/validation)
* [AutoComplete API Reference](slug:Sunfish.Blazor.Components.SunfishAutoComplete-1)
