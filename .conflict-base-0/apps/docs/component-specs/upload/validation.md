...
* client validation - by the Sunfish Upload component
* server validation - in the application endpoints

The Sunfish Upload component offers parameters to validate selected files on the client:
...
>caption Client validation by the Sunfish Upload
...
<SunfishUpload AllowedExtensions="@ValidFiles"
...
>note The [Blazor framework does not support form validation for files](https://github.com/dotnet/aspnetcore/issues/18821). We made [an example that creates similar experience](https://github.com/ctwoodwa/sunfish-archive/blazor-ui/tree/master/upload/form-validation). Use it as base for your implementation.
...
* [Live Demo: Upload Validation](https://demos.sunfish.dev/blazor-ui/upload/validation)
