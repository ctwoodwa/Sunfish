...
tags: sunfish,blazor,flatcolorpicker,events
published: true
position: 20
...
This article describes the available events of the Sunfish FlatColorPicker for Blazor.
...
<SunfishFlatColorPicker @bind-Value="@Color" OnChange="@FlatColorPickerOnChange" />
...
<SunfishFlatColorPicker Value="@Color" ValueChanged="@FlatColorPickerValueChanged" />
...
<SunfishFlatColorPicker @bind-Value="@Color" View="@View" ViewChanged="@FlatColorPickerViewChanged" />
