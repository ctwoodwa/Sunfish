...
tags: sunfish,blazor,date,input,dateinput,overview
published: True
position: 0
...
>caption Basic Sunfish Blazor DateInput

````RAZOR
<SunfishDateInput @bind-Value="@DateValue"
                  Format="dd MMMM yyyy"
                  Min="@MinDate"
                  Max="@MaxDate"
...
The following section lists some Date Input parameters and links to other pages that provide information for more parameters. Also check the [DateInput API Reference](slug:Sunfish.Blazor.Components.SunfishDateInput-1) for all parameters, methods and events.
...
````RAZOR
<SunfishDateInput @ref="@DateInputRef"
                  @bind-Value="@DateValue"
                  Width="200px">
</SunfishDateInput>

<SunfishButton OnClick="@OnButtonClick">Focus DateInput</SunfishButton>

@code {
    private SunfishDateInput<DateTime> DateInputRef { get; set; }
...
* [Live Demo: Date Input](https://demos.sunfish.dev/blazor-ui/dateinput/overview)
* [Input Validation](slug:common-features/input-validation)
* [Date Input API Reference](slug:Sunfish.Blazor.Components.SunfishDateInput-1)
