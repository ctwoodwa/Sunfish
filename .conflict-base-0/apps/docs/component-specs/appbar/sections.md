...
tags: sunfish,blazor,appbar,sections,section,content
published: True
position: 1
components: ["appbar"]
---
...
>caption The Sunfish AppBar sections with its parameter
...
<SunfishButton OnClick="@(() => isSectionVisible = !isSectionVisible)">Toggle the visibility of the Our Mission section</SunfishButton>
