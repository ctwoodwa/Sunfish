...
<SunfishContextMenu Data="@MenuItems" @ref="@TheContextMenu">
    <Template>
        ...
        @if (UseSpecialMenu)
        {
            <SunfishButton OnClick="@( () => Console.WriteLine($"do more with {dataSource[1].Text}") )">Do More</SunfishButton>
        }
    </Template>
</SunfishContextMenu>
...
## See Also
  ...
  * [Live Demo: Context Menu Templates](https://demos.sunfish.dev/blazor-ui/contextmenu/templates)
