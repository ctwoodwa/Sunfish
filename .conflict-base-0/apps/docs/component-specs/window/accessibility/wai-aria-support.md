...
page_title: Sunfish UI for Blazor Window Documentation | Window Accessibility
...
Out of the box, the Sunfish UI for Blazor Window provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the Window keyboard navigation works, refer to the [Blazor Window Accessibility and Keyboard Navigation Demo](https://demos.sunfish.dev/blazor-ui/window/keyboard-navigation).
