...
tags: sunfish,blazor,window,position
published: True
position: 2
components: ["window"]
---
...
The Sunfish Window component provides multiple options to control its position, allowing you to customize its placement and behavior to suit your application's layout and requirements. This article contains the following sections:
...
In this case, the Window will render inside the specified container and not as a child of the [`SunfishRootComponent`](slug:rootcomponent-overview).
...
<div id="window-container"
    ...
    <SunfishButton OnClick="@( () => WindowVisible = !WindowVisible )">Toggle Window</SunfishButton>

    <SunfishWindow ContainmentSelector="#window-container"
...
### Center
 ...
 The Sunfish Window is automatically centered when the `Top` and `Left` parameters are not set or are explicitly set to `string.Empty`. To see this behavior in action, refer to the [example](#example) below.
...
<SunfishWindow @ref="@WindowRef"
    ...
    <WindowFooter>
        <SunfishButton OnClick="@CenterWindow">Center Window</SunfishButton>
    </WindowFooter>
</SunfishWindow>
...
* [Live Demo: Window Position](https://demos.sunfish.dev/blazor-ui/window/position)
* [Live Demo: Constrain Window Movement](https://demos.sunfish.dev/blazor-ui/window/constrain-movement)
