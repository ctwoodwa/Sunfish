...
tags: sunfish,blazor,drawer,navigation
published: True
position: 3
components: ["drawer"]
---
...
<SunfishRootComponent>
    ...
    <SunfishDrawer Data="@NavigablePages" Expanded="true" MiniMode="true" Mode="@DrawerMode.Push">
        <DrawerContent>
            @Body
        </DrawerContent>
    </SunfishDrawer>
...
* A GitHub sample project that showcases [Drawer as side navigation](https://github.com/ctwoodwa/sunfish-archive/blazor-ui/tree/master/drawer/sidenav).
