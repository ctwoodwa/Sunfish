...
tags: sunfish,blazor,drawer,templates
published: True
position: 12
components: ["drawer"]
---
...
<SunfishButton OnClick="@(() => DrawerRef.ToggleAsync())" Icon="@SvgIcon.Menu" />

<SunfishDrawer @bind-Expanded="@Expanded"
               Data="@Data"
               MiniMode="true"
    ...
    <ItemTemplate Context="item">
        <SunfishSvgIcon Icon="@item.Icon" Class="styled-icon"></SunfishSvgIcon>
        @if (Expanded)
        {
...
@code {
    public SunfishDrawer<DrawerItem> DrawerRef { get; set; }
...
>tip You can find a runnable sample that showcases this in the [Drawer as Side Navigation using the Template](https://github.com/ctwoodwa/sunfish-archive/blazor-ui/tree/master/drawer/template) sample project.
...
<SunfishDrawer @bind-Expanded="@DrawerExpanded"
               Data="@Data"
               MiniMode="true"
               Mode="@DrawerMode.Push"
               @bind-SelectedItem="@SelectedItem"
    ...
    <Template>
        ...
        @if (DrawerExpanded)
        {
            <div style="text-align: center; margin-top: 3em; padding-top: 2em; border-top: 2px solid black; white-space:nowrap">
                ...
                <br /><br />
                <SunfishButton Icon="@SvgIcon.Logout" ThemeColor="primary">Log Out</SunfishButton>
            </div>
        }
    </Template>
    <DrawerContent>
...
* [Drawer Templates Demo](https://demos.sunfish.dev/blazor-ui/drawer/overview)
* [Drawer Data Binding](slug:drawer-data-binding)
* [Drawer Navigation](slug:drawer-navigation)
* [Hierarchical Drawer Demo](https://demos.sunfish.dev/blazor-ui/drawer/hierarchical-drawer)
