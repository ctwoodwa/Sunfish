...
<SunfishComboBox Data="@ComboBoxData" @bind-Value="@Role" Placeholder="Write your position">
    <HeaderTemplate>
...
## See Also
  ...
  * [Live Demo: ComboBox Templates](https://demos.sunfish.dev/blazor-ui/combobox/templates)
