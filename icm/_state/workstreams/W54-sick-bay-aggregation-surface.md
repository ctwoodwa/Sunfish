...
status: "building"
status_cell: "`building` (Phase 1 #628 + Phase 2 #695 + Phase 2b #811 + **Phase 3a MERGED PR #817** — 6 Blazor components (SickBayBlock/PharmacyTabContent/LabTabContent/AtmosphereTabContent/FirstAidTab/MedevacDialog) + 20 bUnit tests; WCAG/a11y+arch+security councils PASS (1 Blocking fixed: MedevacDialog initial focus + inline Tab-trap); **Phase 3b next** — SickBayCommandService + MedevacOrchestrator + IKeyRotationScheduler impl; security-engineering council mandatory)"
owner: "sunfish-PM"
