...
status: "building"
status_cell: "`building` — **Phase 1–4 MERGED 2026-05-13** (PR #624 + #711 + #753 + #756 + #759 + #762 + **#787**; `blocks-ships-office` + `foundation-ships-office` + 5 Razor + Anchor + Bridge wiring + apps/docs + 59 tests); Phase 5 gated on ADR 0055 Accepted (H4 gate); Phase 6 ledger flip pending"
owner: "sunfish-PM"
