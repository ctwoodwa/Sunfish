...
| 14 | ADR 0013 provider-neutrality enforcement gate (Roslyn analyzer + BannedSymbols) | `ready-to-build` | sunfish-PM (next) | `icm/_state/handoffs/adr-0013-enforcement-gate.md` | UPF-graded A. User approved 2026-04-28. ~3 hours sunfish-PM. Pre-Phase-2 urgency: must land before first `providers-*` package scaffolds. Resolves audit finding C-1. |
