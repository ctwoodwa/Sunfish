...
- **Commercial services operate as a separate legal entity.** LLC or corporation structure is TBD; the decision will be made before the first commercial customer contract is signed so that invoicing and liability are clean from day one.
...
| First commercial customer (Level 4 signal) | Commercial entity formalized (LLC or corporation). Contract templates published (master services agreement, SLA, statement-of-work template, terms of service for hosted tenants). |
