...
tags: sunfish,blazor,combo,combobox,virtualization
published: True
position: 30
...
* `ScrollMode` - `Sunfish.Blazor.DropDownScrollMode` - set it to `DropDownScrollMode.Virtual`. It defaults to the "regular" scrolling.
...
@SelectedValue
<br />
<SunfishMultiColumnComboBox Data="@Data"
                            TItem="Person"
                            TValue="int"
...
<SunfishMultiColumnComboBox TItem="Person"
                            TValue="int"
                            TextField="@TextField"
...
## See Also
  ...
  * [Live Demo: MultiColumnComboBox Virtualization](https://demos.sunfish.dev/blazor-ui/multicolumncombobox/virtualization)
