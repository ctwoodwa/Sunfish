...
tags: sunfish,blazor,circular,gauge,overview
published: True
position: 0
...
The <a href = "https://sunfish.dev/blazor-ui/circular-gauge" target="_blank">Sunfish Circular Gauge for Blazor</a> represents [numerical values](slug:circular-gauge-pointers) on a circular [scale](slug:circular-gauge-scale).

## Creating Blazor Circular Gauge

1. Add the `<SunfishCircularGauge>` tag.
...
>caption Basic Sunfish Circular Gauge for Blazor.

````RAZOR
@* Setup a basic circular gauge with center label template *@

<SunfishCircularGauge Width="100px" Height="100px">
...
<SunfishButton OnClick="@ChangeTheHeight">Change the Height of the component</SunfishButton>

<SunfishCircularGauge @ref="@CircularGaugeRef" Height="@Height">
    <CircularGaugePointers>
...
@code {
    Sunfish.Blazor.Components.SunfishCircularGauge CircularGaugeRef { get; set; }
...
* [Live Demo: Circular Gauge](https://demos.sunfish.dev/blazor-ui/circulargauge/overview)