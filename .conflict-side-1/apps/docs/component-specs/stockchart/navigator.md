...
tags: sunfish,blazor,stock,chart,navigator
published: true
position: 2
...
1. set up a [`<SunfishStockChart>`](slug:stockchart-overview)
1. add a `<StockChartNavigator>` inside the main `<SunfishStockChart>`
