...
page_title: Sunfish UI for Blazor ColorGradient Documentation | ColorGradient Accessibility
description: "Get started with the Sunfish UI for Blazor ColorGradient and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Sunfish UI for Blazor ColorGradient provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the ColorGradient keyboard navigation works, refer to the [Blazor ColorGradient Accessibility and Keyboard Navigation Demo](https://demos.sunfish.dev/blazor-ui/colorgradient/keyboard-navigation).
