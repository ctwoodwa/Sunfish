...
slug: menu-icons
tags: sunfish,blazor,menu,icon,iconclass,image
published: True
position: 15
components: ["menu"]
---
...
You can add [Sunfish Font or SVG icons](slug:common-features-icons) to the Menu items. The component also supports custom icons.
...
>caption How to use icons in the Sunfish Menu

````RAZOR
<SunfishMenu Data="@MenuData"
...
* [Online Demo: Menu Icons](https://demos.sunfish.dev/blazor-ui/menu/images)
