...
tags: sunfish,blazor,menu,overview
published: True
position: 0
components: ["menu"]
---
...
The following table lists Context Menu parameters, which are not related to other features on this page. Check the [Menu API Reference](slug:Sunfish.Blazor.Components.SunfishMenu-1) for a full list of properties, methods and events.
...
* [Live Demo: Menu](https://demos.sunfish.dev/blazor-ui/menu/overview)
* [Menu API Reference](slug:Sunfish.Blazor.Components.SunfishMenu-1)
