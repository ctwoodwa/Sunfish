...
tags: sunfish,blazor,dockmanager,state,save,load,layout,set,change,management
published: True
position: 15
...
<SunfishButton OnClick="@GetDockManagerState">Get State</SunfishButton>
<SunfishButton OnClick="@SetDockManagerState">Set State</SunfishButton>

<SunfishDockManager @ref="DockManager"
                    Height="600px"
                    OnStateInit="@OnStateInit"
                    OnStateChanged="@OnStateChanged">
    <DockManagerPanes>
...
@code {
    ...
    private SunfishDockManager DockManager { get; set; }
...
* [DockManagerState API reference](slug:Sunfish.Blazor.Components.SunfishDockManager)
