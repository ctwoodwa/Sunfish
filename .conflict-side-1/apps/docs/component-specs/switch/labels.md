...
slug: switch-labels
tags: sunfish,blazor,labels,on,off
published: True
position: 10
components: ["switch"]
---
...
<SunfishSwitch @bind-Value="@hasAgreed"
               OnLabel="@myOnLabel"
               OffLabel="@myOffLabel"
               Width="100px">
</SunfishSwitch>
...
<SunfishSwitch @bind-Value="@isSelected" OnLabel=" " OffLabel=" " />
...
## See Also
* [Live Demo: Switch Labels](https://demos.sunfish.dev/blazor-ui/switch/labels)
