...
description: Events available in the Sunfish Blazor Data Pager component.
slug: pager-events
tags: sunfish,blazor,pager,paging,events
published: True
position: 20
components: ["pager"]
---
...
This article explains the events available in the Sunfish Pager for Blazor:
