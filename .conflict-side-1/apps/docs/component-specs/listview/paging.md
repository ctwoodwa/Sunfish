...
tags: sunfish,blazor,listview,paging
published: True
position: 4
components: ["listview"]
---
...
<SunfishListView Data="@ListViewData" Pageable="true" PageSize="15">
    <Template>
...
* [Live Demo: ListView](https://demos.sunfish.dev/blazor-ui/listview/overview)
