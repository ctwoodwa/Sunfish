...
tags: sunfish,blazor,range,slider,label,template
published: true
position: 10
...
<SunfishRangeSlider @bind-StartValue="@TheStartValue"
...
<SunfishRangeSlider @bind-StartValue="@TheStartIndex"
...
* [Live Demo: RangeSlider Label Template](https://demos.sunfish.dev/blazor-ui/rangeslider/label-template)