...
tags: sunfish,blazor,masked,Color,Palette,overview
published: True
position: 0
...
1. Add the `<SunfishColorPalette>` tag to a Razor file.
...
````RAZOR
<SunfishColorPalette @bind-Value="@MyColor" />
...
The Blazor ColorPalette provides various parameters to configure the component. Also check the [ColorPalette public API](slug:Sunfish.Blazor.Components.SunfishColorPalette).
...
* [Live ColorPalette Demos](https://demos.sunfish.dev/blazor-ui/colorpalette/overview)
* [ColorPalette API Reference](slug:Sunfish.Blazor.Components.SunfishColorPalette)
