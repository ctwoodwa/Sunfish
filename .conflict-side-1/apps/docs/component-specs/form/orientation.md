...
tags: sunfish,blazor,form,edit,form,orientation
published: True
position: 10
components: ["form"]
---
...
The Form component for Blazor allows you control its orientation through the `Orientation` parameter. It takes a member of the `Sunfish.Blazor.Enums.FormOrientation` enum:
...
<div>
    <SunfishDropDownList @bind-Value="@Orientation" Data="@OrientationTypes"></SunfishDropDownList>
</div>
