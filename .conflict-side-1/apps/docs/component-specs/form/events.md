...
slug: form-events
tags: sunfish,blazor,form,edit,events
published: True
position: 30
components: ["form"]
---
...
<SunfishForm EditContext="@myEditContext"
...
The `OnUpdate` event argument is a [`FormUpdateEventArgs` object](slug:Sunfish.Blazor.Components.FormUpdateEventArgs) with the following properties:
    ...
    <FormItems>
        <FormItem Field="@nameof(Person.FirstName)">
            <Template>
                FirstName
                <br />
                <SunfishTextBox @bind-Value="@Colleague.FirstName"
