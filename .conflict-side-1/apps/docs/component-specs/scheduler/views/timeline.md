...
tags: sunfish,blazor,scheduler,view,timeline
published: True
position: 5
...
<SunfishScheduler Data="@Appointments" @bind-Date="@StartDate" Width="1000px">
    <SchedulerViews>
...
* [Live Demo: Scheduler Timeline View](https://demos.sunfish.dev/blazor-ui/scheduler/timeline-view)
