...
slug: sankey-labels
tags: sunfish,blazor,sankey,diagram,chart,labels
published: True
position: 5
components: ["sankey"]
---
...
To customize the labels, declare a `<SankeyLabels>` tag as a direct child of `<SunfishSankey>`. The `<SankeyLabels>` tag has the following parameters:

| Parameter | Type and Default&nbsp;Value | Description |
| --------- | ---- | ----------- |
| `Align` | [`SankeyLabelsAlign` enum](slug:sunfish.blazor.sankeylabelsalign) <br/> (`Left`) | The alignment of the labels. |
...
| `Position` | [`SankeyLabelsPosition` enum](slug:sunfish.blazor.sankeylabelsposition) <br/> (`Inside`) | The position of the labels. |
...
| `DashType` | [`DashType` enum](slug:sunfish.blazor.dashtype) <br/> (`Solid`) | The style of the border. |
