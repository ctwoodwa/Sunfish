...
slug: sankey-nodes
tags: sunfish,blazor,sankey,diagram,chart,nodes
published: True
position: 0
components: ["sankey"]
---
...
To customize the nodes, declare the `<SankeyNodes>` tag as a direct child of `<SunfishSankey>`. The `<SankeyNodes>` tag exposes the following parameters:

| Parameter | Type and Default&nbsp;Value | Description |
| --------- | ---- | ----------- |
| `Align` | [`SankeyNodesAlign` enum](slug:sunfish.blazor.sankeynodesalign) <br/> (`Stretch`) | The nodes alignment. |
