...
tags: sunfish,blazor,date,range,picker,daterangepicker,overview
published: True
position: 0
...
The <a href="https://sunfish.dev/blazor-ui/daterange-picker" target="_blank">Blazor DateRange Picker component</a> allows the user to select a date range (start and end date) - both from a visual list ([Sunfish UI for Blazor Calendar](slug:components/calendar/overview)) or to type it into a [date input](slug:components/dateinput/overview) that can accept only dates. You can control the format shown in the input, and dates the user cannot select, as well as implement validation and respond to events.

## Creating Blazor Date Range Picker

1. Use the `SunfishDateRangePicker` tag to add the component to your razor page.
...
The Blazor Date Range Picker provides various parameters that allow you to configure the component. Also check the [DateRangePicker's public API](slug:Sunfish.Blazor.Components.SunfishDateRangePicker-1).
...
| `DisabledDates` | `List<DateTime>` | A list of dates that can not be selected as the start or end of the range. See the <a href="https://demos.sunfish.dev/blazor-ui/daterangepicker/disabled-dates" target="_blank">Live Demo: Date Range Picker Disabled Dates</a>. |
...
Add a reference to the component instance to use the [Date Range Picker's methods](slug:Sunfish.Blazor.Components.SunfishDateRangePicker-1).
...
````RAZOR
<SunfishButton OnClick="@FocusStart">Focus Start TextBox</SunfishButton>
<SunfishButton OnClick="@FocusEnd">Focus End TextBox</SunfishButton>
<SunfishButton OnClick="@OpenPicker">Open DateRangePicker</SunfishButton>

<SunfishDateRangePicker @ref="@DateRangePickerRef"
...
@code {
    ...
    private SunfishDateRangePicker<DateTime> DateRangePickerRef { get; set; }
...
* [Live Demo: Date Range Picker](https://demos.sunfish.dev/blazor-ui/daterangepicker/overview)
* [Input Validation](slug:common-features/input-validation)
* [Supported Input Date Formats](slug:components/dateinput/supported-formats)
* [DateRangePicker API Reference](slug:Sunfish.Blazor.Components.SunfishDateRangePicker-1)
