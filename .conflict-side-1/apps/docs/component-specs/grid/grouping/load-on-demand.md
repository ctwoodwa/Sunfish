...
slug: grid-group-lod
tags: sunfish,blazor,grid,group,load,on,demand
published: True
position: 10
components: ["grid"]
---
...
<SunfishDataGrid Data="@GridData"
    ...
    <GridAggregates>
        ...
        <SunfishGridColumn Field="@nameof(Employee.Salary)" Groupable="false">
            <GroupFooterTemplate>
...
<SunfishDataGrid TItem="@object"
        ...
        <SunfishGridColumn Field="@nameof(Employee.Salary)" FieldType="@typeof(decimal)" Groupable="false" />
...
<p>
    <label>
        <SunfishCheckBox Value="@GridLoadGroupsOnDemand"
...
<SunfishDataGrid @ref="@GridRef"
        ...
        <SunfishGridColumn Field="@nameof(Employee.Salary)" />
        <SunfishGridColumn Field="@nameof(Employee.OnVacation)" />
</SunfishDataGrid>
...
* [Live Demo: Grid Group Load On Demand](https://demos.sunfish.dev/blazor-ui/grid/group-loadondemand)
