...
tags: sunfish,blazor,grid,hierarchy,detail,detail template
published: True
position: 40
components: ["grid"]
---
...
<SunfishDataGrid Data="salesTeamMembers">
    <DetailTemplate>
        @{
            var employee = context as MainModel;
            <SunfishDataGrid Data="employee.Orders" Pageable="true" PageSize="5">
                    <SunfishGridColumn Field="OrderId"></SunfishGridColumn>
                    <SunfishGridColumn Field="DealSize"></SunfishGridColumn>
            </SunfishDataGrid>
        }
    </DetailTemplate>
        <SunfishGridColumn Field="Id"></SunfishGridColumn>
        <SunfishGridColumn Field="Name"></SunfishGridColumn>
</SunfishDataGrid>
...
* [Load Hierarchical Data On Demand](https://github.com/ctwoodwa/sunfish-archive/blazor-ui/tree/master/grid/load-on-demand-hierarchy)

* [Multi-Level Hierarchy](slug:grid-three-level-hierarchy)

* [Align Columns in Nested Grids](slug:grid-kb-align-columns-hierarchy)

* [Custom Excel Export that Includes Hierarchy](https://github.com/ctwoodwa/sunfish-archive/blazor-ui/tree/master/grid/export-to-xlsx-hierarchy)
...
* [Live Demo: Grid Hierarchy](https://demos.sunfish.dev/blazor-ui/grid/hierarchy)
