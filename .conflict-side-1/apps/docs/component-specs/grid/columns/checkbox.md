...
description: Configuration options for the Sunfish Blazor Grid Checkbox Column
slug: components/grid/columns/checkbox
tags: sunfish,blazor,grid,column,selection
published: True
position: 10
components: ["grid"]
---
...
@*If the Grid has data operations enabled, see
    https://docs.sunfish.dev/blazor-ui/knowledge-base/grid-get-filtered-data
...
* [Live Demo: Grid Selection](https://demos.sunfish.dev/blazor-ui/grid/row-selection)
