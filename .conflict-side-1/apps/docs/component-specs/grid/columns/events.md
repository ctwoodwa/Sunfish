...
tags: sunfish,blazor,grid,column,columns,events
published: True
position: 100
components: ["grid"]
---
...
This article explains the events available for the Columns of the Sunfish Grid for Blazor.
...
<SunfishDataGrid Data="@MyData"
        ...
        <SunfishGridColumn Field="@(nameof(SampleData.Team))" Title="Team" OnCellRender="@((x) => OnCellRenderHandler(x, "Team"))" />
        <SunfishGridColumn Field="@(nameof(SampleData.HireDate))" Title="Hire date" />
</SunfishDataGrid>
