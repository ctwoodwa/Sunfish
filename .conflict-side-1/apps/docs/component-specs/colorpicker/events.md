...
tags: sunfish,blazor,colorpicker,events
published: true
position: 20
...
This article describes the available events of the Sunfish ColorPicker for Blazor.
...
<SunfishColorPicker @bind-Value="@Color" OnChange="@ColorPickerOnChange" />
...
<SunfishColorPicker Value="@Color" ValueChanged="@ColorPickerValueChanged" />
...
<SunfishColorPicker @bind-Value="@Color" View="@View" ViewChanged="@ColorPickerViewChanged" />
...
````RAZOR
<SunfishColorPicker @bind-Value="@Color" OnOpen="@OnColorPickerPopupOpen" />
...
<SunfishColorPicker @bind-Value="@Color" OnClose="@OnColorPickerPopupClose" />
