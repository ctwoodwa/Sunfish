...
tags: sunfish,blazor,calendar,events
published: true
position: 21
components: ["calendar"]
---
...
This article explains the events available in the Sunfish Calendar for Blazor:
...
<SunfishCalendar Min="@CalendarMin"
                 Max="@CalendarMax"
                 Date="@CalendarDate"
...
@result
<br />
<SunfishCalendar Min="@min" Max="@max" View="@initialView" ViewChanged="@ViewChangedHandler">
</SunfishCalendar>
...
<SunfishCalendar OnCellRender="@OnCellRender">
</SunfishCalendar>
