...
tags: sunfish,blazor,chunk,chunkprogressbar,progress,bar,progressbar,overview
published: True
position: 0
...
The <a href = "https://sunfish.dev/blazor-ui/chunkprogressbar" target = "_blank">Blazor ChunkProgressBar component</a> tracks the execution of operations and displays what portion of it is completed in predefined number of sections (chunks). For very long tasks, you can also make it [indeterminate](slug:chunkprogressbar-indeterminate-state) while waiting for an update.


## Creating Blazor ChunkProgressBar

1. Add the `<SunfishChunkProgressBar>` tag.
...
<SunfishChunkProgressBar Value="@ChunkProgressBarValue" Max="@MaxValue" />
...
````RAZOR
<SunfishChunkProgressBar Value="2"
                         Max="3"
                         ChunkCount="3">
</SunfishChunkProgressBar>
````
...
````RAZOR
<SunfishChunkProgressBar Value="3"
                         Max="10"
                         ChunkCount="4">
</SunfishChunkProgressBar>
````
...
<div style="width: 50%; border: 1px solid red;">
    ...
    <SunfishChunkProgressBar Class="width-100" Value="44" />
</div>
````
...
* [Live Demo: ChunkProgressBar](https://demos.sunfish.dev/blazor-ui/chunkprogressbar/overview)
* [ChunkProgressBar API Reference](slug:Sunfish.Blazor.Components.SunfishChunkProgressBar)
