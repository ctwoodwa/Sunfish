...
tags: sunfish,blazor,fileselect,templates
published: True
position: 30
...
<SunfishFileSelect>
    <SelectFilesButtonTemplate>
        <SunfishSvgIcon Icon="@SvgIcon.Upload" />
...
```CSHTML
<SunfishFileSelect @ref="@FileSelectRef" Files="@InitialFiles">
...
```CSHTML
<SunfishFileSelect Files="@InitialFiles">
