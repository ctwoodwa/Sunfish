...
tags: sunfish,blazor,window,draggable,movable
published: True
position: 5
components: ["window"]
---
...
<SunfishWindow Visible="true" @bind-Left="@TheLeft" @bind-Top="@TheTop">
...
<SunfishWindow Visible="true" Draggable="false" Left="400px" Top="200px">
...
## See Also
  ...
  * [Live Demo: Draggable Window](https://demos.sunfish.dev/blazor-ui/window/draggable)
