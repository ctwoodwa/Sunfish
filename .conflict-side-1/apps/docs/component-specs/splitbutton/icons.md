...
tags: sunfish,blazor,splitbutton,icons
published: True
position: 5
...
The `<SunfishSplitButton>` and `<SplitButtonItem>` provide an `Icon` parameter that allows you to add an icon to the main button and all secondary action items.
...
>caption How to use icons in Sunfish Blazor SplitButton

````RAZOR
<SunfishSplitButton Icon="@SvgIcon.Table">
    ...
    <SplitButtonItems>
        ...
        <SplitButtonItem> <SunfishLoader /> Custom Markup </SplitButtonItem>
    </SplitButtonItems>
</SunfishSplitButton>
...
* [Live Demo: SplitButton Icons](https://demos.sunfish.dev/blazor-ui/splitbutton/overview)
