...
tags: sunfish,blazor,gantt,column,resize,drag
published: True
position: 3
components: ["gantt"]
---
...
>caption Enable column resizing in Sunfish Gantt Tree
...
## See Also
  ...
  * [Live Demo: Column Resizing](https://demos.sunfish.dev/blazor-ui/gantt/column-resizing)
