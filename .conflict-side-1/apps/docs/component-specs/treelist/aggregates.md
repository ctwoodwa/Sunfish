...
There are several available aggregate functions under the `Sunfish.Blazor.GridAggregateType` enum:
...
<SunfishGrid Data=@GridData Groupable="true" Pageable="true" Height="650px">
    <GridAggregates>
