...
tags: sunfish,blazor,TreeList,filtering,filter,CheckBoxList
published: True
position: 15
components: ["treelist"]
---
...
1. Set the `FilterMode` parameter of the grid to `Sunfish.Blazor.TreeListFilterMode.FilterMenu`
1. Set the `FilterMenuType` parameter of the grid to `Sunfish.Blazor.FilterMenuType.CheckBoxList`. It defaults to `Menu` for the default behavior.
...
<SunfishTreeList Data="@Data" FilterMode="@TreeListFilterMode.FilterMenu" FilterMenuType="@FilterMenuType.CheckBoxList"
...
## See Also
  ...
  * [Live Demo: Treelist CheckBox List Filter](https://demos.sunfish.dev/blazor-ui/treelist/filter-checkboxlist)
