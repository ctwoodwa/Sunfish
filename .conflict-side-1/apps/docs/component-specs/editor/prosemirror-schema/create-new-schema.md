...
tags: sunfish,blazor,editor,prosemirror,schema
published: True
position: 5
components: ["editor"]
---
...
@code {
    ...
    {
        EditorValue = @"
        <p>This Sunfish Blazor Editor uses a ProseMirror Schema that supports only several nodes and marks - Paragraph, Hyperlinks, Bold text, Emphasized text, Underlined text.</p>
...
* [Live Demo: Editor - ProseMirror Schema](https://demos.sunfish.dev/blazor-ui/editor/prosemirror-schema)
...
Similar to how this is handled in the Grid State article - https://docs.sunfish.dev/blazor-ui/components/grid/state#examples
-->