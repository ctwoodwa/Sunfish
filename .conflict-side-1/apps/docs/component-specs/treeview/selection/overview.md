...
tags: sunfish,blazor,treeview,selection,overview
published: True
position: 1
components: ["treeview"]
---
...
@if (SelectedItems.Any())
{
    ...
    <div>
        Selected item: <strong> <SunfishSvgIcon Icon="@selectedItem.Icon" /> @selectedItem.Text</strong>
    </div>
}
...
## See Also
  ...
  * [Live Demo: TreeView Selection](https://demos.sunfish.dev/blazor-ui/treeview/selection)
