...
tags: sunfish,blazor,promptbox,events,action,speech,files
published: true
position: 20
...
The event provides [`PromptBoxActionButtonEventArgs`](https://docs.sunfish.dev/blazor-ui/api/Sunfish.Blazor.Components.PromptBoxActionButtonEventArgs) containing the current text and action type.

>caption Handle action button interactions

````RAZOR
<SunfishPromptBox @bind-Value="@Prompt"
...
When speech-to-text functionality is enabled, the PromptBox provides events through the [`PromptBoxSpeechToTextButtonSettings`](https://docs.sunfish.dev/blazor-ui/api/Sunfish.Blazor.Components.PromptBoxSpeechToTextButtonSettings):
...
File selection events are handled through the [`PromptBoxFileSelectButtonSettings`](https://docs.sunfish.dev/blazor-ui/api/Sunfish.Blazor.Components.PromptBoxFileSelectButtonSettings).
