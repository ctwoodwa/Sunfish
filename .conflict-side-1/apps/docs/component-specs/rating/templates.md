...
tags: sunfish,blazor,rating,templates
published: True
position: 11
components: ["rating"]
---
    ...
    <ItemTemplate>
        @{
            if (context.Index + 1 > 3)
            {
                ...
                {
                    <SunfishSvgIcon Icon="@SvgIcon.Heart" Size="@ThemeConstants.SvgIcon.Size.ExtraLarge"></SunfishSvgIcon>
                }
                else
                {
                    <SunfishSvgIcon Icon="@SvgIcon.HeartOutline" Size="@ThemeConstants.SvgIcon.Size.ExtraLarge"></SunfishSvgIcon>
                }
            }
            else
            {
                if (context.Selected || context.Highlighted)
                {
                    <SunfishSvgIcon Icon="@SvgIcon.Star" Size="@ThemeConstants.SvgIcon.Size.ExtraLarge"></SunfishSvgIcon>
                }
                else
                {
                    <SunfishSvgIcon Icon="@SvgIcon.StarOutline" Size="@ThemeConstants.SvgIcon.Size.ExtraLarge"></SunfishSvgIcon>
                }
            }
        }
    </ItemTemplate>
...
* [Live Demo: Rating Templates](https://demos.sunfish.dev/blazor-ui/rating/templates)