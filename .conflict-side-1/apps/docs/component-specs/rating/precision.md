...
tags: sunfish,blazor,rating,precision
published: True
position: 5
components: ["rating"]
---
...
* [Live Demo: Rating Precision](https://demos.sunfish.dev/blazor-ui/rating/precision)
* [Live Demo: Rating Keyboard Navigation](https://demos.sunfish.dev/blazor-ui/rating/keyboard-navigation)