...
tags: sunfish,blazor,loader,container,loadercontainer,overview
published: True
position: 0
...
The <a href = "https://sunfish.dev/blazor-ui/loader-container" target="_blank">Blazor LoaderContainer</a> provides an animated indicator, a panel, and an overlay that can be used when the application is performing a time-consuming background operation, for example loading data.
...
1. Use the `<SunfishLoaderContainer>` tag.
...
<SunfishLoaderContainer Visible="@( Data == null )" Text="Please wait..." />
...
The following table lists the LoaderContainer parameters. Also check the [LoaderContainer API Reference](slug:Sunfish.Blazor.Components.SunfishLoaderContainer).
...
| `Size` | `string`<br />(`"md"`) | Sets the [size of the animated graphic](slug:loadercontainer-appearance#size). For convenience, use the members of the static class [`ThemeConstants.Loader.Size`](slug:Sunfish.Blazor.ThemeConstants.Loader.Size). |
...
| `ThemeColor` | `string`<br />(`"primary"`) | Sets the [color of the animated graphic and text](slug:loadercontainer-appearance#themecolor). For convenience, use the members of the static class [`ThemeConstants.Loader.ThemeColor`](slug:Sunfish.Blazor.ThemeConstants.Loader.ThemeColor). |
...
>
> You can find one example in the following **sample project**: <a href="https://github.com/ctwoodwa/sunfish-archive/blazor-ui/tree/master/loader/block-all-content" target="_blank">Disable All Content with Sunfish Loader</a>
...
<SunfishLoaderContainer Class="no-panel"
...
* [Live Demo: LoaderContainer](https://demos.sunfish.dev/blazor-ui/loadercontainer/overview)
* [LoaderContainer API Reference](slug:Sunfish.Blazor.Components.SunfishLoaderContainer)
