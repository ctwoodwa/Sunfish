---
component: SunfishAutocomplete, SunfishCheckbox, SunfishColorPicker, SunfishComboBox, SunfishDatePicker, SunfishDateRangePicker, SunfishDateTimePicker, SunfishDropDownList, SunfishFileUpload, SunfishMaskedInput, SunfishMultiSelect, SunfishNumericInput, SunfishRadio, SunfishRangeSlider, SunfishRating, SunfishSearchBox, SunfishSelect, SunfishSlider, SunfishSwitch, SunfishTextArea, SunfishTextField, SunfishTimePicker, SunfishUpload
phase: 3
status: not-started
complexity: mixed
priority: high
...
depends-on: [SunfishThemeProvider, SunfishForm, SunfishValidation, SunfishField]
external-resources:
  - name: ""
    url: ""
    license: ""
