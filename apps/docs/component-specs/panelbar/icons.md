...
slug: panelbar-icons
tags: sunfish,blazor,panelbar,icon,iconclass,image
published: True
position: 15
components: ["panelbar"]
---
...
You can add [Sunfish Font or SVG icons](slug:common-features-icons) to the PanelBar items. The component also supports custom icons.
...
>caption How to use icons in the Sunfish PanelBar

````RAZOR
<SunfishPanelBar Data="@PanelBarData">
    <PanelBarBindings>
...
* [Live Demos: PanelBar](https://demos.sunfish.dev/blazor-ui/panelbar/overview)
