...
tags: sunfish,blazor,panelbar,events
published: True
position: 25
components: ["panelbar"]
---
...
<div style="width: 30%;">
    <SunfishPanelBar Data="@Items" OnItemClick="@OnItemClickHandler">
    </SunfishPanelBar>
</div>
...
<div style="width: 30%;">
    <SunfishPanelBar Data="@Items" ExpandedItems="@ExpandedItems" ExpandedItemsChanged="@ExpandedItemsChanged">
    </SunfishPanelBar>
</div>
...
<div style="width: 30%;">
    <SunfishPanelBar Data="@Items" OnItemRender="@OnItemRenderHandler">
    </SunfishPanelBar>
</div>
...
````RAZOR
<SunfishPanelBar Data="@PanelBarItems"
