...
tags: sunfish,blazor,inlineaiprompt,overview
published: True
position: 0
...
The Sunfish InlineAIPrompt for Blazor is a popup-based component that lets you interact with AI language models right inside your content.
...
1. Add the `<SunfishInlineAIPrompt>` tag.
...
>caption Sunfish Blazor InlineAIPrompt

````Razor
<div class="products-container">
    @foreach (var product in Products)
    {
        <SunfishButton Class="product-card"
...
Get familiar with all InlineAIPrompt parameters, methods, events, and nested tags in the [InlineAIPrompt API Reference](slug:Sunfish.Blazor.Components.SunfishInlineAIPrompt).
...
<div class="destinations-container">
    ...
    {
        <SunfishButton Class="destination-card"
...
* [Live Demo: InlineAIPrompt](https://demos.sunfish.dev/blazor-ui/inlineaiprompt/overview)