...
description: Learn how to configure message actions, styling, and behavior in the Sunfish UI for Blazor Chat component.
slug: chat-messages
tags: sunfish,blazor,chat,messages,actions,styling
published: True
position: 5
components: ["chat"]
---
...
The Sunfish UI for Blazor Chat component provides comprehensive control over message display, interactions, and styling to create rich conversational experiences.
...
````RAZOR
<SunfishButton OnClick="@AddTypingMessage">Show Typing Indicator</SunfishButton>
...
````RAZOR
<SunfishChat Data="@ChatConversation"
             @ref="@Chat1"
             Width="600px"
             Height="700px"
             TextField="Content"
...
@code {
    ...
    private SunfishChat<ChatMessage>? Chat1;
