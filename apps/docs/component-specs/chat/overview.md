...
description: Discover the Sunfish UI for Blazor Chat component. Learn how to add the component to your app and explore its features like messaging, AI integration, customization, and accessibility.
slug: chat-overview
tags: sunfish,blazor,chat,messaging,ai,accessibility
published: True
position: 0
components: ["chat"]
---
...
>caption Basic configuration of the Sunfish Chat

````razor
<SunfishChat Data="@ChatData"
...
<SunfishButton OnClick="@OnRefreshChatClick">Refresh Chat</SunfishButton>

@code {
    private SunfishChat<ChatMessage>? ChatRef { get; set; }
...
* [Live Demo: Chat Overview](https://demos.sunfish.dev/blazor-ui/chat/overview)
* [Live Demo: AI Integration](https://demos.sunfish.dev/blazor-ui/chat/ai-integration)
