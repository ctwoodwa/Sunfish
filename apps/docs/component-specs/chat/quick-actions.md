...
description: Learn how to configure and use quick actions and message suggestions in the Sunfish UI for Blazor Chat component.
slug: chat-quick-actions
tags: sunfish,blazor,chat,quick-actions,suggestions
published: True
position: 3
components: ["chat"]
---
...
The Sunfish UI for Blazor Chat component supports quick message actions to enhance the user experience and provide convenient interaction options:
...
````RAZOR
<label class="k-checkbox-label"><SunfishCheckBox @bind-Value="@EnabledSuggestionsHiding" Id="suggestionsHidingCheckBox" /> Hide Suggestions on Click</label>
...
@code {
    ...
    private List<Message> ChatData = new()
    {
       new Message()
       {
           ...
           Text = "Welcome to Sunfish Store! I'm here to help you today.",
           Status = "Seen",
