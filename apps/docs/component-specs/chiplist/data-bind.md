...
slug: chiplist-bound
tags: sunfish,blazor,chiplist,data,bind,binding,databind
published: True
position: 5
components: ["chiplist"]
---
...
````RAZOR
<SunfishChipList Data="@ChipListData" />
...
* [Live Demo: ChipList](https://demos.sunfish.dev/blazor-ui/chiplist/overview)
