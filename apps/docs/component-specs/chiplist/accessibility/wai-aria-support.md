...
page_title: Sunfish UI for Blazor ChipList Documentation | ChipList Accessibility
description: "Get started with the Sunfish UI for Blazor ChipList and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Sunfish UI for Blazor ChipList provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the ChipList keyboard navigation works, refer to the [Blazor ChipList Accessibility and Keyboard Navigation Demo](https://demos.sunfish.dev/blazor-ui/chiplist/keyboard-navigation).
