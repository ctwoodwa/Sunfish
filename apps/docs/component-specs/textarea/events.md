...
tags: sunfish,blazor,textarea,events
published: true
position: 10
components: ["textarea"]
---
...
The events exposed for the Sunfish TextArea for Blazor let you react to user actions and input. This article explains the events available in the Sunfish TextArea.
...
@TextAreaValue
<br />
<SunfishTextArea Value="@TextAreaValue"
...
<SunfishTextArea @bind-Value="@TheValue"
