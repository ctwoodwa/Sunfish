...
tags: sunfish,blazor,stacklayout,layout
published: True
position: 5
...
<SunfishDropDownList @bind-Value="@orientation" 
                     Data="@stackLayoutOrientationOptions">
</SunfishDropDownList>

<SunfishStackLayout Orientation="@orientation" Width="30%">
    <div class="red">
        Box 1
    </div>
    <div class="green">
...
The `Spacing` parameter controls the spacing of the elements nested inside the `SunfishStackLayout`. That parameter is mapped to the <a href="https://css-tricks.com/almanac/properties/g/gap/">gap</a> CSS rule and accepts each value you can pass to the `gap` CSS rule.
...
<SunfishNumericTextBox @bind-Value="@SpacingValue"></SunfishNumericTextBox>

<SunfishStackLayout Spacing="@($"{SpacingValue}px")" Width="30%">
    <div class="red">
        Box 1
    </div>
    <div class="green">
...
The `HorizontalAlign` parameter controls the alignment of the items in the `SunfishStackLayout` based on the X axis. Takes a member of the `StackLayoutHorizontalAlign` enum:
...
<SunfishDropDownList @bind-Value="@align"
                     Data="@stackLayoutOrientationOptions">
</SunfishDropDownList>

<SunfishStackLayout HorizontalAlign="@align" Width="30%">
    <div class="red">
        Box 1
    </div>
    <div class="green">
...
The `VerticalAlign` parameter controls the alignment of the items in the `SunfishStackLayout` based on the Y axis. Takes a member of the `StackLayoutVerticalAlign` enum:
...
<SunfishStackLayout VerticalAlign="@align"
