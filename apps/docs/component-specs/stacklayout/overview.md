...
tags: sunfish,blazor,stacklayout,overview
published: True
position: 0
...
The <a href="https://sunfish.dev/blazor-ui/stacklayout" target="_blank">StackLayout for Blazor</a> is a component that easily aligns multiple elements in a vertical or horizontal order.

## Creating Blazor StackLayout

1. Use the `<SunfishStackLayout>` tag to add the component to your razor page.

2. Inside the `<SunfishStackLayout>` tag, add the desired HTML containers (e.g. `<div>`) or components. Each immediate child element will represent one stack layout item.
...
<div class="parent-container">
    <SunfishStackLayout Orientation="@StackLayoutOrientation.Horizontal" 
                        Width="100%" 
                        Height="100%">
...
Sometimes you may need to create a more complex layout that includes both horizontal and vertical items. To do that, nest `SunfishStackLayout` components inside one another.

>caption Use nested StackLayout to create a page layout.

````RAZOR
<SunfishStackLayout Orientation="StackLayoutOrientation.Vertical" Height="100%">
    <div class="red">
        Header
    </div>
    <SunfishStackLayout Orientation="StackLayoutOrientation.Horizontal">
...
## See Also
  ...
  * [Live StackLayout Demos](https://demos.sunfish.dev/blazor-ui/stacklayout/overview)
  * [StackLayout API Reference](slug:Sunfish.Blazor.Components.SunfishStackLayout)