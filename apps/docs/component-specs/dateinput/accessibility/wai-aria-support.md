...
page_title: Sunfish UI for Blazor DateInput Documentation | DateInput Accessibility
description: "Get started with the Sunfish UI for Blazor DateInput and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Sunfish UI for Blazor DateInput provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the DateInput keyboard navigation works, refer to the [Blazor DateInput Accessibility and Keyboard Navigation Demo](https://demos.sunfish.dev/blazor-ui/dateinput/keyboard-navigation).
