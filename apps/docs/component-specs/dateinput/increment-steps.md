...
tags: sunfish,blazor,DateInput,step
published: true
position: 15
...
<SunfishDateInput Format="yyyy MMM dd, HH:mm:ss tt" @bind-Value="@selectedDateTime" Width="250px">
...
* [Live Demo: Date Input Incremental Steps](https://demos.sunfish.dev/blazor-ui/dateinput/incremental-steps)
