...
tags: sunfish,blazor,DateInput,efficient,keyboard,input
published: true
...
````RAZOR.skip-repl
<SunfishDateInput AutoSwitchKeys="@( new List<object>() { "/", "tab" } )" />
````
...
````RAZOR
<ul>
    <li><label> <SunfishCheckBox @bind-Value="@AllowCaretMode" /> AllowCaretMode </label></li>
    <li><label> <SunfishCheckBox @bind-Value="@AutoCorrectParts" /> AutoCorrectParts </label></li>
    <li><label> <SunfishCheckBox @bind-Value="@AutoSwitchParts" /> AutoSwitchParts </label></li>

    <li>
        <label>
            <SunfishNumericTextBox @bind-Value="@TwoDigitYearMax" Min="0" Max="100" Width="80px" />
