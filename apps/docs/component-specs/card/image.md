...
slug: card-image
tags: sunfish,blazor,card,image
published: True
position: 7
components: ["card"]
---
...
<SunfishCard Width="200px">
    ...
    <CardImage Src="https://demos.sunfish.dev/blazor-ui/images/cards/bg/rila_lakes.jpg"></CardImage>
    ...
    <CardActions Layout="CardActionsLayout.Stretch">
        ...
        <SunfishButton Class="k-flat" Icon="@SvgIcon.Share" Title="Share"></SunfishButton>
    </CardActions>
</SunfishCard>
````
...
## See Also
  ...
  * [Live Demo: Card Building Blocks](https://demos.sunfish.dev/blazor-ui/card/building-blocks)
