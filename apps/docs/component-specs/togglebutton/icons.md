...
tags: sunfish,blazor,Toggle,button,icon,sprite,image
published: True
position: 2
...
|---|---|---|
| `Icon`| `object` | Use it to display a [Sunfish Font and SVG Icons](slug:common-features-icons). |
...
>caption How to use icons in the Sunfish Toggle Button

````RAZOR
@* This sample shows how you can use conditional logic to show different icons in the different states.*@

<SunfishToggleButton Icon="@( SvgSelected ? SvgIcon.VolumeUp : SvgIcon.VolumeDown )"
                     @bind-Selected="@SvgSelected">Svg Icon</SunfishToggleButton>

<SunfishToggleButton Icon="@( FontSelected ? FontIcon.VolumeUp : FontIcon.VolumeDown )"
                     @bind-Selected="@FontSelected">Font Icon</SunfishToggleButton>
...
* Add your own HTML inside the button, something like:
    `<SunfishButton><img style="width: 400px; height: 400px;" src="my-icon.svg" />some text</SunfishButton>`
