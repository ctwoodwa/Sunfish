...
tags: sunfish,blazor,Toggle,button,events
published: True
position: 20
...
This article describes the events of the Sunfish ToggleButton for Blazor:
...
````RAZOR
<SunfishToggleButton Selected="@IsSelected"
