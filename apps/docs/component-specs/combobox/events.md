...
tags: sunfish,blazor,combobox,combo,events
published: true
position: 40
components: ["combobox"]
---
...
This article explains the events available in the Sunfish ComboBox for Blazor:
...
<SunfishComboBox Data="@ComboData"
                 Value="@ComboValue"
...
@selectedValue
<br /><br />
<SunfishComboBox Data="@myComboData" TextField="MyTextField" ValueField="MyValueField"
...
<SunfishComboBox TItem="@String" TValue="@String"
                     OnRead="@ReadItems"
...
<SunfishComboBox @bind-Value="@TheValue" Data="@Suggestions"
