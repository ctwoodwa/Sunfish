...
tags: sunfish,blazor,combobox,combo,overview
published: True
position: 0
components: ["combobox"]
---
...
<SunfishComboBox Data="@myComboData" TextField="MyTextField" ValueField="MyValueField" @bind-Value="selectedValue"
...
>tip To learn more about the appearance, anatomy, and accessibility of the ComboBox, visit the [Progress Design System Kit documentation](https://sunfish.dev/design-system/docs/components/combobox/)—an information portal offering rich component usage guidelines, descriptions of the available style variables, and globalization support details.
...
````RAZOR
<SunfishComboBox Data="@ComboBoxData"
...
Add a reference to the component instance to use the [ComboBox's methods](slug:Sunfish.Blazor.Components.SunfishComboBox-2). Note that the [ComboBox is a generic component](slug:common-features-data-binding-overview#component-type).


@[template](/_contentTemplates/dropdowns/methods.md#methods-list)

````RAZOR
<SunfishComboBox @ref="@ComboBoxRef"
                     Data="@Suggestions"
...
@code {
    private SunfishComboBox<string, string> ComboBoxRef { get; set; }
...
* [Live Demo: ComboBox](https://demos.sunfish.dev/blazor-ui/combobox/overview)
* [Live Demo: ComboBox Validation](https://demos.sunfish.dev/blazor-ui/combobox/validation)
* [ComboBox API Reference](slug:Sunfish.Blazor.Components.SunfishComboBox-2)
