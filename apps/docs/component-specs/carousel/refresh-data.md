...
tags: sunfish,blazor,carousel,observable,data,new,collection
published: True
position: 15
components: ["carousel"]
---
...
@code {
    private SunfishCarousel<CarouselModel> CarouselRef;
...
<SunfishButton OnClick="@LoadNew">Load New Items</SunfishButton>
