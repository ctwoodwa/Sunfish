...
tags: sunfish,blazor,popover,popover,align,position,collision
published: True
position: 10
components: ["popover"]
---
...
<div>
    <label>
        Popover Position
        <SunfishDropDownList @bind-Value="@PopoverPositionType" Data="@PopoverPositions" Width="200px" />
    </label>
</div>
<div>
    <label>
        Offset
        <SunfishNumericTextBox @bind-Value="@PopoverOffset" Width="200px" />
    </label>
</div>
<div>
    <label>
        Popover Collision Type
        <SunfishDropDownList @bind-Value="@PopoverCollisionType" Data="@PopoverCollisionTypes" Width="200px" />
    </label>
</div>
...
<SunfishPopover @ref="@PopoverRef"
    ...
    <PopoverContent>
        I am a Sunfish Popover
    </PopoverContent>
    <PopoverActions>
        <SunfishButton OnClick="@(() => PopoverRef?.Hide())" Icon="@SvgIcon.X">Close</SunfishButton>
    </PopoverActions>
</SunfishPopover>
