...
tags: sunfish,blazor,dropdown,DropDownList,virtualization
published: True
position: 20
...
<br />
<SunfishDropDownList TItem="@Person" TValue="@int"
                     ScrollMode="@DropDownScrollMode.Virtual"
...
* [Live Demo: DropDownList Virtualization](https://demos.sunfish.dev/blazor-ui/dropdownlist/virtualization)
