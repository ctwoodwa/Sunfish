...
tags: sunfish,blazor,dropdownlist,dropdown,list,templates
published: True
position: 25
...
<SunfishDropDownList Data="@DropDownData" @bind-Value="@Role">
    <ValueTemplate>
...
* [Live Demo: DropDownList Templates](https://demos.sunfish.dev/blazor-ui/dropdownlist/templates)
