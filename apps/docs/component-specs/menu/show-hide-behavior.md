...
tags: sunfish,blazor,menu,show,hide,events,hover,click,mouseleave,mouseenter
published: true
position: 3
components: ["menu"]
---
...
* The `ShowOn` parameter accepts a value from the `Sunfish.Blazor.MenuShowEvent` enum:
...
* The `HideOn` parameter accepts a value from the `Sunfish.Blazor.MenuHideEvent` enum:
