...
tags: sunfish,blazor,menu,events
published: true
position: 20
components: ["menu"]
---
...
This article describes the events available in the Sunfish Menu for Blazor:
...
<SunfishMenu Data="@MenuItems" OnClick="@((MenuItem item) => OnClickHandler(item))">
</SunfishMenu>
