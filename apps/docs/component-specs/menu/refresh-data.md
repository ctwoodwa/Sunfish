...
tags: sunfish,blazor,menu,observable,data,new,collection
published: True
position: 17
components: ["menu"]
---
...
<SunfishButton OnClick="@AddItem">Add menu item</SunfishButton>

<SunfishButton OnClick="@RemoveItem">Remove menu item</SunfishButton>

<SunfishButton OnClick="@LoadData">Load new menu data</SunfishButton>
