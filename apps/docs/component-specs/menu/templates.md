...
tags: sunfish,blazor,menu,templates
published: True
position: 10
components: ["menu"]
---
...
<SunfishMenu Data="@MenuItems" OnClick="@((MenuItem item) => OnClick(item))">
    <ItemTemplate Context="item">
        @{
            @*
        ...
        MenuItems = new List<MenuItem>()
        {
            ...
            new MenuItem()
            {
                ...
                Items = new List<MenuItem>()
                {
                    ...
                    {
                        Text = "Documentation",
                        Href = "https://docs.sunfish.dev/blazor-ui/introduction",
                        Icon = SvgIcon.Star
                    },
                    new MenuItem()
                    {
                        Text = "Demos",
                        Href = "https://demos.sunfish.dev/blazor-ui",
                        Icon = SvgIcon.Star
                    }
                }
            }
...
* [Live Demo: Menu Template](https://demos.sunfish.dev/blazor-ui/menu/template)
