...
tags: sunfish,blazor,listview,observable,data,new,collection
published: True
position: 53
components: ["listview"]
---
...
To refresh the `ListView` data when using [`OnRead`](slug:listview-manual-operations), call the `Rebind` method of the `SunfishListView` reference. This will fire the `OnRead` event and execute the business logic in the handler.
...
<div class="example-box">
    ...
    <SunfishButton OnClick="@RebindListView">Rebind</SunfishButton>
    <SunfishListView @ref="@ListViewRef"
                     TItem="SampleData"
                     OnRead="@ReadItems"
                     Width="700px"
                     Pageable="true">
...
@code {
    ...
    private SunfishListView<SampleData> ListViewRef { get; set; }
...
<SunfishButton OnClick="@RemoveEmployee">Remove employee</SunfishButton>
...
<SunfishButton OnClick="@ChangeData">Change employee data</SunfishButton>
