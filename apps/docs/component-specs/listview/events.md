...
tags: sunfish,blazor,listview,events
published: true
position: 20
components: ["listview"]
---
...
This article explains the events available in the Sunfish ListView for Blazor:
...
<SunfishListView Data="@ListViewData" 
                 Pageable="true"
...
<SunfishListView Data="@ListViewData" Pageable="true" PageChanged="@PageChangedHandler">
    <Template>
        <h6>@context.Name</h6>
    </Template>
</SunfishListView>
