...
The table below lists the PDF Viewer parameters. Also check the [PDF Viewer API Reference](slug:Sunfish.Blazor.Components.SunfishPdfViewer) for all parameters, methods and events.
...
````RAZOR
<SunfishPdfViewer @ref="@PdfViewerRef"
                  Data="@PdfSource">
    <PdfViewerToolBar>
        <PdfViewerToolBarCustomTool>
            <SunfishButton OnClick="@OnButtonClick" Icon="@SvgIcon.ArrowRotateCw">Rebind PDF Viewer</SunfishButton>
        </PdfViewerToolBarCustomTool>
    </PdfViewerToolBar>
</SunfishPdfViewer>

@code {
    private SunfishPdfViewer PdfViewerRef { get; set; }
