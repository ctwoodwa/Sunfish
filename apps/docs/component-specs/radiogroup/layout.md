...
tags: sunfish,blazor,radiobuttongroup,radio,list,layout
published: True
position: 10
...
By default, the list is vertical, and you can change that through the `Layout` parameter that takes a member of the `Sunfish.Blazor.RadioGroupLayout` enum.

>caption Horizontal and Vertical layouts in the Sunfish Blazor Button Group Component
...
<br />
<SunfishRadioGroup Data="@Data" @bind-Value="@SelectedValue" Layout="@theLayout"></SunfishRadioGroup>
@code{
...
<div style="width: 500px; border: 1px solid red;">
    <SunfishRadioGroup Data="@RadioButtonsList"
