...
tags: sunfish,blazor,arcgauge,arc,gauge,overview
published: True
position: 0
components: ["arcgauge"]
---
...
The <a href = "https://sunfish.dev/blazor-ui/arc-gauge" target="_blank">Sunfish Arc Gauge for Blazor</a> represents [numerical values](slug:arc-gauge-pointers) on an arc [scale](slug:arc-gauge-scale).

## Creating Blazor Arc Gauge

1. Add the `<SunfishArcGauge>` tag.
...
<SunfishButton OnClick="@ChangeTheHeight">Change the Width of the component</SunfishButton>

<SunfishArcGauge @ref="@ArcGaugeRef" Width="@Width">
    <ArcGaugePointers>
...
@code {
    Sunfish.Blazor.Components.SunfishArcGauge ArcGaugeRef { get; set; }
