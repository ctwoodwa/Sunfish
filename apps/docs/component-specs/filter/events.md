...
slug: filter-events
tags: sunfish,blazor,filter,events,event
published: true
position: 11
components: ["filter"]
---
...
This article explains the available events for the Sunfish Filter for Blazor:
...
<SunfishFilter Value="@Value" OnUpdate="@OnFilterUpdate">
    <FilterFields>
