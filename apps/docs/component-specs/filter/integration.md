...
tags: sunfish,blazor,filter,integration
published: True
position: 3
components: ["filter"]
---
...
To integrate the Filter with the Sunfish Chart:
...
<SunfishFilter Value="@FilterValue" OnUpdate="@OnUpdate">
    <FilterFields>
...
To integrate the Filter with the Sunfish Grid:
...
<SunfishFilter Value="FilterValue" OnUpdate="@OnFilterUpdate">
    <FilterFields>
...
<p>
    <SunfishButton ThemeColor="@ThemeConstants.Button.ThemeColor.Primary"
                   OnClick="@ApplyFilters">Apply Filters</SunfishButton>
</p>
...
To integrate the Filter with the Sunfish ListView:
...
To integrate the Filter with the Sunfish TreeList:
...
To integrate the Filter with the Sunfish TreeView:
...
<SunfishTreeView Data="@FlatData" @bind-ExpandedItems="@ExpandedItems">
    <TreeViewBindings>
...
* [Online Demo: Filter](https://demos.sunfish.dev/blazor-ui/filter/overview)
