...
tags: sunfish,blazor,filter,filterfields,templates
published: True
position: 10
components: ["filter"]
---
...
The `context` of the`ValueTemplate` is of type [`FilterFieldValueTemplateContext`](slug:sunfish.blazor.components.filterfieldvaluetemplatecontext). You can get and set its `FilterDescriptor` property, which is of type [`FilterDescriptor`](slug:sunfish.datasource.filterdescriptor).
...
<SunfishFilter Value="@FilterValue" OnUpdate="@OnUpdate">
    <FilterFields>
        ...
        <FilterField Name="@(nameof(Food.Price))" Type="@(typeof(decimal))" Label="Price">
            <ValueTemplate>
                <SunfishNumericTextBox Value="@((decimal?)context.FilterDescriptor.Value)"
                                       Format="C"
                                       Step="0.01m"
...
## See Also
  ...
  * [Live Demo: Filter](https://demos.sunfish.dev/blazor-ui/filter/templates)
