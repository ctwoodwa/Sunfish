...
tags: sunfish,blazor,filter,overview
published: True
position: 0
components: ["filter"]
---
...
The <a href="https://sunfish.dev/blazor-ui/filter" target="_blank">Blazor Filter component</a> serves as a complementary addition to data-bound components that do not have built-in filtering.
...
1. Use the `SunfishFilter` tag to add the component to your razor page.
...
>caption A basic configuration of the Sunfish Filter.
...
<SunfishFilter @ref="FilterRef" Value="@FilterValue" OnUpdate="@OnUpdate">
    <FilterFields>
...
@code {
    private SunfishFilter? FilterRef { get; set; }
...
* [Live Demo: Filter](https://demos.sunfish.dev/blazor-ui/filter/overview)
