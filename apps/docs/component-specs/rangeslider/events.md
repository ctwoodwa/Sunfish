...
tags: sunfish,blazor,range,slider,events
published: true
position: 20
...
This article showcases the available events in the Sunfish RangeSlider component:
...
<SunfishRangeSlider StartValue="@StartValue" StartValueChanged="@( async (decimal v) => await StartValueChangedHandler(v) )"
...
<SunfishRangeSlider StartValue="@StartValue"
                    EndValue="@EndValue"
