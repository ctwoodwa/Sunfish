...
tags: sunfish,blazor,grid,filtering,filter,row
published: True
position: 5
components: ["grid"]
---
...
Set the `FilterMode` parameter of the Sunfish Grid to `GridFilterMode.FilterRow`.
...
>caption Filter Row in Sunfish Grid

````RAZOR
@* Filter row mode *@

<SunfishDataGrid Data=@GridData FilterMode="@GridFilterMode.FilterRow" Pageable="true" Height="400px">
...
## See Also
  ...
  * [Live Demo: Grid Filter Row](https://demos.sunfish.dev/blazor-ui/grid/filter-row)
