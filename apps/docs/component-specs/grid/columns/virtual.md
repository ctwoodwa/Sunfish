...
tags: sunfish,blazor,grid,column,virtual,scrolling
published: true
position: 45
components: ["grid"]
---
...
The Sunfish Blazor Grid provides Virtual Scrolling for its Columns. This means that columns and the corresponding data will be rendered only for the currently visible viewport. When changing the [Page](slug:components/grid/features/paging) or [Sorting](slug:components/grid/features/sorting) the Grid, fewer elements are rendered which improves the responsiveness and the overall user experience.
...
<SunfishDataGrid Data="@MyData"
        ...
        <SunfishGridColumn Field="@(nameof(User.Id))" Width="100px" />
        <SunfishGridColumn Field="@(nameof(User.FirstName))" Title="First Name" Width="200px" />
        <SunfishGridColumn Field="@(nameof(User.LastName))" Title="Last Name" Width="200px" />
        <SunfishGridColumn Field="@(nameof(User.FullName))" Title="Full Name" Width="200px" />
        <SunfishGridColumn Field="@(nameof(User.DateOfBirth))" Title="Date of Birth" Width="200px" />
        <SunfishGridColumn Field="@(nameof(User.Age))" Title="Age" Width="100px" />
        <SunfishGridColumn Field="@(nameof(User.EmailAddress))" Title="Email Address" Width="200px" />
        <SunfishGridColumn Field="@(nameof(User.RegistrationDate))" Title="Registration Date" Width="200px" />
        <SunfishGridColumn Field="@(nameof(User.LocalTime))" Title="Local Time" Width="200px" />
        <SunfishGridColumn Field="@(nameof(User.UserNumber))" Title="User Number" Width="300px" />
        <SunfishGridColumn Field="@(nameof(User.Gender))" Title="Gender" Width="200px" />
        <SunfishGridCommandColumn Width="250px" Title="Command Column">
...
## See also
 * [Live demo: Virtual Columns](https://demos.sunfish.dev/blazor-ui/grid/column-virtualization)
