...
tags: sunfish,blazor,grid,column,columns,menu
published: True
position: 55
components: ["grid"]
---
...
To enable the Column Menu, set the `ShowColumnMenu` parameter of the `<SunfishDataGrid>` tag to `true`. This will enable the menu for each column of the Grid.
...
<SunfishDataGrid Data="@GridData"
             ...
             Sortable="true"
             ShowColumnMenu="true">
        <SunfishGridColumn Field="@(nameof(SampleData.Id))" Width="80px" />
...
<SunfishDataGrid Data="@GridData"
    ...
    <GridSettings>
        ...
        <SunfishGridColumn Field="@(nameof(SampleData.Id))" Width="80px" ShowColumnMenu="false" />
        <SunfishGridColumn Field="@(nameof(SampleData.FirstName))" Title="First Name" Id="firstname-column-id" />
        <SunfishGridColumn Field="@(nameof(SampleData.LastName))" Title="Last Name" Id="lastname-column-id" />
        <SunfishGridColumn Field="@(nameof(SampleData.CompanyName))" Title="Company" Id="companyname-column-id" />
        <SunfishGridColumn Field="@(nameof(SampleData.Team))" Title="Team" Id="team-column-id" />
        <SunfishGridColumn Field="@(nameof(SampleData.HireDate))" Title="Hire Date" VisibleInColumnChooser="false" />
</SunfishDataGrid>
...
<SunfishDataGrid Data="@MyData"
    ...
    <GridSettings>
        ...
        <SunfishGridColumn Field="@(nameof(SampleData.Id))" Width="80px" />
        <SunfishGridColumn Field="@(nameof(SampleData.Name))" Title="Employee Name" ShowColumnMenu="false" />
        <SunfishGridColumn Field="@(nameof(SampleData.Team))" Title="Team" VisibleInColumnChooser="false" />
        <SunfishGridColumn Field="@(nameof(SampleData.HireDate))" Title="Hire Date" />
</SunfishDataGrid>
...
## See Also
  * [Live Demo: Grid Column Menu](https://demos.sunfish.dev/blazor-ui/grid/column-menu)
  * [Live Demo: Grid Custom Column Menu](https://demos.sunfish.dev/blazor-ui/grid/custom-column-menu)
