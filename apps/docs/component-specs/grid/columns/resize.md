...
tags: sunfish,blazor,grid,column,resize,drag
published: True
position: 20
components: ["grid"]
---
...
>caption How Column Resizing Works in the Sunfish Grid
...
<SunfishButton OnClick="@AutoFitSingleColumn">AutoFit ID Column</SunfishButton>
<SunfishButton OnClick="@AutoFitMultipleColumns">AutoFit String Columns</SunfishButton>
<SunfishButton OnClick="@AutoFitAllColumns">AutoFit All Columns</SunfishButton>
...
<SunfishDataGrid @ref="@GridRef"
             ...
             Sortable="true"
             Height="300px">
        <SunfishGridColumn Field=@nameof(SampleData.Id) Title="ID" Id="@IdColumnId" />
        <SunfishGridColumn Field=@nameof(SampleData.FirstName) Title="First Name" Id="@FirstNameColumnId" />
        <SunfishGridColumn Field=@nameof(SampleData.LastName) Title="Last Name" Id="@LastNameColumnId" />
        <SunfishGridCommandColumn Width="100px" Resizable="false">
...
@code {
    public SunfishDataGrid<SampleData>? GridRef { get; set; }
...
## See Also
  ...
  * [Live Demo: Column Resizing](https://demos.sunfish.dev/blazor-ui/grid/column-resizing)
