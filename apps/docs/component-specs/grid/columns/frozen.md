...
tags: sunfish,blazor,grid,column,freeze,frozen
published: true
position: 40
components: ["grid"]
---
...
<SunfishDataGrid Data="@GridData"
             Width="850px"
             Height="400px">
        <SunfishGridColumn Field=@nameof(Product.ProductName) Title="Product Name" Width="150px" Locked="true" />
        <SunfishGridColumn Field=@nameof(Product.UnitPrice) Title="Unit Price" Width="150px" />
        <SunfishGridColumn Field=@nameof(Product.UnitsInStock) Title="Units in stock" Width="150px" />
        <SunfishGridColumn Field=@nameof(Product.CreatedAt) Title="Date created" Width="250px" />
        <SunfishGridColumn Field=@nameof(Product.Discontinued) Title="Discontinued" Width="150px" />
        <SunfishGridCommandColumn Width="250px" Locked="true">
...
<SunfishDataGrid Data="@GridData"
             Width="550px"
             Height="400px">
        <SunfishGridColumn Field=@nameof(Product.ProductName) Title="Product Name" Width="200px" Locked="true" />
        <SunfishGridColumn Field=@nameof(Product.UnitPrice) Title="Unit Price" Width="200px" />
        <SunfishGridColumn Field=@nameof(Product.SupplierId) Title="Supplier Id" Width="150px" Locked="true" />
        <SunfishGridColumn Field="@nameof(Product.UnitsInStock)" Title="Units In Stock" Width="200px" />
</SunfishDataGrid>
...
## See also
 * [Live demo: Frozen Columns](https://demos.sunfish.dev/blazor-ui/grid/frozen-columns)
