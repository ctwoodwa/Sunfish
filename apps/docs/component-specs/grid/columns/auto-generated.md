...
tags: sunfish,blazor,grid,column,automatic,automatically,generated,columns
published: true
position: 35
components: ["grid"]
---
...
If you don't need explicitly declared columns (such as a command column or frozen columns) no column declarations are required.
...
<SunfishDataGrid Data="@GridData" AutoGenerateColumns="true"
...
To set explicit position of the Automatically Generated Columns you can use the `GridAutoGeneratedColumns` tag inside `<SunfishDataGrid>` and place it in the order you want it to have in relation to the columns you declare.
...
>tip To use the attributes listed above the `System.ComponentModel.DataAnnotations` using statement has to be present in the file with your model. With [Popup editing](https://demos.sunfish.dev/blazor-ui/grid/editing-popup), you can use validation attributes in addition to the customization attributes.
...
<div style="max-width: 800px;">
    ...
    <SunfishDataGrid Data="@GridData"
        ...
        <GridToolBarTemplate>
            ...
            <SunfishGridColumn Field="@nameof(GridDataModel.RegistrationDate)" Title="Registration Date" Width="200px" />
            <SunfishGridCommandColumn Width="250px">
                <GridCommandButton Command="Edit" Icon="@SvgIcon.Pencil">Edit</GridCommandButton>
...
* [Live Demo: Auto Generated Columns](https://demos.sunfish.dev/blazor-ui/grid/column-auto-generation)
