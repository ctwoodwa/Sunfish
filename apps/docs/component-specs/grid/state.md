...
slug: grid-state
tags: sunfish,blazor,grid,state,save,load,layout,set,change,management
published: True
position: 50
components: ["grid"]
---
...
The Grid state is a generic [class `GridState<TItem>`](slug:Sunfish.Components.DataGrid.GridState-1). The type depends on the type of the Grid model. The `GridState<TItem>` object exposes the following properties:
...
<SunfishDataGrid Data="@GridData"
        ...
        <SunfishGridColumn Field="@nameof(Product.Category)" />
        <SunfishGridColumn Field="@nameof(Product.Stock)" />
...
<div id="demo-container">
    ...
    <div id="console">
        ...
        @OnStateChangedCount
        <SunfishButton OnClick="@( () => OnStateChangedCount = 0 )">Reset</SunfishButton>
        <br /><br />
...
* [Live Demo: Grid State](https://demos.sunfish.dev/blazor-ui/grid/persist-state)
* [GridState API reference](slug:Sunfish.Components.DataGrid.GridState-1)
