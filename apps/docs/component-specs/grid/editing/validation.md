...
tags: sunfish, blazor, grid, validation, editing
published: True
position: 40
components: ["grid"]
---
...
The Sunfish Grid for Blazor supports built-in validation that is enabled by default. This article describes how the Grid validation works and how to customize or disable it.
...
Third party validation tools are not part of Sunfish UI for Blazor. Reference the required NuGet packages explicitly.
...
>caption Use Sunfish Grid for Blazor with FluentValidation
...
<SunfishDataGrid Data="@GridData"
    ...
    <GridToolBarTemplate>
        ...
        <label class="k-checkbox-label">
            <SunfishCheckBox @bind-Value="@GridValidationEnabled" />
            Enable Validation
        </label>
    </GridToolBarTemplate>
...
* [Remote Validation](https://github.com/ctwoodwa/sunfish-archive/blazor-ui/tree/master/grid/remote-validation)
