...
tags: sunfish,blazor,grid,ai,smart,box,search,semantic
published: True
position: 15
components: ["grid"]
---
...
For detailed information on all available parameters, see the [GridToolBarSmartBoxTool API reference](slug:Sunfish.Components.DataGrid.GridToolBarSmartBoxTool).
