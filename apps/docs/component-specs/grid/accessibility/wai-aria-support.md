...
page_title: Sunfish UI for Blazor Grid Documentation | Grid Accessibility
...
Out of the box, the Sunfish UI for Blazor Grid provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
[Form accessibility specification](../../form/accessibility/wai-aria-support.md)
...
[Pager accessibility specification](../../pager/accessibility/wai-aria-support.md)
...
For details on how the Grid keyboard navigation works, refer to the [Blazor Grid Accessibility and Keyboard Navigation Demo](https://demos.sunfish.dev/blazor-ui/grid/keyboard-navigation).
