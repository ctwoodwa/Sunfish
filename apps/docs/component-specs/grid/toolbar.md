...
tags: sunfish,blazor,grid,toolbar
published: True
position: 45
components: ["grid"]
---
...
The [Blazor Grid](https://demos.sunfish.dev/blazor-ui/grid/overview) toolbar can render built-in and custom tools. This article describes the built-in tools and shows how to add [custom tools](#custom-tools) or create a [custom toolbar](#custom-toolbar-configuration).

## Built-In Tools

The [Blazor Grid](https://demos.sunfish.dev/blazor-ui/grid/overview) provides several built-in tools that can be added to the component toolbar. To include a specific tool in the [toolbar configuration](#toolbar-tools-configuration), use the respective tool tags below.
...
Add a `<GridToolBar>` tag inside `<SunfishDataGrid>` to configure a toolbar, for example:
...
<SunfishDataGrid Data=@GridData
    ...
    <GridToolBar>
        <GridToolBarCustomTool>
            <SunfishButton OnClick="@OnToolbarCustomClick">Custom Grid Tool</SunfishButton>
        </GridToolBarCustomTool>
        ...
        <SunfishGridColumn Field=@nameof(Person.EmployeeId) Editable="false" Visible="true" Width="200px" />
        <SunfishGridColumn Field=@nameof(Person.Name) Width="200px" />
        <SunfishGridColumn Field=@nameof(Person.AgeInYears) Title="Age" Visible="false" Width="240px" />
        <SunfishGridColumn Field=@nameof(Person.HireDate) Title="Hire Date" Width="230px" />
        <SunfishGridCommandColumn Width="200px">
...
<SunfishDataGrid Data=@MyData Pageable="true" PageSize="15" EditMode="@GridEditMode.Inline" Height="500px" OnCreate="@CreateHandler">
    ...
    <GridExport>
        ...
        <GridPdfExport FileName="sunfish-grid-export" AllPages="@ExportAllPages" />
    </GridExport>
...
* [Grid Live Demo](https://demos.sunfish.dev/blazor-ui/grid/overview)
