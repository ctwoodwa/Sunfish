...
tags: sunfish,blazor,grid,templates,command,column,header
published: True
position: 23
components: ["grid"]
---
...
<SunfishDataGrid Data="@GridData"
        ...
        <SunfishGridColumn Field="@nameof(Product.Price)" Title="Price" />
        <SunfishGridColumn Field="@nameof(Product.Quantity)" Title="Quantity" />
        <SunfishGridCommandColumn Width="280px">
            <HeaderTemplate>
