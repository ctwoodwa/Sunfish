...
tags: sunfish,blazor,grid,templates,column,menu
published: True
position: 40
components: ["grid"]
---
...
<SunfishDataGrid Data="@MyData"
    ...
    <GridSettings>
        ...
        <SunfishGridColumn Field="@(nameof(SampleData.Id))" Width="80px" Title="Id" Id="id-column-id" />
        ...
        <SunfishGridColumn Field="@(nameof(SampleData.HireDate))" Title="Hire Date" Id="hiredate-column-id" />
</SunfishDataGrid>
