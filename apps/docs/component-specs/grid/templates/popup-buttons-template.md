...
tags: sunfish,blazor,grid,templates,popup,buttons
published: True
position: 50
components: ["grid"]
---
...
<SunfishDataGrid Data=@MyData EditMode="@GridEditMode.Popup" Pageable="true" Height="500px"
    ...
    <GridSettings>
        ...
        <SunfishGridColumn Field=@nameof(SampleData.ID) Title="ID" Editable="false" />
