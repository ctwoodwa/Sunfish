...
tags: sunfish,blazor,promptbox,ai,communication,speech,files,input
published: True
position: 0
...
The <a href="https://sunfish.dev/blazor-ui/promptbox" target="_blank">Blazor PromptBox component</a> facilitates human-AI communication with a feature-rich input interface. It combines text input, speech-to-text functionality, file attachments, and intelligent layout adaptation to provide a comprehensive user experience for AI workflows.
...
1. Add the `<SunfishPromptBox>` tag to a Razor file.
...
To review all available parameters for the PromptBox component, see the [PromptBox API Reference](https://docs.sunfish.dev/blazor-ui/api/Sunfish.Blazor.Components.SunfishPromptBox#parameters).
