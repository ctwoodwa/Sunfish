...
tags: sunfish,blazor,promptbox,adornments,templates,prefixes,suffixes
published: True
position: 10
...
<SunfishPromptBox @bind-Value="@Prompt"
    ...
    <PromptBoxStartAffixTemplate>
        <SunfishButton Icon="SvgIcon.User" 
...
<SunfishPromptBox @bind-Value="@Prompt"
    ...
    <PromptBoxEndAffixTemplate>
        <div class="d-flex gap-1">
            <SunfishButton Icon="SvgIcon.Image" 
                           FillMode="@ThemeConstants.Button.FillMode.Clear"
                           Size="@ThemeConstants.Button.Size.Small"
                           OnClick="OnImageClick"
                           Title="Add Image" />
            <SunfishButton Icon="SvgIcon.Link" 
                           FillMode="@ThemeConstants.Button.FillMode.Clear"
                           Size="@ThemeConstants.Button.Size.Small"
                           OnClick="OnLinkClick"
                           Title="Add Link" />
            <SunfishButton Icon="SvgIcon.Gear" 
                           FillMode="@ThemeConstants.Button.FillMode.Clear"
                           Size="@ThemeConstants.Button.Size.Small"
...
<SunfishPromptBox @bind-Value="@Prompt"
    ...
    <PromptBoxTopAffixTemplate>
        <div class="p-2 border-bottom d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-1">
                <SunfishButton OnClick="OnBoldClick"
                               FillMode="@ThemeConstants.Button.FillMode.Clear"
                               Size="@ThemeConstants.Button.Size.Small"
                               Icon="SvgIcon.Bold" />
                <SunfishButton OnClick="OnItalicClick"
                               FillMode="@ThemeConstants.Button.FillMode.Clear"
                               Size="@ThemeConstants.Button.Size.Small"
                               Icon="SvgIcon.Italic" />
            </div>
...
<div class="prompt-container">
    <SunfishPromptBox OnBlur="@(() => Logs.Add("PromptBox blurred"))"
                      DebounceDelay="0"
