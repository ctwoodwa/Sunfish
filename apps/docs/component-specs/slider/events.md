...
slug: slider-events
tags: sunfish,blazor,slider,events
published: true
position: 20
components: ["slider"]
---
...
This article showcases the available events in the Sunfish Slider component:
...
<br />
<br />
<SunfishSlider Value="@TheValue" ValueChanged="@( (int v) => ValueChangedHandler(v))"
...
<br />
<br />
<SunfishSlider Value="@TheValue" OnChange="@OnChangeHandler"
               SmallStep="5" LargeStep="20" Min="0" Max="100" Width="500px">
</SunfishSlider>
