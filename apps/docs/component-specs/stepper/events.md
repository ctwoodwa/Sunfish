...
slug: stepper-events
tags: sunfish,blazor,stepper,events
published: True
position: 25
components: ["stepper"]
---
...
This article explains the events available in the Sunfish Stepper for Blazor:
...
The Sunfish Stepper for Blazor supports ValueChanged event. It fires upon every change of the CurrentStepIndex.
...
<SunfishStepper ValueChanged="@ValueChangeHandler">
    <StepperSteps>
...
## See Also
  ...
  * [Live Demo: Stepper Events](https://demos.sunfish.dev/blazor-ui/stepper/events)
