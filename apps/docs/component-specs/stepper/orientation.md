...
tags: sunfish,blazor,stepper,orientation
published: True
position: 15
components: ["stepper"]
---
...
You can customize the stepper orientation through the `Orientation` parameter the `SunfishStepper` exposes. It takes a member of the `Sunfish.Blazor.Enums.StepperOrientation` enum:
...
<SunfishStepper Orientation="StepperOrientation.Vertical">
    <StepperSteps>
        <StepperStep Text="1" Label="Step 1"></StepperStep>
        <StepperStep Text="2" Label="Step 2"></StepperStep>
        <StepperStep Text="3" Label="Step 3"></StepperStep>
...
## See Also
  ...
  * [Live Demo: Stepper Overview](https://demos.sunfish.dev/blazor-ui/stepper/overview)
  * [Live Demo: Stepper Configuration](https://demos.sunfish.dev/blazor-ui/stepper/configuration)