...
tags: sunfish,blazor,edit,mode,overview
published: True
position: 0
components: ["editor"]
---
...
You control which mode is used through the `EditMode` parameter of the editor which takes a member of the `Sunfish.Blazor.EditorEditMode` enum:
...
<SunfishEditor @bind-Value="@Val1" EditMode="@EditorEditMode.Iframe"></SunfishEditor>

<SunfishEditor @bind-Value="@Val2" EditMode="@EditorEditMode.Div"></SunfishEditor>
