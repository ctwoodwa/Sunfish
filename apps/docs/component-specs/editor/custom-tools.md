...
tags: sunfish,blazor,custom,tool
published: True
position: 60
...
The [Blazor Editor](https://sunfish.dev/blazor-ui/editor) component lets you add custom tools to its [toolbar](slug:editor-toolbar). In those tools, you can use both the [built-in tools and commands](slug:editor-built-in-tools) the editor provides, and also your own custom logic.
...
<SunfishEditor Tools="@Tools" @bind-Value="@TheEditorContent">
    <EditorCustomTools>
        <EditorCustomTool Name="AddSignature">
            <SunfishButton OnClick="@AddSignature">Add Signature</SunfishButton>
        </EditorCustomTool>
    </EditorCustomTools>
</SunfishEditor>
...
<SunfishEditor @ref="@EditorRef" Tools="@Tools" @bind-Value="@TheEditorContent">
    <EditorCustomTools>
        <EditorCustomTool Name="ImportantFragment">
            <SunfishButton OnClick="@MarkImportant" Icon="@SvgIcon.Star"></SunfishButton>
        </EditorCustomTool>
    </EditorCustomTools>
</SunfishEditor>
...
@code {
    ...
    SunfishEditor EditorRef { get; set; }
    IEnumerable<EditorTool> Tools { get; set; }
...
<SunfishEditor Tools="@Tools" @bind-Value="@TheEditorContent">
    <EditorCustomTools>
        <EditorCustomTool Name="Save">
            <SunfishButton OnClick="@Save" Icon="@SvgIcon.Save" />
        </EditorCustomTool>
    </EditorCustomTools>
</SunfishEditor>
