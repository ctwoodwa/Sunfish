...
slug: editor-events
tags: sunfish,blazor,editor,event
published: True
position: 150
components: ["editor"]
---
...
This article explains the events available in the Sunfish Editor for Blazor:
...
<SunfishEditor Value="@TheEditorContent" ValueChanged="@ValueChangedHandler">
</SunfishEditor>
