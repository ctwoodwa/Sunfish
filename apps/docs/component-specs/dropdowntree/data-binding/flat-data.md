...
description: Learn how to bind the Sunfish DropDownTree for Blazor to flat self-referencing data collections.
...
* [Live Demo: DropDownTree Flat Data](https://demos.sunfish.dev/blazor-ui/dropdowntree/flat-data)
