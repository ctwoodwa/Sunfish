...
description: The article describes the Sunfish Blazor DropDownTree component events and event arguments.
...
This article describes the available events in the Sunfish DropDownTree for Blazor:
...
````RAZOR.skip-repl
<SunfishDropDownTree ExpandedItems="@DropDownTreeExpandedItems"
...
````RAZOR.skip-repl
<SunfishDropDownTree OnBlur="@OnDropDownTreeBlur" />
...
````RAZOR.skip-repl
<SunfishDropDownTree OnClose="@OnDropDownTreeClose" />
...
````RAZOR.skip-repl
<SunfishDropDownTree OnFocus="@OnDropDownTreeFocus" />
...
````RAZOR.skip-repl
<SunfishDropDownTree OnItemClick="@OnDropDownTreeItemClick" />
...
````RAZOR.skip-repl
<SunfishDropDownTree OnItemRender="@OnDropDownTreeItemRender" />
...
````RAZOR.skip-repl
<SunfishDropDownTree OnOpen="@OnDropDownTreeOpen" />
...
````RAZOR.skip-repl
<SunfishDropDownTree Value="@DropDownTreeValue"
...
<div style="display: flex; gap: 2em; justify-content: space-between;">
    ...
    <div style="max-height: 90vh; overflow: auto; flex: 0 0 50%;">
        <p><label class="k-checkbox-label"><SunfishCheckBox @bind-Value="@ShowOnItemRender"/> Show OnItemRender events</label></p>
        <SunfishButton OnClick="@(() => DropDownTreeEventLog.Clear())">Clear Log</SunfishButton>
        <ul>
