...
tags: sunfish,blazor,barcode,overview
published: True
position: 0
components: ["barcode"]
---
...
The <a href="https://sunfish.dev/blazor-ui/barcode" target="_blank">Blazor Barcode component</a> represents data in a machine-readable format. It supports several different encoding standards.
...
1. Add the `SunfishBarcode` tag to add the component to your razor page.
...
>caption A basic configuration of the Sunfish Barcode

````RAZOR
<SunfishBarcode Width="300px"
                Height="200px"
                Value="123456789">
</SunfishBarcode>
````
...
<SunfishButton OnClick="@ChangeSize">Change Size!</SunfishButton>
<br />
<br />
<SunfishButton OnClick="@(() => SunfishBarcodeRef.Refresh())">Refresh component after changes!</SunfishButton>
<br />
<br />

<SunfishBarcode @ref="SunfishBarcodeRef" Width="@Width"
                Height="@Height"
                Value="123456789">
</SunfishBarcode>

@code{
    Sunfish.Blazor.Components.SunfishBarcode SunfishBarcodeRef { get; set; }
...
* [Live Demo: Barcode](https://demos.sunfish.dev/blazor-ui/barcode/overview)
* [Live Demo: Barcode Encoding](https://demos.sunfish.dev/blazor-ui/barcode/encodings)
