...
tags: sunfish,blazor,barcode,qrcode,overview
published: True
position: 0
components: ["qrcode"]
---
...
The <a href="https://sunfish.dev/blazor-ui/qr-code" target="_blank">Blazor QRCode component</a> generates **Canvas** and **SVG** images that represent Quick Response (QR) codes.
...
1. Use the `SunfishQRCode` tag to add the component to your razor page.
...
>caption Basic Sunfish QRCode

````RAZOR
<SunfishQRCode Value="https://sunfish.dev/blazor-ui"
               Size="200px">
</SunfishQRCode>
````
...
* [Live Demo: QRCode](https://demos.sunfish.dev/blazor-ui/qrcode/overview)
