...
page_title: Sunfish UI for Blazor Spreadsheet Documentation | Spreadsheet Accessibility
description: "Get started with the Sunfish UI for Blazor Spreadsheet and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Sunfish UI for Blazor Spreadsheet provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the Spreadsheet keyboard navigation works, refer to the [Blazor Spreadsheet Accessibility and Keyboard Navigation Demo](https://demos.sunfish.dev/blazor-ui/spreadsheet/keyboard-navigation).

## See Also

* [Blazor Spreadsheet Demos](https://demos.sunfish.dev/blazor-ui/spreadsheet/overview)
