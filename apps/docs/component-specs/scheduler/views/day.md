...
tags: sunfish,blazor,scheduler,view,day
published: True
position: 1
...
<SunfishScheduler Data="@Appointments" @bind-Date="@StartDate" Height="600px">
    <SchedulerViews>
...
* [Live Demo: Scheduler Day View](https://demos.sunfish.dev/blazor-ui/scheduler/day-view)
