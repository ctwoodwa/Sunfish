...
tags: sunfish,blazor,scheduler,view,agenda
published: True
position: 6
...
<SunfishCheckBox @bind-Value="@HideEmptyDays" Id="hide-emptydays-checkbox"></SunfishCheckBox>

<SunfishScheduler Data="@Appointments" @bind-Date="@StartDate" Width="800px">
    <SchedulerViews>
...
* [Live Demo: Scheduler Agenda View](https://demos.sunfish.dev/blazor-ui/scheduler/agenda-view)
