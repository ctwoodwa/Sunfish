...
tags: sunfish,blazor,scheduler,view,month
published: True
position: 4
...
<SunfishScheduler Data="@Appointments" @bind-Date="@StartDate" @bind-View="@SelectedView" Height="600px">
    <SchedulerViews>
...
* [Live Demo: Scheduler Month View](https://demos.sunfish.dev/blazor-ui/scheduler/month-view)
