...
tags: sunfish,blazor,scheduler,resources
published: true
position: 30
...
> **Implementation status:** v1 implemented. The `Resources`, `ResourceIdField`, and `GroupByResource` parameters are available on `SunfishScheduler`. Resource grouping is supported in Day, Week, and Month views.
...
* [Live Demo: Scheduler Resources](https://demos.sunfish.dev/blazor-ui/scheduler/resources)
