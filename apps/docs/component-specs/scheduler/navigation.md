...
tags: sunfish,blazor,scheduler,navigation
published: true
position: 4
...
````RAZOR
Change active date:
<SunfishDatePicker @bind-Value="@StartDate" />
<br />
Change current View:
<SunfishDropDownList Data="@AvailableViews" @bind-Value="@CurrView" />


<SunfishScheduler Data="@Appointments" @bind-Date="@StartDate" @bind-View="@CurrView" Height="600px">
    <SchedulerViews>
