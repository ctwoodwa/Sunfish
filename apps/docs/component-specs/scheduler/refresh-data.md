...
tags: sunfish,blazor,scheduler,observable,data,new,collection
published: True
position: 40
...
You can refresh the Scheduler data by using the Rebind method exposed to the reference of the SunfishScheduler.
...
<SunfishButton OnClick="@AddAppointment">Add appointment</SunfishButton>

<SunfishButton OnClick="@RemoveAppointment">Remove appointment</SunfishButton>

<SunfishButton OnClick="@ChangeData">Change data</SunfishButton>

<SunfishScheduler @ref="SchedulerRef" Data="@Appointments" @bind-Date="@StartDate" @bind-View="@CurrView" Height="600px" Width="800px">
    <SchedulerViews>
...
@code {
    SunfishScheduler<SchedulerAppointment> SchedulerRef { get; set; }
...
<SunfishScheduler Data="@Appointments" @bind-Date="@StartDate" @bind-View="@CurrView" Height="600px" Width="800px">
    <SchedulerViews>
        <SchedulerDayView StartTime="@DayStart" />
        <SchedulerWeekView StartTime="@DayStart" />
        <SchedulerMultiDayView StartTime="@DayStart" NumberOfDays="10" />
