...
tags: sunfish,blazor,gridlayout,items
published: True
position: 5
...
<SunfishNumericTextBox @bind-Value="@ColumnSpan" Max="3" Min="1" Width="200px"/>
...
<SunfishNumericTextBox @bind-Value="@RowSpan" Max="3" Min="1" Width="200px"/>
...
````RAZOR
@* Create a page layout with the Sunfish Components *@
...
<SunfishGridLayout>
    ...
    <GridLayoutItems>
        <GridLayoutItem Column="1" Row="1" ColumnSpan="3">
            <span>
                <SunfishButton OnClick="@(() => DrawerRef.ToggleAsync())" Icon="@("menu")">Toggle drawer</SunfishButton>
            </span>
        </GridLayoutItem>
        <GridLayoutItem Column="1" Row="2">

            <div style="width: 200px">
                <SunfishDrawer Data="@DrawerData"
                               MiniMode="true"
        ...
        <GridLayoutItem Column="2" Row="2">
            ...
            <SunfishGrid Data="@GridData"
                         ...
                         Sortable="true"
                         Groupable="true"
                         FilterMode="Sunfish.Blazor.GridFilterMode.FilterRow"
                         Resizable="true"
                         Reorderable="true">
            </SunfishGrid>
        ...
        <GridLayoutItem Column="3" Row="2">
            <SunfishTreeView Data="@TreeViewData">
                <TreeViewBindings>
        ...
        <GridLayoutItem Column="1" ColumnSpan="3">
            <SunfishSwitch @bind-Value="@likedLayout" Width="70px" Id="layout-liked" OnLabel="Liked" OffLabel="Not"></SunfishSwitch>
