...
tags: sunfish, blazor, smartpastebutton, events, ai
published: True
position: 20
...
This article describes the events available in the Sunfish SmartPasteButton for Blazor:
...
The event handler receives an argument of type [`SmartPasteButtonRequestStartEventArgs`](https://docs.sunfish.dev/blazor-ui/api/Sunfish.Blazor.Components.SmartPasteButtonRequestStartEventArgs).
...
<div style="display: flex; max-width: 600px; margin-bottom: 16px;">
    <div style="flex: 1; margin-right: 16px;">
        ...
        <SunfishButton OnClick="@CopySampleText" Icon="SvgIcon.Copy">Copy</SunfishButton>
    </div>
...
````RAZOR Home.razor
<SunfishSmartPasteButton ChatClientKey="gpt-4o-mini"
...
* [SmartPasteButton Live Events Demo](https://demos.sunfish.dev/blazor-ui/smartpastebutton/events)
