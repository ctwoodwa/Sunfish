...
tags: sunfish, blazor, smartpastebutton, ai, forms, validation
published: True
position: 10
...
<div style="max-width: 500px; display: flex; flex-direction: column; gap: 12px;">
    <SunfishTextArea @bind-Value="SourceText"
                     Placeholder="Paste or edit text here" />
    <SunfishButton OnClick="@CopyToClipboard">
        Copy Text
    </SunfishButton>
        ...
        <FormItems>
            <FormItem Field="@nameof(FormData.Name)" LabelText="Name">
                <Template>
                    ...
                    <div class="k-form-field-wrap">
                        <SunfishTextBox Id="name" @bind-Value="FormModel.Name" />
                    </div>
                </Template>
            </FormItem>
            ...
            <FormItem Field="@nameof(FormData.Email)" LabelText="Email">
                <Template>
                    ...
                    <div class="k-form-field-wrap">
                        <SunfishTextBox Id="email" @bind-Value="FormModel.Email" />
                        <SunfishValidationMessage For="@(() => FormModel.Email)" />
                    </div>
                </Template>
            </FormItem>
        </FormItems>
...
* [SmartPasteButton Live Validation Demo](https://demos.sunfish.dev/blazor-ui/smartpastebutton/validation)
