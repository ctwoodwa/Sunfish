...
tags: sunfish,blazor,window,size
published: True
position: 1
components: ["window"]
---
...
You can invoke those actions by setting the `State` parameter. It takes a member of the `Sunfish.Blazor.WindowState` enum:
...
<SunfishWindow @bind-State="@State" Width="500px" Height="300px" Visible="true"
...
<SunfishButton OnClick="@(() => WindowResizable = !WindowResizable)">Toggle Resizable</SunfishButton>

<SunfishWindow @bind-Visible="@WindowVisible"
...
* [Live Demo: Window Size](https://demos.sunfish.dev/blazor-ui/window/dimensions)
