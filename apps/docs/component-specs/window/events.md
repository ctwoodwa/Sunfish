...
slug: window-events
tags: sunfish,blazor,window,events
published: True
position: 20
components: ["window"]
---
...
This article explains the events available in the Sunfish Window for Blazor:
...
<SunfishButton OnClick="@ToggleWindow">Toggle the Window</SunfishButton>

<SunfishWindow Visible="@isVisible" VisibleChanged="@VisibleChangedHandler">
    <WindowTitle>
...
<SunfishButton OnClick="@( _ => isVisible = !isVisible )">Toggle the Window</SunfishButton>
...
<SunfishWindow State="@State" StateChanged="@StateChangedHandler" Width="500px" Height="300px" Visible="true"
...
<SunfishWindow Left="@TheLeft" Top="@TheTop" Draggable="true"
