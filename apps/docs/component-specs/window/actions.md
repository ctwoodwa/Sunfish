...
tags: sunfish,blazor,window,actions
published: True
position: 3
components: ["window"]
---
...
| `Icon` | `string` | The CSS class of the icon to be rendered. Use with the [Sunfish font icons](slug:common-features-icons), or set your own font icon class. |
...
<SunfishWindow Visible="@WindowVisible">
	<WindowActions>
...
@if (!WindowVisible)
{
	<SunfishButton OnClick="@( () => WindowVisible=true )">Show the Window</SunfishButton>
}
...
* [(Demo) Window Actions](https://demos.sunfish.dev/blazor-ui/window/actions)
