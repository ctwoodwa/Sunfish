...
tags: sunfish,blazor,window,overview
published: True
position: 0
components: ["window"]
---
...
This article provides basic information about the <a href="https://sunfish.dev/blazor-ui/window" target="_blank">Blazor Window component</a> and its core features.
...
The following table lists the Window parameters. Also check the [Window API](slug:Sunfish.Blazor.Components.SunfishWindow) for a full list of parameters, methods, and events.
...
| `ThemeColor` | `string` | A predefined color scheme for the Window, especially the titlebar. Use the available members of the static class [`ThemeConstants.Window.ThemeColor`](slug:Sunfish.Blazor.ThemeConstants.Window.ThemeColor). |
...
````RAZOR
<SunfishButton OnClick="@OpenWindow">Open Window</SunfishButton>

<SunfishWindow @ref="WindowRef" @bind-Visible="@WindowVisible">
    <WindowTitle>
        Window Title
    </WindowTitle>
    <WindowActions>
    ...
    <WindowContent>
        ...
        <SunfishButton OnClick="IncrementCount">Increment Count</SunfishButton>
    </WindowContent>
</SunfishWindow>

@code {
    private SunfishWindow? WindowRef { get; set; }
...
When [`ContainmentSelector`](slug:components/window/position#containmentselector) is not set, the Sunfish Window component renders as a child of the [`SunfishRootComponent`](slug:rootcomponent-overview) at the root of the Blazor app. This placement ensures that the Window can show over all the other page content in all scenarios and have a correct position.
...
* [Live Demo: Window](https://demos.sunfish.dev/blazor-ui/window/overview)
* [Window API Reference](slug:Sunfish.Blazor.Components.SunfishWindow)
