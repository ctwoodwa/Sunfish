...
slug: gantt-tree
tags: sunfish,blazor,gantt,chart,tree
published: True
position: 0
components: ["gantt"]
---
...
Set data to the component through its [data binding](slug:gantt-data-binding-overview) options. You can also use the [filtering](slug:gantt-filtering-overview), [sorting](slug:gantt-sorting), and [editing](slug:gantt-tree-editing) capabilities of the Sunfish Gantt for Blazor.
