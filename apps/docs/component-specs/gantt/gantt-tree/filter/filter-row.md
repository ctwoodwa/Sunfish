...
tags: sunfish,blazor,gantt,filtering,filter,row
published: True
position: 5
components: ["gantt"]
---
...
When a filter matches child items, the Gantt automatically expands parent nodes to reveal matching results.

>caption Filter Row in Sunfish Gantt
...
## See Also
  ...
  * [Live Demo: Gantt Filter Row](https://demos.sunfish.dev/blazor-ui/gantt/filter-row)