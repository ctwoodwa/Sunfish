...
tags: sunfish,blazor,textbox,events
published: true
position: 20
components: ["textbox"]
---
...
This article explains the events available in the <a href = "https://sunfish.dev/blazor-ui/textbox" target="_blank">Sunfish Textbox for Blazor</a>:
...
````RAZOR
<SunfishTextBox Value="@TextBoxValue"
