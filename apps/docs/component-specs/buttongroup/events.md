...
This article describes the events of the Sunfish ButtonGroup component for Blazor.
...
<p><label><SunfishCheckBox @bind-Value="@HandleEvents" /> Handle SelectedChanged</label></p>
