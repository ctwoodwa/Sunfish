...
tags: sunfish,blazor,buttongroup,button,appearance
published: True
position: 35
...
You can control the appearance of the buttons in the `<SunfishButtonGroup>` by setting the following attributes:
...
The `FillMode` toggles the background and border of the SunfishButton. You can set the parameter to a member of the `Sunfish.Blazor.ThemeConstants.Button.FillMode` class:
