...
tags: sunfish,blazor,chart,OHLC
published: True
position: 0
components: ["charts"]
---
...
The <a href="https://sunfish.dev/blazor-ui/ohlc-chart" target="_blank">OHLC (open-high-low-close) chart </a> is typically used to illustrate movements in the price of a financial instrument over time. Each vertical line on the chart shows the price range (the highest and lowest prices) over a period of time.
...
<SunfishChart Height="480px" Width="640px">

    <ChartSeriesItems>
        <SunfishChartSeries Type="@ChartSeriesType.OHLC"
                     Name="Product 1"
 ...
 * [Live Demo: OHLC Chart](https://demos.sunfish.dev/blazor-ui/chart/ohlc-chart)
