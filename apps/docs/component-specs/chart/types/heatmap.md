...
tags: sunfish,blazor,chart,heatmap
published: True
position: 13
components: ["charts"]
---
...
The <a href="https://sunfish.dev/blazor-ui/heatmap" target="_blank">Blazor Heatmap chart</a> shows the data in a grid-like structure that shows the magnitude of a value over two dimensions.
...
<SunfishChart>
    <ChartSeriesItems>
        <SunfishChartSeries Type="@ChartSeriesType.Heatmap"
...
To change the marker type you should set the `Type` parameter, exposed on the `ChartSeriesMarkers` tag (child tag of the `<SunfishChartSeries>`). It takes a member of the ChartSeriesMarkersType enum:
...
## See Also
  ...
  * [Live Demo: Heatmap Chart](https://demos.sunfish.dev/blazor-ui/chart/heatmap-chart)
