...
tags: sunfish,blazor,chart,stack,group
published: True
position: 20
components: ["charts"]
---
...
To use a 100% stacks, set the `Type` property of the first stacked series to `Sunfish.Blazor.ChartSeriesStackType.Stack100`.
...
<SunfishChart>
    <ChartSeriesItems>
        <SunfishChartSeries Type="ChartSeriesType.Column" Name="Product 1" Data="@series1Data">
            <ChartSeriesStack Group="myStack" Type="Sunfish.Blazor.ChartSeriesStackType.Stack100"></ChartSeriesStack>
        </SunfishChartSeries>
        <SunfishChartSeries Type="ChartSeriesType.Column" Name="Product 2" Data="@series2Data">
            <ChartSeriesStack Group="myStack"></ChartSeriesStack>
        </SunfishChartSeries>
