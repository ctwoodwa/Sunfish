...
tags: sunfish,blazor,MultiSelect,virtualization
published: True
position: 25
...
Number of selected items: @SelectedValues?.Count
<br />
<SunfishMultiSelect TItem="@Person" TValue="@int"
                    ScrollMode="@DropDownScrollMode.Virtual"
...
## See Also
  ...
  * [Live Demo: MultiSelect Virtualization](https://demos.sunfish.dev/blazor-ui/multiselect/virtualization)
