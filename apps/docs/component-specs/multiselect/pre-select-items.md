...
tags: sunfish,blazor,multiselect,pre-select
published: True
position: 8
...
````RAZOR
Select IDs
<SunfishNumericTextBox @bind-Value="@Id1" Min="1" Max="10" Width="70px" />
and
<SunfishNumericTextBox @bind-Value="@Id2" Min="1" Max="10" Width="70px" />

<SunfishButton OnClick="@SelectItems">Apply</SunfishButton>
<SunfishButton OnClick="@ClearSelection">Clear Selection</SunfishButton>

<br />

<SunfishMultiSelect Data="@Products"
