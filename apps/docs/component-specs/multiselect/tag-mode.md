...
tags: sunfish,blazor,multiselect,tag,mode,single,multiple,summary
published: True
position: 17
...
To configure the tag mode, use the `TagMode` parameter. It accepts a member of the `Sunfish.Blazor.MultiSelectTagMode` enum.
...
## See Also
  ...
  * [Live Demo: MultiSelect Tag Mode](https://demos.sunfish.dev/blazor-ui/multiselect/tag-mode)
