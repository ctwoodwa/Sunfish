...
tags: sunfish,blazor,multiselect,events
published: true
position: 35
...
This article explains the events available in the Sunfish MultiSelect for Blazor:
...
<SunfishMultiSelect Data="@MultiData"
                    Value="@MultiValues"
...
@result
<br />
<SunfishMultiSelect Data="@Roles" @bind-Value="@TheValues" OnChange="@MyOnChangeHandler" />
<br />
from the model:
<ul>
...
<SunfishMultiSelect TItem="@String" TValue="@String"
                    OnRead="@ReadItems"
...
<SunfishMultiSelect Data="@Options"
...
<SunfishMultiSelect @bind-Value="@TheValues" Data="@Options"
