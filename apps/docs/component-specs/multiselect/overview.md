...
tags: sunfish,blazor,multiselect,overview
published: True
position: 0
...
>tip To learn more about the appearance, anatomy, and accessibility of the MultiSelect, visit the [Progress Design System Kit documentation](https://sunfish.dev/design-system/docs/components/multiselect/)—an information portal offering rich component usage guidelines, descriptions of the available style variables, and globalization support details.
...
````RAZOR.skip-repl
<SunfishMultiSelect Data="@MultiSelectData"
...
Add a reference to the component instance to use the [MultiSelect's methods](slug:Sunfish.Blazor.Components.SunfishMultiSelect-2). Note that the [MultiSelect is a generic component](slug:common-features-data-binding-overview#component-type).


@[template](/_contentTemplates/dropdowns/methods.md#methods-list)

````RAZOR.skip-repl
<SunfishMultiSelect @ref="@MultiSelectRef" .../>
...
* [Live Demo: MultiSelect](https://demos.sunfish.dev/blazor-ui/multiselect/overview)
* [Live Demo: MultiSelect Validation](https://demos.sunfish.dev/blazor-ui/multiselect/validation)
* [MultiSelect API Reference](slug:Sunfish.Blazor.Components.SunfishMultiSelect-2)
