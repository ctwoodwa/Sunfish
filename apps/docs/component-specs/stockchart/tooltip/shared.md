...
tags: sunfish,blazor,stock,chart,tooltip,shared,tooltips
published: True
position: 2
components: ["stockchart"]
---
# Shared Tooltip for Sunfish Blazor Stock Chart

The Sunfish Stock Chart allows you to show a unified tooltip for all categories in the Chart.
...
1. Inside the `<SunfishStockChart>` tag, add the `<StockChartTooltip>` tag.
