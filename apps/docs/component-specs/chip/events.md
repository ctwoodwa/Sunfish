...
slug: chip-events
tags: sunfish,blazor,chip,events
published: true
position: 20
components: ["chip"]
---
...
This article showcases the available events in the Sunfish Chip component, together with a complete [example](#example).
...
````RAZOR
<SunfishChip Selected="@IsChipSelected"
...
* [Live Demo: Chip Events](https://demos.sunfish.dev/blazor-ui/chip/events)
