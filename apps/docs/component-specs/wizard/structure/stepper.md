...
tags: sunfish,blazor,wizard,stepper
published: True
position: 0
components: ["wizard"]
---
...
One of the main elements of the Wizard component is the Stepper. The Wizard component utilizes the [Sunfish UI for Blazor Stepper](slug:stepper-overview) internally.

You can use the parameters the `WizardStep` exposes to customize the following properties of the internal stepper:

* [General Stepper settings](#general-stepper-settings)
    * [StepType](#steptype)
...
<div style="text-align:center">
    <SunfishWizard Width="600px" Height="250px">
        <WizardSettings>
...
* `Icon` - `object` - Specifies the [Sunfish Font or SVG icon](slug:common-features-icons) which will be put inside the step indicator.
...
<SunfishButton OnClick="@ToggleDisabled">Toggle Disabled of the Preview Step</SunfishButton>
