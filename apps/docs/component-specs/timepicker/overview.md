...
tags: sunfish,blazor,time,picker,timepicker,overview
published: True
position: 0
...
<SunfishTimePicker Min="@Min" Max="@Max" Format="hh:mm:ss tt" @bind-Value="@selectedTime"></SunfishTimePicker>
...
The Blazor Time Picker component provides various parameters that allow you to configure the component. Also check the [TimePicker's public API](slug:Sunfish.Blazor.Components.SunfishTimePicker-1).
...
Add a reference to the component instance to use the [Time Picker's methods](slug:Sunfish.Blazor.Components.SunfishTimePicker-1).
...
````RAZOR
<SunfishTimePicker @ref="@TimePickerRef"
...
@code {    
    ...
    private SunfishTimePicker<DateTime> TimePickerRef { get; set; }
...
* [Live Demo: Time Picker](https://demos.sunfish.dev/blazor-ui/timepicker/overview)
* [Input Validation](slug:common-features/input-validation)
* [Supported Input Date Formats](slug:components/dateinput/supported-formats)
* [TimePicker API Reference](slug:Sunfish.Blazor.Components.SunfishTimePicker-1)
