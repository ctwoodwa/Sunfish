...
tags: sunfish,blazor,TimePicker,step
published: true
position: 5
...
<SunfishTimePicker Format="hh:mm:ss tt" @bind-Value="@selectedTime">
...
* [Live Demo: Time Picker Incremental Steps](https://demos.sunfish.dev/blazor-ui/timepicker/incremental-steps)
