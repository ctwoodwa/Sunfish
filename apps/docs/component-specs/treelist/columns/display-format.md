...
tags: sunfish,blazor,treelist,column,display,format
published: True
position: 2
components: ["treelist"]
---
...
<SunfishTreeList Data="@Data" ItemsField="Items" Pageable="true">
    <TreeListColumns>
...
## See Also
  ...
  * [Live Demo: Cell Formatting](https://demos.sunfish.dev/blazor-ui/treelist/cell-formatting)
