...
tags: sunfish,blazor,treelist,column,resize,drag
published: True
position: 3
components: ["treelist"]
---
...
>caption How column resizing works in the Sunfish TreeList
...
````RAZOR
<SunfishButton OnClick="@AutoFitSingleColumn">AutoFit Name Column</SunfishButton>
<SunfishButton OnClick="@AutoFitMultipleColumns">AutoFit Id and ParentId Columns</SunfishButton>
<SunfishButton OnClick="@AutoFitAllColumns">AutoFit All Columns</SunfishButton>

<SunfishTreeList @ref="@TreeList" Data="@TreeListData" Resizable="true"
...
@code {
    private SunfishTreeList<Employee>? TreeList { get; set; }
...
* [Live Demo: Column Resizing](https://demos.sunfish.dev/blazor-ui/treelist/column-resizing)
