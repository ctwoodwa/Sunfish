...
tags: sunfish,blazor,treelist,bound,column
published: True
position: 0
components: ["treelist"]
---
...
<SunfishTreeList Data="@Data" Pageable="true" IdField="Id" ParentIdField="ParentId" Width="650px">
    <TreeListColumns>
...
* `EditorType` - set the [editor component for `string` or `DateTime` columns](slug:treelist-editing-overview#column-editors) when an [`EditorTemplate`](slug:treelist-templates-editor) is not used.
...
>tip You can find more examples in the rest of the treelist documentation and in our [live demos](https://demos.sunfish.dev/blazor-ui/treelist/overview).
...
## See Also
  ...
  * [Live Demo: TreeList Columns](https://demos.sunfish.dev/blazor-ui/treelist/columns)
