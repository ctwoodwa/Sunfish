...
tags: sunfish,blazor,treelist,column,command
published: True
position: 1
components: ["treelist"]
---
...
* Appearance properties like `Icon`, `Class`, `Enabled` that are come from the underlying [Sunfish UI for Blazor Button Component features](slug:components/button/overview).
...
## See Also
  ...
  * [Live Demo: TreeList Command Column](https://demos.sunfish.dev/blazor-ui/treelist/editing-inline)
