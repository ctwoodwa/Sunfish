...
description: Configuration options for the Sunfish Blazor TreeList Checkbox Column
slug: treelist-columns-checkbox
tags: sunfish,blazor,TreeList,column,selection
published: True
position: 2
components: ["treelist"]
---
...
* [Live Demo: TreeList Selection](https://demos.sunfish.dev/blazor-ui/treelist/row-selection)
