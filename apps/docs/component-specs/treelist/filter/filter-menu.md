...
tags: sunfish,blazor,TreeList,filtering,filter,menu
published: True
position: 10
components: ["treelist"]
---
...
To enable the filter menu, set the `FilterMode` property of the grid to `Sunfish.Blazor.TreeListFilterMode.FilterMenu`.
...
>caption Filter Menu in Sunfish TreeList
