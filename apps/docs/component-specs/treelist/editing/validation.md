...
tags: sunfish, blazor, treelist, validation, editing
published: True
position: 40
components: ["treelist"]
---
...
The Sunfish TreeList for Blazor supports built-in validation that is enabled by default. This article describes how the TreeList validation works and how to customize or disable it.
...
>caption Use Sunfish TreeList for Blazor with FluentValidation
...
<SunfishTreeList Data="@TreeListData"
    ...
    <TreeListToolBarTemplate>
        ...
        <label class="k-checkbox-label">
            <SunfishCheckBox @bind-Value="@TreeListValidationEnabled" />
            Enable Validation
        </label>
    </TreeListToolBarTemplate>
    <TreeListColumns>
