...
tags: sunfish,blazor,context menu,data,bind,databind,databinding,basics
published: True
position: 0
...
* `Icon` - The [Sunfish Font or SVG icon](slug:common-features-icons) that will be rendered in the item. Read more in the [Icons article](slug:contextmenu-icons).
...
<SunfishContextMenu Data="@ContextMenuItems" Selector=".menuTarget"
...
## See Also
  ...
  * [Live Demo: Context Menu](https://demos.sunfish.dev/blazor-ui/contextmenu/overview)
