...
tags: sunfish,blazor,context menu,events
published: true
position: 30
...
This article describes the events that are fired by the Sunfish Context Menu for Blazor:
...
<SunfishContextMenu Data="@MenuItems" Selector="#context-menu-target"
...
<SunfishContextMenu Data="@MenuItems"
