...
tags: sunfish,blazor,calendar,navigation,min,max
published: True
position: 2
components: ["calendar"]
---
...
<SunfishCalendar @bind-Date="@startDate" @bind-View="@selectedView" Min="@minDate" Max="@maxDate"></SunfishCalendar>
@code {
...
To control the initial view, set the `View` property to a member of the `Sunfish.Blazor.CalendarView` enum, as listed above.
...
<SunfishCalendar TopView="@CalendarView.Year" BottomView="@CalendarView.Year" @bind-View="@SelectedView"
...
<SunfishCalendar @bind-Date="@startDate" @bind-View="@calendarView"
                 Min="@min" Max="@max">
</SunfishCalendar>
<SunfishButton OnClick="@UpdateView">Update View</SunfishButton>
