...
tags: sunfish,blazor,calendar,templates,Decade
published: True
position: 4
components: ["calendar"]
---
...
<SunfishCalendar @bind-Date="@startDate" @bind-View="@theView">
    <DecadeCellTemplate>
        @if (yearsWithEvents.Contains(context.Year))
        {
            <SunfishSvgIcon Icon="@SvgIcon.ExclamationCircle"></SunfishSvgIcon>
        }
        @context.Year
    </DecadeCellTemplate>
</SunfishCalendar>
