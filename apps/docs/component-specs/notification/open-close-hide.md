...
tags: sunfish,blazor,notification,open,close,hide
published: True
position: 20
...
<SunfishButton OnClick="@AddAutoClosingNotification">Add Auto closing notification</SunfishButton>
...
<SunfishButton OnClick="@AddManuallyClosingNotification">Add manually closing notification</SunfishButton>
...
<SunfishButton OnClick="@AddTwoNotifications">Add two notifications</SunfishButton>
<SunfishButton OnClick="@HideAllNotification">Hide All Notifications</SunfishButton>
