...
tags: sunfish,blazor,notification,template,templates
published: True
position: 10
...
<SunfishButton OnClick="@AddNotifications">Add notifications</SunfishButton>

<SunfishNotification @ref="@NotificationReference1">
    <Template>
        The current text is: @context.Text
    </Template>
</SunfishNotification>

<SunfishNotification @ref="@NotificationReference2">
    <Template>
...
@code {
    public SunfishNotification NotificationReference1 { get; set; }
    public SunfishNotification NotificationReference2 { get; set; }
...
## See Also
  ...
  * [Live Demo: Notification Template](https://demos.sunfish.dev/blazor-ui/notification/template)
