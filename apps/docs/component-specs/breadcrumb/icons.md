...
tags: sunfish,blazor,breadcrumb,icons
published: True
position: 10
...
You can add [Sunfish Font or SVG icons](slug:common-features-icons) to the Breadcrumb items. The component also supports custom icons.
...
>caption How to use icons in Sunfish Breadcrumb

````RAZOR
<SunfishBreadcrumb Data="@Data"></SunfishBreadcrumb>
...
* [Live Demo: Breadcrumb Items](https://demos.sunfish.dev/blazor-ui/breadcrumb/items)
