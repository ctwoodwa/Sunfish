...
tags: sunfish,blazor,breadcrumb,overview
published: True
position: 0
...
To use a Sunfish Breadcrumb for Blazor:

1. add the `SunfishBreadcrumb` tag
...
````RAZOR
<SunfishBreadcrumb @ref="theBreadcrumbRef" Data="@Items">
</SunfishBreadcrumb>

@code{
    Sunfish.Blazor.Components.SunfishBreadcrumb<BreadcrumbItem> theBreadcrumbRef { get; set; }
...
* `Size`&mdash;the size of the Breadcrumb component. You can set it to a member of the `Sunfish.Blazor.ThemeConstants.Breadcrumb.Size` class. The default value is `Medium`.
...
* [BreadCrumb API Reference](slug:Sunfish.Blazor.Components.SunfishBreadcrumb-1)
