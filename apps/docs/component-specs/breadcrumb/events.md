...
tags: sunfish,blazor,breadcrumb,events
published: True
position: 30
...
This article explains the events available in the Sunfish Breadcrumb for Blazor:
...
<SunfishBreadcrumb OnItemClick="@ClickHandler"
                   Data="@Items" >
</SunfishBreadcrumb>
...
* [Live Demo: Breadcrumb Events](https://demos.sunfish.dev/blazor-ui/breadcrumb/events)
