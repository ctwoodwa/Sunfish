...
tags: sunfish,blazor,badge,navbar,appearance
published: True
position: 35
components: ["badge"]
---
...
You can toggle the Badge border and background by setting the `FillMode` parameter to a member of the `Sunfish.Blazor.ThemeConstants.Badge.FillMode` class:
...
The `Rounded` parameter applies the `border-radius` CSS rule to the Badge and lets you curve its edges. You can set it to a member of the `Sunfish.Blazor.ThemeConstants.Badge.Rounded` class:
...
You can increase or decrease the size of the Badge by setting the `Size` parameter to a member of the `Sunfish.Blazor.ThemeConstants.Badge.Size` class:
...
You can change the color of the Badge by setting the `ThemeColor` parameter to a member of the `Sunfish.Blazor.ThemeConstants.Badge.ThemeColor` class:
...
<div class="container">
    <div class="row">
        <div class="col-md-3">
            <label>
                Theme Color
                <SunfishDropDownList Data="@ThemeColors" @bind-Value="@ThemeColor"></SunfishDropDownList>
            </label>
        </div>
        <div class="col-md-3">
            <label>
                FillMode
                <SunfishDropDownList Data="@FillModes" @bind-Value="@FillMode"></SunfishDropDownList>
            </label>
        </div>
        <div class="col-md-3">
            <label>
                Rounded
                <SunfishDropDownList Data="@RoundedValues" @bind-Value="@Rounded"></SunfishDropDownList>
            </label>
        </div>
        <div class="col-md-3">
            <label>
                Size
                <SunfishDropDownList Data="@Sizes" @bind-Value="@Size"></SunfishDropDownList>
            </label>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <SunfishButton>
                Notifications
                <SunfishBadge ThemeColor="@ThemeColor"
                              Rounded="@Rounded"
                              FillMode="@FillMode"
                              Size="@Size">
                    10
...
* [Live Demo: Badge Appearance](https://demos.sunfish.dev/blazor-ui/badge/appearance)
