...
tags: sunfish,blazor,splitbutton,appearance,styling
published: True
position: 10
...
````RAZOR
<SunfishSplitButton FillMode="@ThemeConstants.SplitButton.FillMode.Solid"
...
<SunfishSplitButton FillMode="solid"
                    Rounded="lg"
                    Size="lg"
                    ThemeColor="primary">
    <SplitButtonContent> Foo </SplitButtonContent>
...
@foreach (var item in FillModes)
{
    ...
    <SunfishSplitButton FillMode="@fillMode">
...
@foreach (var item in RoundedOptions)
{
    ...
    <SunfishSplitButton Rounded="@rounded">
...
@foreach (var item in ThemeColors)
{
    ...
    <SunfishSplitButton ThemeColor="@themeColor">
...
* [Live Demo: SplitButton Appearance](https://demos.sunfish.dev/blazor-ui/splitbutton/appearance)
