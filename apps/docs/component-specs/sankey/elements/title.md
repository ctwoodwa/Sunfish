...
slug: sankey-title
tags: sunfish,blazor,sankey,diagram,chart,title
published: True
position: 7
components: ["sankey"]
---
...
1. Declare a `<SankeyTitle>` tag as a direct child of `<SunfishSankey>`.
...
| --------- | ---- | ----------- |
| `Align` | [`SankeyTitleAlign` enum](slug:sunfish.blazor.sankeytitlealign) <br/> (`Left`) | The alignment of the title. |
...
| `Position` | [`SankeyTitlePosition` enum](slug:sunfish.blazor.sankeytitleposition) <br/> (`Top`)| The position of the title. |
...
* [`Border`](slug:sunfish.blazor.components.sankeytitleborder)
* [`Margin`](slug:sunfish.blazor.components.sankeytitlemargin)
* [`Padding`](slug:sunfish.blazor.components.sankeytitlepadding)
