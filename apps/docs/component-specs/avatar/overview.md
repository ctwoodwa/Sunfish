...
tags: sunfish,blazor,avatar,overview
published: True
position: 0
components: ["avatar"]
---
...
The <a href="https://sunfish.dev/blazor-ui/avatar" target="_blank">Blazor Avatar component</a> is typically used to display images, icons or initials representing people or other entities.
...
1. Use the `SunfishAvatar` tag to add the component to your razor page.

1. Declare your desired content (as `ChildContent`) inside the `SunfishAvatar` tag - text, icon or image. This example demonstrates Avatar with initials (text).
...
<SunfishAvatar Type="AvatarType.Text"
               ThemeColor="@Sunfish.Blazor.ThemeConstants.Avatar.ThemeColor.Info">
    JD
</SunfishAvatar>
````
...
## See Also
  ...
  * [Live Demo: Avatar](https://demos.sunfish.dev/blazor-ui/avatar/overview)