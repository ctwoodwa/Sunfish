...
tags: sunfish,blazor,skeleton,appearance
published: True
position: 5
components: ["skeleton"]
---
...
<div class="row">
    <div class="col-4" style="position: relative;">
        <SunfishSkeleton ShapeType="@SkeletonShapeType.Circle"
    ...
    <div class="col-4" style="position: relative;">
        <SunfishSkeleton ShapeType="@SkeletonShapeType.Text"
                         Width="50px" Height="50px" Visible="true">
        </SunfishSkeleton>
    </div>
</div>
...
<div class="row">
    <div class="col-4" style="position:relative;">
        <SunfishSkeleton AnimationType="@SkeletonAnimationType.None"
                         Width="50px" Height="50px" Visible="true">
        </SunfishSkeleton>
    </div>
    <div class="col-4" style="position:relative;">
        <SunfishSkeleton AnimationType="@SkeletonAnimationType.Pulse"
                         Width="50px" Height="50px" Visible="true">
        </SunfishSkeleton>
    </div>
    <div class="col-4" style="position:relative;">
        <SunfishSkeleton AnimationType="@SkeletonAnimationType.Wave"
                         Width="50px" Height="50px" Visible="true">
        </SunfishSkeleton>
    </div>
</div>
...
* [Live Demo: Skeleton Appearance](https://demos.sunfish.dev/blazor-ui/skeleton/appearance)
