...
page_title: Sunfish UI for Blazor Pager Documentation | Pager Accessibility
description: "Get started with the Sunfish UI for Blazor Pager and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Sunfish UI for Blazor Pager provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the Pager keyboard navigation works, refer to the [Blazor Pager Accessibility and Keyboard Navigation Demo](https://demos.sunfish.dev/blazor-ui/pager/keyboard-navigation).
