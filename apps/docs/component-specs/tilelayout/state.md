...
tags: sunfish,blazor,tile,layout,dashboard,state
published: True
position: 25
...
You can see this feature in the [Live Demo: TileLayout State](https://demos.sunfish.dev/blazor-ui/tilelayout/persist-state).
...
<SunfishButton OnClick="@SaveState" Icon="@SvgIcon.Save" Class="mr-sm">Save State</SunfishButton>
<SunfishButton OnClick="@ReloadPage" Icon="@SvgIcon.ArrowRotateCw" Class="mr-sm">Reload the page</SunfishButton>
<SunfishButton OnClick="@LoadState" Icon="@SvgIcon.Download" Class="mr-sm">Load last State</SunfishButton>
<SunfishButton OnClick="@SetExplicitState" Icon="@SvgIcon.Gear" Class="mr-sm">Configure State</SunfishButton>

<SunfishTileLayout @ref="@TileLayoutInstance"
                   Columns="3"
                   Resizable="true"
                   Reorderable="true">
    <TileLayoutItems>
...
@code {
    SunfishTileLayout TileLayoutInstance { get; set; }
    TileLayoutState SavedState { get; set; }
    
    string stateStorageKey = "SunfishBlazorTileLayoutStateDocsKey";
...
* [Live Demo: TileLayout State](https://demos.sunfish.dev/blazor-ui/tilelayout/persist-state)
