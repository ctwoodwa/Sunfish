...
page_title: Sunfish UI for Blazor TileLayout Documentation | TileLayout Accessibility Overview
description: "Get started with the Sunfish UI for Blazor TileLayout and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
tags: sunfish,blazor,accessibility,wai-aria,wcag,tilelayout
...
The illustrative example below shows the tile resize action, achievable through the [DropDown Button](slug:dropdownbutton-overview). Sunfish UI for Blazor aims to offer a versatile API that allows users to trigger all functions programmatically or externally, meeting diverse accessibility requirements for any applications.
            ...
            <TileLayoutItem RowSpan="@item.RowSpan" ColSpan="@item.ColSpan">
                <HeaderTemplate>
                    <div class="header">
                        ...
                        <SunfishDropDownButton AriaLabel="Resize Options" ShowArrowButton="false" FillMode="@ThemeConstants.DropDownButton.FillMode.Clear" Icon="@SvgIcon.MoreVertical">
                            <DropDownButtonItems>
                                <DropDownButtonItem OnClick="@(() => HandleTileResize(item))" Icon="@SvgIcon.ImageResize">
                                    Resize tile
                                    <SunfishSvgIcon Icon="@SvgIcon.WindowRestore" Class="window-restore" />
                                </DropDownButtonItem>
                            </DropDownButtonItems>
...
<SunfishDialog @bind-Visible="@Visible"
    ...
    <DialogContent>
        ...
        <div class="example">
            <div class="column-wrapper">
                <SunfishDropDownList Data="@ColSpanOptions"
            ...
            <div class="row-wrapper">
                <SunfishDropDownList Data="@RowSpanOptions"
    ...
    <DialogButtons>
        ...
        <SunfishButton AriaLabel="Cancel Resize" OnClick="@(() => { Visible = false; })"><SunfishSvgIcon Icon="@SvgIcon.Cancel" /><span style="margin-left: 5px;">Cancel</span></SunfishButton>
    </DialogButtons>
</SunfishDialog>
...
## See also
 * [Live demo: TileLayout Resizing](https://demos.sunfish.dev/blazor-ui/tilelayout/resizing)