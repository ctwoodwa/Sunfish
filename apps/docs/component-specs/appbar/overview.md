...
tags: sunfish,blazor,appbar,navbar
published: True
position: 0
components: ["appbar"]
---
...
The <a href = "https://sunfish.dev/blazor-ui/appbar" target="_blank">Blazor AppBar component</a> helps you build navigation bars for your application seamlessly. This article explains how to start using the component and describes its features.

## Creating Blazor AppBar

1. Add the `<SunfishAppBar>` tag to a Razor file.
...
>caption Basic configuration of the Sunfish AppBar
...
The Blazor AppBar provides parameters to configure the component. Also check the [AppBar API Reference](slug:Sunfish.Blazor.Components.SunfishAppBar) for a full list of properties.
...
| `ThemeColor` | `Sunfish.Blazor.ThemeConstants.AppBar.ThemeColor` | Adjust the color of the AppBar |
...
````RAZOR
<SunfishButton OnClick="@RefreshAppBar">Refresh AppBar</SunfishButton>

<SunfishAppBar @ref="AppBarRef" />

@code {
	private SunfishAppBar AppBarRef { get; set; }
...
* [Live AppBar Demos](https://demos.sunfish.dev/blazor-ui/appbar/overview)
* [AppBar API Reference](slug:Sunfish.Blazor.Components.SunfishAppBar)
