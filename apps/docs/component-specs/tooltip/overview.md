...
tags: sunfish,blazor,tooltip,overview
published: True
position: 0
components: ["tooltip"]
---
...
The <a href="https://sunfish.dev/blazor-ui/tooltip" target="_blank">Blazor Tooltip component</a> enhances the default browser tooltips in a beautiful, cross-browser popup. The Tooltip component allows customization of its size, content, position and show event. Attach a single Tooltip instance to multiple targets to optimize the performance.
...
````RAZOR
<SunfishTooltip TargetSelector=".tooltip-target" />

<div style="padding: 5em;">
    Hover the button ...

    <SunfishButton Icon="@SvgIcon.Eye" Title="Hello world!" Class="tooltip-target" />

    ... and the question mark:

    <span title="I am a Sunfish Blazor Tooltip." class="tooltip-target">
        <SunfishSvgIcon Icon="@SvgIcon.QuestionCircle" />
    </span>
</div>
````
...
The Blazor Tooltip provides the following configuration parameters. Also check the [Tooltip component API](slug:Sunfish.Blazor.Components.SunfishTooltip).
...
* [Live Demo: Tooltip](https://demos.sunfish.dev/blazor-ui/tooltip/overview)
