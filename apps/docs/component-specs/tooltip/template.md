...
tags: sunfish,blazor,tooltip,template
published: true
position: 4
components: ["tooltip"]
---
...
<SunfishTooltip TargetSelector="p strong[title]">
    <Template>
        @{
...
<SunfishTooltip TargetSelector="p strong.target" Height="300px" Width="400px">
    <Template>
...
* [Live Demo: Tooltip Template](https://demos.sunfish.dev/blazor-ui/tooltip/template)
