...
slug: fab-positions
tags: sunfish,blazor,floating action button,position,align,alignment
published: True
position: 2
...
<div class="custom-container">
    <label>
        ...
        <br />
        <SunfishRadioGroup Data="@HorizontalAligns"
    ...
    <label>
        Vertical Alignment
        <br />
        <SunfishRadioGroup Data="@VerticalAligns"
                           @bind-Value="@VerticalAlign">
        </SunfishRadioGroup>
    </label>
</div>

<SunfishFloatingActionButton HorizontalAlign="@HorizontalAlign"
...
* [Positioning - Design System Docs](https://sunfish.dev/design-system/docs/components/floatingactionbutton/#positioning)