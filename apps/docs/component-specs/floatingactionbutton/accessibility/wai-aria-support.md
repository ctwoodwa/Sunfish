...
page_title: Sunfish UI for Blazor FloatingActionButton Documentation | FloatingActionButton Accessibility
description: "Get started with the Sunfish UI for Blazor FloatingActionButton and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Sunfish UI for Blazor FloatingActionButton provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
* [FloatingActionButton Overview](https://demos.sunfish.dev/blazor-ui/floatingactionbutton/overview)
