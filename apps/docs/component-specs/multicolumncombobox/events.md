...
tags: sunfish,blazor,multicolumncombobox,combobox,combo,events
published: true
position: 50
...
This article describes the events of the Sunfish MultiColumnComboBox for Blazor.
...
<SunfishMultiColumnComboBox TItem="@SuggestionsModel" TValue="int"
                            OnRead="@ReadItems"
...
<SunfishMultiColumnComboBox TItem="Car" TValue="int"
                            TextField="Model"
                            ValueField="Id"
                            GroupField="Make"
                            Filterable="true"
...
````RAZOR
<SunfishMultiColumnComboBox Data="@Items"
