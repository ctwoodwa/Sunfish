...
page_title: Sunfish UI for Blazor DropDownButton Documentation | DropDownButton Accessibility
description: "Get started with the Sunfish UI for Blazor DropDownButton and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Sunfish UI for Blazor DropDownButton provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the DropDownButton keyboard navigation works, refer to the [Blazor DropDownButton Accessibility and Keyboard Navigation Demo](https://demos.sunfish.dev/blazor-ui/dropdownbutton/keyboard-navigation).
