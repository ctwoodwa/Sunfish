...
tags: sunfish,blazor,dropdownbutton,appearance,styling
published: True
position: 10
...
````RAZOR
<SunfishDropDownButton FillMode="@ThemeConstants.DropDownButton.FillMode.Solid"
...
<SunfishDropDownButton FillMode="solid"
                       Rounded="lg"
                       Size="lg"
                       ThemeColor="primary">
    <DropDownButtonContent> Foo </DropDownButtonContent>
...
@foreach (var item in FillModes)
{
    ...
    <SunfishDropDownButton FillMode="@fillMode">
...
@foreach (var item in RoundedOptions)
{
    ...
    <SunfishDropDownButton Rounded="@rounded">
...
@foreach (var item in Sizes)
{
    ...
    <SunfishDropDownButton Size="@size">
...
@foreach (var item in ThemeColors)
{
    ...
    <SunfishDropDownButton ThemeColor="@themeColor">
...
* [Live Demo: DropDownButton Appearance](https://demos.sunfish.dev/blazor-ui/dropdownbutton/appearance)
