...
@code {
    private SunfishListBox<ListBoxModel> ListBoxRef { get; set; } = null!;
...
````RAZOR
<SunfishListBox Data="@ListBoxStrings"
...
The table below lists the ListBox parameters. For a full list of the ListBox API members (parameters, methods, and events), check the [ListBox API Reference](slug:Sunfish.Blazor.Components.SunfishListBox-1).
...
| `Size` | `string` <br /> (`"md"`) | This parameter controls ListBox styles such as paddings or font size. For easier usage, set the parameter to a member of the static class `Sunfish.Blazor.ThemeConstants.ListBox.Size`. |
...
<SunfishButton OnClick="@AddListBoxItem">Add ListBox Item</SunfishButton>
...
* [Live Demo: ListBox](https://demos.sunfish.dev/blazor-ui/listbox/overview)
* [ListBox API Reference](slug:Sunfish.Blazor.Components.SunfishListBox-1)
