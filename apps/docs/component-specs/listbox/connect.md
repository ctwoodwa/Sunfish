...
One of the main benefits of the Sunfish Blazor ListBox is the ability to move items from one component instance to another. This article explains how to link multiple ListBoxes to transfer items.
...
<SunfishListBox @ref="@ListBoxRef3"
                Data="@ListBoxData3"
                TextField="@nameof(ListBoxModel.Name)"
                Id="@ListBoxId3"
                SelectionMode="@ListBoxSelectionMode.Multiple"
...
<label><SunfishCheckBox @bind-Value="@SelectItemsInDestination" /> Select Moved Items in Destination ListBox</label>

@code {
    private SunfishListBox<ListBoxModel> ListBoxRef1 { get; set; } = null!;
    private SunfishListBox<ListBoxModel> ListBoxRef2 { get; set; } = null!;
    private SunfishListBox<ListBoxModel> ListBoxRef3 { get; set; } = null!;
