...
page_title: Sunfish UI for Blazor CheckBox Documentation | CheckBox Accessibility
description: "Get started with the Sunfish UI for Blazor CheckBox and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Sunfish UI for Blazor CheckBox provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
* [Blazor CheckBox Demos](https://demos.sunfish.dev/blazor-ui/checkbox/overview)
