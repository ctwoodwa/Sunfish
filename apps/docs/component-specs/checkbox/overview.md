...
tags: sunfish,blazor,checkbox,overview
published: True
position: 0
components: ["checkbox"]
---
...
>caption Basic setup of the Sunfish CheckBox using two-way data binding.
...
>tip To learn more about the appearance, anatomy, and accessibility of the CheckBox, visit the [Progress Design System Kit documentation](https://sunfish.dev/design-system/docs/components/checkbox/)—an information portal offering rich component usage guidelines, descriptions of the available style variables, and globalization support details.
...
<SunfishCheckBox Id="myCheckBox" @bind-Value="@hasAgreed" />
...
* [Live CheckBox Demos](https://demos.sunfish.dev/blazor-ui/checkbox/overview)
* [CheckBox API Reference](slug:Sunfish.Blazor.Components.SunfishCheckBox-1)
