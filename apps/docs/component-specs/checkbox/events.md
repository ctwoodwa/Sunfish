...
tags: sunfish,blazor,checkbox,events
published: true
position: 20
components: ["checkbox"]
---
...
This article showcases the available events in the Sunfish CheckBox component:
...
<div class="mt-2">
    ...
    <SunfishCheckBox @bind-Value="@CheckBoxValue" Id="theCb"
                     Indeterminate="@Indeterminate"
                     IndeterminateChanged="((bool val) => ChangeHandler(val))">
    </SunfishCheckBox>
</div>
<SunfishButton ThemeColor="primary" OnClick="@(() => Indeterminate = !Indeterminate)"> Toggle Indeterminate </SunfishButton>
...
<SunfishCheckBox @bind-Value="@TheValue"
