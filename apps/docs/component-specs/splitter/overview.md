...
tags: sunfish,blazor,splitter,overview
published: True
position: 0
components: ["splitter"]
---
...
>tip The following sample app shows how to create a 100%-high page layout with a Splitter that includes a header, footer, and sidebar: <a href="https://github.com/ctwoodwa/sunfish-archive/blazor-ui/tree/master/splitter/use-100-percent-viewport" target="_blank">How to make the Splitter take up 100% of the viewport</a>.
...
Check the [Splitter API Reference ](slug:Sunfish.Blazor.Components.SunfishSplitter) for a full list of properties, methods and events.
...
Add a reference to the component instance to use the [Splitter methods](slug:Sunfish.Blazor.Components.SunfishSplitter#methods).
...
````RAZOR
<SunfishButton OnClick="@GetSplitterState">Get Splitter State</SunfishButton>

<SunfishSplitter @ref="@SplitterRef"
                 Height="200px">
    <SplitterPanes>
        <SplitterPane>
...
@code {
    private SunfishSplitter? SplitterRef { get; set; }
...
* [Splitter API Reference](slug:Sunfish.Blazor.Components.SunfishSplitter)
* [SplitterPane API Reference](slug:Sunfish.Blazor.Components.SplitterPane)
