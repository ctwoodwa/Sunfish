...
slug: splitter-panes
tags: sunfish,blazor,splitter,panes
published: True
position: 3
...
````RAZOR
<SunfishSplitter Width="600px" Height="300px">
    <SplitterPanes>
...
<SunfishRadioGroup Data="@SplitterOrientations"
                   @bind-Value="@SplitterOrientation"
                   Layout="@RadioGroupLayout.Horizontal" />

<label><SunfishCheckBox @bind-Value="@ShouldSetSplitterHeight" /> Set Splitter Height <code>@SplitterHeight</code></label>
<br />
<label><SunfishCheckBox @bind-Value="@ShouldExpandPanesVertically" /> Expand Panes without Splitter Height</label>

<br />
<br />

<SunfishSplitter Height="@SplitterHeight"
    ...
    <SplitterPanes>
        <SplitterPane Collapsible="@FirstPaneCollapsible"
            ...
            <ul style="list-style-type: disc;">
                <li>
                    Size: <SunfishNumericTextBox Value="@FirstPaneSizeNumber"
                ...
                <li><label><SunfishCheckBox @bind-Value="@FirstPaneCollapsible" /> Collapsible</label></li>
                <li><label><SunfishCheckBox @bind-Value="@FirstPaneResizable" /> Resizable</label></li>
        ...
        <SplitterPane Collapsible="@MiddlePaneCollapsible"
            ...
            <ul style="list-style-type: disc;">
                ...
                <li><label><SunfishCheckBox @bind-Value="@MiddlePaneCollapsible" /> Collapsible</label></li>
                <li><label><SunfishCheckBox @bind-Value="@MiddlePaneResizable" /> Resizable</label></li>
        ...
        <SplitterPane Collapsible="@LastPaneCollapsible"
            ...
            <ul style="list-style-type: disc;">
                <li>
                    Size: <SunfishNumericTextBox Value="@LastPaneSizeNumber"
                ...
                <li><label><SunfishCheckBox @bind-Value="@LastPaneCollapsible" /> Collapsible</label></li>
                <li><label><SunfishCheckBox @bind-Value="@LastPaneResizable" /> Resizable</label></li>
