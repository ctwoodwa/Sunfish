...
tags: sunfish,blazor,fileselect,async,validate,validation
published: true
position: 10
...
* Client validation&mdash;performed by the Sunfish FileSelect component
* Server validation&mdash;must be implemented in the application backend or endpoints

## Parameters

The Sunfish [FileSelect component offers parameters](slug:Sunfish.Blazor.Components.SunfishFileSelect) to validate the file selection on the client:
...
>caption Sunfish FileSelect file validation
...
* [Live Demo: FileSelect Validation](https://demos.sunfish.dev/blazor-ui/fileselect/validation)
