...
tags: sunfish,blazor,drawer,data,binding
published: True
position: 2
components: ["drawer"]
---
...
The properties of a drawer item match directly to a field of the model the drawer is bound to. You provide that relationship by providing the name of the field from which the corresponding information is present. To do this, use the properties in the main `SunfishDrawer` tag:
...
>caption Default field names for drawer item bindings. If you use these, you don't have to specify them in the `SunfishDrawer` tag explicitly.
...
https://docs.sunfish.dev/blazor-ui/components/drawer/navigation
*@

<SunfishDrawer Data="@Data" UrlField="ItemUrl" TextField="ItemText" IconField="ItemIcon"
