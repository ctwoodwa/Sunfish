...
slug: drawer-icons
tags: sunfish,blazor,drawer,icon,iconclass,image
published: True
position: 22
components: ["drawer"]
---
...
You can add [Sunfish Font or SVG icons](slug:common-features-icons) to the Drawer items. The component also supports custom icons.
...
>caption How to use icons in the Sunfish Drawer
...
<style>
    ...
    .my-image {
        ...
        background-image: url('https://demos.sunfish.dev/kendo-ui/content/shared/icons/16/star.png'); 
        flex-shrink: 0;
    }
</style>

<!-- Load this stylesheet only if using Sunfish font icons -->
<link href="https://blazor.cdn.sunfish.dev/blazor/6.0.2/kendo-font-icons/font-icons.css" rel="stylesheet" type="text/css" />
