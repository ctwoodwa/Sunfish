...
tags: sunfish,blazor,drawer,mode,mini
published: True
position: 7
components: ["drawer"]
---
...
<SunfishButton OnClick="@(() => MiniMode = !MiniMode)">Toggle MiniMode</SunfishButton>
...
* [Drawer Mini View Demo](https://demos.sunfish.dev/blazor-ui/drawer/mini)
