...
slug: switch-events
tags: sunfish,blazor,switch,events
published: true
position: 20
components: ["switch"]
---
...
This article showcases the available events in the Sunfish Switch component:
...
<SunfishSwitch Value="@toggleSwitch" 
...
<SunfishSwitch @bind-Value="@toggleSwitch"
...
<SunfishSwitch @bind-Value="@TheValue"
