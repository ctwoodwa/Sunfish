...
description: Learn how to apply styles to the Blazor Button component by Sunfish UI.
slug: button-styling
tags: sunfish,blazor,button,styling,
published: True
position: 10
components: ["button"]
---
...
````RAZOR
<SunfishButton Class="my-button">Large button with red text</SunfishButton>
