...
slug: button-type
tags: sunfish,blazor,button,type
published: True
position: 3
components: ["button"]
---
...
````RAZOR
<SunfishButton>Implicit SUBMIT</SunfishButton>
<SunfishButton ButtonType="@ButtonType.Submit">Explicit SUBMIT</SunfishButton>
<SunfishButton ButtonType="@ButtonType.Button">BUTTON</SunfishButton>
<SunfishButton ButtonType="@ButtonType.Reset">RESET</SunfishButton>
````
