...
tags: sunfish,blazor,button,overview
published: True
position: 0
components: ["button"]
---
...
This article introduces the <a href="https://sunfish.dev/blazor-ui/buttons" target="_blank">Blazor Button component</a>, shows how to start using it, and lists its core features.
...
1. Use the `<SunfishButton>` tag to add the component to your razor page.
...
>tip To learn more about the appearance, anatomy, and accessibility of the Button, visit the [Progress Design System Kit documentation](https://sunfish.dev/design-system/docs/components/button/)—an information portal offering rich component usage guidelines, descriptions of the available style variables, and globalization support details.

## Button Parameters

The Blazor Button provides various parameters that allow you to configure the component. Also check the [Button's public API](slug:Sunfish.Blazor.Components.SunfishButton).
...
| `Icon` | `object` | The [icon rendered in the Button](slug:button-icons). Can be set to a predefined Sunfish icon or a custom one. | 
...
Add a reference to the component instance to use the [Button methods](slug:Sunfish.Blazor.Components.SunfishButton). Be aware of the Blazor life cycle if you want to [focus the component on page load](slug:inputs-kb-focus#focus-on-page-load).

| Method | Description |
| --- | --- |

````RAZOR.skip-repl
<SunfishButton @ref="ButtonRef">Hello!</SunfishButton>
...
* [Live Demo: Button](https://demos.sunfish.dev/blazor-ui/button/overview)
* [Events](slug:button-events)
* [Type](slug:button-type)
* [Button API Reference](slug:Sunfish.Blazor.Components.SunfishButton)
