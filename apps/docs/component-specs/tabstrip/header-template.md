...
tags: sunfish,blazor, tabstrip, header, template
published: True
position: 15
components: ["tabstrip"]
---
...
>caption The following example showcases the use of a `<HeaderTemplate>`, including `SunfishIcons`
...
* [Live Demo: TabStrip Header Template](https://demos.sunfish.dev/blazor-ui/tabstrip/header-template)
