...
tags: sunfish,blazor,tab,strip,tabstrip,alignment
published: True
position: 11
components: ["tabstrip"]
---
...
You can customize their alignment through the `TabAlignment` parameter. It takes a member of the `Sunfish.Blazor.TabStripTabAlignment` enumeration:
...
````RAZOR
<SunfishTabStrip TabAlignment="@TabStripTabAlignment.End">
