...
tags: sunfish,blazor,loader,container,loadercontainer,appearance
published: True
position: 5
...
You can see the appearance settings in action in the [LoaderContainer Appearance live demo](https://demos.sunfish.dev/blazor-ui/loadercontainer/appearance).
...
<div class="row">
    <div class="col-4" style="position: relative; height: 200px">
        <SunfishLoaderContainer OverlayThemeColor="dark"></SunfishLoaderContainer>
    ...
    <div class="col-4" style="position: relative; height: 200px">
        <SunfishLoaderContainer OverlayThemeColor="light"></SunfishLoaderContainer>
...
<div class="row">
    <div class="col-4" style="position: relative; height: 200px">
        <SunfishLoaderContainer LoaderPosition="@LoaderPosition.Top"></SunfishLoaderContainer>
    </div>
    <div class="col-4" style="position: relative; height: 200px">
        <SunfishLoaderContainer LoaderPosition="@LoaderPosition.Start"></SunfishLoaderContainer>
    </div>
    <div class="col-4" style="position: relative; height: 200px"> 
        <SunfishLoaderContainer LoaderPosition="@LoaderPosition.End"></SunfishLoaderContainer>
    </div>
</div>
````
...
>caption Setting SunfishLoaderContainer LoaderType

````RAZOR
<SunfishLoaderContainer LoaderType="@LoaderType.InfiniteSpinner" />
````
...
>caption Setting SunfishLoaderContainer Size

````RAZOR
<SunfishLoaderContainer Size="@ThemeConstants.Loader.Size.Large" />
````
...
>caption Setting SunfishLoaderContainer ThemeColor

````RAZOR
<SunfishLoaderContainer ThemeColor="@ThemeConstants.Loader.ThemeColor.Info" />
````
...
````RAZOR
<SunfishLoaderContainer Class="custom-loading-colors" />
...
* [Live Demo: LoaderContainer Appearance](https://demos.sunfish.dev/blazor-ui/loadercontainer/appearance)
