...
tags: sunfish,blazor,autocomplete,data,bind,binding,databind
published: True
position: 5
...
<br />
<SunfishAutoComplete Data="@Suggestions" @bind-Value="@FirstValue" />

<br />
User input 2: @SecondValue
<br />
<SunfishAutoComplete Data="@ArraySuggestions" @bind-Value="@SecondValue" />
