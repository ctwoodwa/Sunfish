...
tags: sunfish,blazor,flatcolorpicker,overview
published: True
position: 0
...
To use a Sunfish FlatColorPicker for Blazor:

1. Add the `SunfishFlatColorPicker` tag.
...
* [FlatColorPicker Live Demo](https://demos.sunfish.dev/blazor-ui/flatcolorpicker/overview)
