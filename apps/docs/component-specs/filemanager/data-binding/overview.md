...
tags: sunfish,blazor,treeview,data,bind,databind,databinding,basics
published: True
position: 0
...
All [FileManager item features](#filemanager-item-features) map to model properties. You define that relationship by providing the property name from which the corresponding information is taken. To do this, use the following parameters of the main `SunfishFileManager` tag:
...
* [Live Demo: FileManager Flat Data](https://demos.sunfish.dev/blazor-ui/filemanager/flat-data)
* [Live Demo: FileManager Hierarchical Data](https://demos.sunfish.dev/blazor-ui/filemanager/hierarchical-data)
