...
tags: sunfish,blazor,progress,bar,progressbar,indeterminate,state
published: True
position: 10
...
>caption Sunfish ProgressBar in Indeterminate state
...
````RAZOR
<div>
    <SunfishButton ThemeColor="primary" OnClick="(_ => isIndeterminate = true)">Put the ProgressBar in Indeterminate State</SunfishButton>
</div>

<br />

<SunfishProgressBar Indeterminate="@isIndeterminate" Value="10" Max="100" />
...
## See Also
  ...
  * [Live Demo: ProgressBar Overview](https://demos.sunfish.dev/blazor-ui/loader/overview)
