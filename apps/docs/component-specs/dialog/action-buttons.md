...
tags: sunfish,blazor,dialog,action,buttons
published: True
position: 7
components: ["dialog"]
---
...
````RAZOR
<SunfishDialog @ref="@DialogRef"
               @bind-Visible="@DialogVisible"
               Title="Select Buttons Layout"
               ButtonsLayout="@SelectedButtonLayout">
    <DialogContent>
        <SunfishRadioGroup Data="@ButtonLayouts"
                           @bind-Value="@SelectedButtonLayout"
                           OnChange="@OnRadioChange">
        </SunfishRadioGroup>
    </DialogContent>
    <DialogButtons>
        <SunfishButton>Cancel</SunfishButton>
        <SunfishButton ThemeColor="primary">OK</SunfishButton>
    </DialogButtons>
</SunfishDialog>
