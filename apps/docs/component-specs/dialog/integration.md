...
tags: sunfish,blazor,dialog,integration
published: True
position: 9
components: ["dialog"]
---
...
1. Include the [Sunfish CheckBox](slug:checkbox-overview) as `DialogContent`.
...
<SunfishDialog @ref="DialogRef" Visible="true">
    <DialogContent>
        <SunfishCheckBox Id="MyCheckBox" @bind-Value="@IsSelected" OnChange="@OnCheckBoxValueChanged" />
...
@code {
    ...
    private SunfishDialog DialogRef { get; set; }
...
1. Include the [Sunfish Filter](slug:filter-overview) inside `<DialogContent>`.
...
<SunfishDialog @ref="DialogRef" Visible="true" Width="66vw" Height="66vh">
    <DialogContent>
