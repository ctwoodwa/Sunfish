...
tags: sunfish,blazor,treeview,observable,data,new,collection
published: True
position: 17
components: ["treeview"]
---
...
<SunfishButton OnClick="@ChangeItems">Change items data</SunfishButton>

<SunfishTreeView Data="@Items">
    <TreeViewBindings>
