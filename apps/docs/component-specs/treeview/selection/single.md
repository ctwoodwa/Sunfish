...
tags: sunfish,blazor,treeview,selection,single
published: True
position: 5
components: ["treeview"]
---
...
To use **single** node selection, set the `SelectionMode` parameter to `Sunfish.Blazor.TreeViewSelectionMode.Single`.
...
@if (SelectedItems.Any())
{
    ...
    <div>
        ...
        <div class="card" style="width: 15rem">
            <span><strong>Icon:</strong> <SunfishSvgIcon Icon="@selectedItem.Icon" /></span>
