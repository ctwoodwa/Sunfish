...
#advanced-example-toolbar
    <GridToolBarTemplate>
        ...
        <label class="k-checkbox-label"><SunfishCheckBox @bind-Value="@ShouldCancelOnAddEdit" /> Cancel OnAdd and OnEdit Events</label>
        <span class="k-separator"></span>
        <label class="k-checkbox-label"><SunfishCheckBox @bind-Value="@GridConfirmDelete" /> Confirm Delete Commands</label>
        <span class="k-separator"></span>
        <label class="k-checkbox-label"><SunfishCheckBox @bind-Value="@ShouldConfirmOnCancel" /> Confirm Cancel Commands</label>
    </GridToolBarTemplate>
#end
...
#advanced-example-code
    ...
    [CascadingParameter]
    public DialogFactory? SunfishDialogs { get; set; }
    ...
    {
        if (ShouldConfirmOnCancel && SunfishDialogs != null)
        {
            bool shouldContinue = await SunfishDialogs.ConfirmAsync("Do you want to discard your changes?");
