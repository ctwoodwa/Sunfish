...
The `FormatPlaceholder` parameter allows you to set custom strings as placeholders for each DateTime segment and is available for the following Sunfish UI for Blazor components:
...
<SunfishDatePicker @bind-Value="@DateValue">
