...
#edit-debouncedelay
Consider setting `DebounceDelay="0"` to the component inside the editor template. This is how the default editors in all Sunfish Blazor components work. Otherwise, fast users may try to save changes before the data item in edit mode receives the new value.
#end
...
<SunfishFloatingLabel Class="custom-label-class" Text="Enter email">
    <SunfishTextBox @bind-Value="@TextValue"
                    Width="300px">
        <TextBoxPrefixTemplate>
            <SunfishSvgIcon Icon="@SvgIcon.Envelop" />
        </TextBoxPrefixTemplate>
    </SunfishTextBox>
