#appearance-themebuilder

## ThemeBuilder

To take full control over the appearance of the Sunfish UI for Blazor components, you can create your own styles by using [ThemeBuilder](https://docs.sunfish.dev/themebuilder).
