...
`Sunfish.Blocks.FinancialLedger` is a framework-agnostic, adapter-free accounting domain block.
...
- Package: `Sunfish.Blocks.FinancialLedger`
- Source: `packages/blocks-financial-ledger/`
- Namespace roots: `Sunfish.Blocks.FinancialLedger.Models`, `Sunfish.Blocks.FinancialLedger.Services`,
  `Sunfish.Blocks.FinancialLedger.DependencyInjection`

## When to use it

Use `Sunfish.Blocks.FinancialLedger` when your application needs:
