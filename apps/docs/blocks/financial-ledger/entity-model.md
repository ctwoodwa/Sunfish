...
description: Chart of accounts, journal entries with double-entry invariants, and depreciation schedule records exposed by Sunfish.Blocks.FinancialLedger.
keywords:
  - sunfish
  - accounting
  - gl-account
