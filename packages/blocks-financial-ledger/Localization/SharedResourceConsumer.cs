...
namespace Sunfish.Blocks.FinancialLedger.Localization;

/// <summary>
/// Bundle reference holder that closes the SUNFISH_I18N_002 (LocUnused) loop for
/// the blocks-financial-ledger <c>SharedResource</c> bundle by enumerating every key in
...
/// <c>Sunfish.Blocks.FinancialLedger.csproj</c> can be removed without scaffolding a
