 ...
 *
 * @param {HTMLElement} rootElement - the grid's outer container
 ...
 */
export function attachGrid(rootElement, dotnetRef, options) {
    const handle = {
        rootElement,
        dotnetRef,
        options: options ?? {},
...
/**
 * Set a column's width by CSS var, without triggering a re-render.
 ...
 */
export function setColumnWidth(rootElement, columnId, widthCss) {
