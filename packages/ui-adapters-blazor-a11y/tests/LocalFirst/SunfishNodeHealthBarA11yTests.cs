...
public class SunfishNodeHealthBarA11yTests : IClassFixture<SunfishNodeHealthBarA11yTests.Ctx>
{
    private readonly Ctx _ctx;

    public SunfishNodeHealthBarA11yTests(Ctx ctx) => _ctx = ctx;

    [Fact]
    public async Task SunfishNodeHealthBar_AllHealthy_HasNoModeratePlusAxeViolations()
    {
        ...
        try
        {
            ...
            Assert.True(moderatePlus.Count == 0,
                $"SunfishNodeHealthBar surfaced {moderatePlus.Count} moderate+ axe violation(s): " +
