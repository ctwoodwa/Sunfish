...
/// <c>SUNFISH_SHIPSOFFICE_PERM001</c> shipping with W#55 Phase 2.
/// </para>
/// <para>
...
public interface IShipsOfficeDataProvider
{
    ...
    /// tenant. Pre-condition: caller has verified
    /// <see cref="ShipAction.ViewShipsOffice"/>. Implementations may
    /// fall back to polling at <c>ShipsOfficeOptions.FallbackPollingInterval</c>
