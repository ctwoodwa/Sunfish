 ...
 *
 * Forward-compat: C# substrate carries `[JsonExtensionData] UnknownFields`.
 * TypeScript interface declarations permit unknown additional properties via
 * structural typing — no extra machinery required.
 *
 * See ADR 0063-A1.1 (Accepted) for the full substrate spec.
 */
