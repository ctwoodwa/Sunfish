...
/// implementations per W#55 Phase 2b. Per cohort
...
{
    /// <summary>
    /// Registers the Phase 2b implementations:
    /// <list type="bullet">
    ...
    /// </summary>
    /// <remarks>
    /// Phase 2c adds <c>ShipsOfficeCommandService</c>; Phase 2d adds
    /// <c>IDocumentDiffService</c> stub + the <c>SUNFISH_SHIPSOFFICE_PERM001</c>
    /// Roslyn analyzer. Both ship in separate PRs per the XO ruling.
    /// </remarks>
