...
<SunfishButton OnClick="@SetTreeListSort">Set sorted state</SunfishButton>
...
@code {
    public SunfishTreeList<Employee> TreeListRef { get; set; } = new SunfishTreeList<Employee>();
...
<SunfishButton OnClick="@SetTreeListFilter">Filter From Code</SunfishButton>
...
@code {
    private SunfishTreeList<Employee> TreeListRef { get; set; } = new SunfishTreeList<Employee>();
...
<SunfishButton OnClick="@SetTreeListFilter">Set filtered state</SunfishButton>
...
@code {
    private SunfishTreeList<SampleModel>? TreeListRef { get; set; }
...
<div>
    <span>
        <label for="sunfishNumericTextbox">Select the index a root level item</label>
        <SunfishNumericTextBox Min="0" 
                               Max="@Data.Count" 
                               @bind-Value="@ExpandedItemIndex" 
                               Id="sunfishNumericTextbox"/>
    </span>
    <span>
        <SunfishButton OnClick="@SetTreeListExpandedItems">Expand the selected root level item</SunfishButton>
    </span>
</div>
...
<SunfishButton OnClick="@GetColumnsFromState">Get the state of the Columns</SunfishButton>
...
<SunfishButton OnClick="@ReorderTreeListColumns">Reoder Email and HireDate Columns</SunfishButton>
