...
tags: sunfish,blazor,treelist,selection,cells
position: 5
components: ["treelist"]
---
# Cell Selection
...
| --- | --- | --- |
| `ColumnField` | `string` | The value of the TreeList column [`Field` parameter](slug:sunfish.blazor.components.common.boundcolumnbase#Sunfish_Blazor_Components_Common_BoundColumnBase_Field), if set. |
| `ColumnId` | `string` | The value of the TreeList column [`Id` parameter](slug:Sunfish.Blazor.Components.Common.ColumnBase#Sunfish_Blazor_Components_Common_ColumnBase_Id), if set. |
...
* [Live Demo: TreeList Cell Selection](https://demos.sunfish.dev/blazor-ui/treelist/cell-selection)
