...
tags: sunfish,blazor,tile,layout,dashboard,reorder
published: True
position: 20
...
To enable reordering, set the `Reorderable` parameter of the main `SunfishTileLayout` tag to `true`.
...
* [Live Demo: TileLayout Reordering](https://demos.sunfish.dev/blazor-ui/tilelayout/reordering)
