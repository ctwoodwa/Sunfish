...
tags: sunfish,blazor,circular,gauge,scale
published: True
position: 5
...
The scale of the Circular Gauge renders the values, pointers and labels. You can customize it by adding an instance of the `<CircularGaugeScale>` to the `<CircularGaugeScales>` collection, child tag of the `<SunfishCircularGauge>`.
...
* [Live Demo: Circular Gauge - Scale Options](https://demos.sunfish.dev/blazor-ui/circulargauge/scale-options)
