...
tags: sunfish,blazor,chart,rangebar
published: True
position: 0
components: ["charts"]
---
...
5. (optional) Set `Visible="true"` or define [label `Template`](slug:components/chart/label-template-format) for `<ChartSeriesLabelsFrom>` or `<ChartSeriesLabelsTo>`. These are nested tags inside `<ChartSeriesLabels>` of the respective `<SunfishChartSeries>`.
...
<SunfishChart>
    ...
    <ChartSeriesItems>
        <SunfishChartSeries Type="ChartSeriesType.RangeBar" Data="@SleepData">
            <ChartSeriesLabels>
...
<SunfishChart>
    ...
    <ChartSeriesItems>
        <SunfishChartSeries Type="ChartSeriesType.RangeBar"
                     Data="@SleepData"
...
* [Live Demo: Range Bar Chart](https://demos.sunfish.dev/blazor-ui/chart/range-bar-chart)
