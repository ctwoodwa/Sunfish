...
tags: sunfish,blazor,chart,tooltip,shared,tooltips
published: True
position: 2
components: ["charts"]
---
# Shared Tooltip for Sunfish Blazor Chart

The Sunfish Chart allows you to show a unified tooltip for all categories in [Categorical](slug:components/chart/databind#series-types) Charts.
...
1. Inside the `<SunfishChart>` tag, add the `<ChartTooltip>` tag.
