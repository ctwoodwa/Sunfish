...
tags: sunfish,blazor,checkbox,state,indeterminate
published: true
position: 2
components: ["checkbox"]
---
...
In addition to `checked` and `unchecked` basic states, the Sunfish CheckBox has a third state - `Indeterminate`. This means that its state is something in between - neither checked, nor unchecked.
...
<SunfishButton ThemeColor="primary" OnClick="@( _ => TheValue = null )">Make indeterminate</SunfishButton>
<br />

<SunfishCheckBox Id="DemoCheckbox" @bind-Value="@TheValue" Indeterminate="@( !TheValue.HasValue )" />
...
<div>
    <SunfishCheckBox Id="selectAllCheckbox"
                     Value="SelectAll"
                     ValueChanged="((bool newVal) => ChangeAllHander(newVal))"
                     Indeterminate="SelectAllIndeterminate"></SunfishCheckBox>
...
@foreach (var delivery in Deliveries)
{
    <div class="ml-2">
        <label class="text-muted">
            <SunfishCheckBox Value="delivery.IsDelivered"
