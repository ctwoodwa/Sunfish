...
tags: sunfish,blazor,mediaquery,events
published: True
position: 30
...
The SunfishMediaQuery component for Blazor exposes events that allow you to respond to user actions and provide custom logic.
...
<SunfishMediaQuery Media="@MediaQuery" OnChange="@OnChange"></SunfishMediaQuery>
