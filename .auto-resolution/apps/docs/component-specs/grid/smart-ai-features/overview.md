...
The following types and Grid methods are relevant to scenarios when you want to integrate AI functionality with the Sunfish Grid.

See [Integration with Sunfish.AI.SmartComponents.Extensions](slug:common-features-sunfish-ai-smartcomponents-extensions-integration) for more information on how you can implement your server-side AI service to be compatible with the Sunfish Grid.
...
The semantic search functionality available through the `GridToolBarSmartBoxTool` is not a built-in feature. Sunfish UI for Blazor provides only the user interface and event handlers. You must implement the actual semantic search logic by integrating with an AI service of your choice. This approach gives you flexibility in choosing your AI provider and customizing the search logic to fit your data model.
...
The following online demos show complete implementations of the Grid AI smart functionality. These examples use a Sunfish-hosted AI service for demonstration purposes only. See [Integration with Sunfish.AI.SmartComponents.Extensions](slug:common-features-sunfish-ai-smartcomponents-extensions-integration) for more information on how you can implement your own server-side AI service to be compatible with the Sunfish Grid.

* [Grid AI Toolbar Assistant](https://demos.sunfish.dev/blazor-ui/grid/ai-toolbar-assistant)
* [Grid AI Data Highlight](https://demos.sunfish.dev/blazor-ui/grid/ai-highlight)
...
* [Live Demo: Grid AI Toolbar Assistant](https://demos.sunfish.dev/blazor-ui/grid/ai-toolbar-assistant)
* [Live Demo: Grid AI Data Highlight](https://demos.sunfish.dev/blazor-ui/grid/ai-highlight)
* [Grid API](slug:Sunfish.Components.DataGrid.SunfishDataGrid-1)
* [Integration with Sunfish.AI.SmartComponents.Extensions](slug:common-features-sunfish-ai-smartcomponents-extensions-integration)
