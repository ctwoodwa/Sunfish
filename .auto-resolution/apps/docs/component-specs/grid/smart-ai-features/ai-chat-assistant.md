...
description: Learn how to implement an AI Chat Assistant for the Sunfish UI for Blazor Grid that enables natural language interactions to perform data operations through conversational commands.
slug: grid-ai-chat-assistant
tags: sunfish,blazor,grid,ai,chat,assistant,conversational
published: True
position: 18
...
>tip The example in this article uses a Sunfish-hosted AI service for demonstration purposes only. For production applications, you should [implement your own AI service](slug:grid-ai-service-setup) that understands your specific domain, data, and business requirements.
...
2. Set Up the Chat Component
    ...
    @code {
        private SunfishChat<Message> ChatRef { get; set; }
            ...
            <SunfishDataGrid @ref="@GridRef" ...>
                <GridToolBar>
                    <GridToolBarCustomTool>
                        <SunfishToggleButton OnClick="@ToggleChat"
...
View the [complete live demo](https://demos.sunfish.dev/blazor-ui/grid/ai-chat-assistant).
