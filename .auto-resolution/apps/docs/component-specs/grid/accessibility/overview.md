...
page_title: Sunfish UI for Blazor Grid Documentation | Grid Accessibility Overview
description: "Get started with the Sunfish UI for Blazor Grid and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
tags: sunfish,blazor,accessibility,wai-aria,wcag,grid
...
<SunfishDialog @bind-Visible="@Visible"
    ...
    <DialogContent>
        ...
        <SunfishRadioGroup Data="@RadioOptions"
            ...
            <ItemTemplate>
                ...
                {
                    <span>@item.Text</span>
                    <SunfishDropDownList Width="190px"
                                         Data="@ColumnsList"
                ...
                {
                    <span>@item.Text</span>
                    <SunfishNumericTextBox @bind-Value="@DestinationIndex" 
                                           Width="40%" 
    ...
    <DialogButtons>
        <SunfishButton AriaLabel="Confirm Reorder" OnClick="@OnApplyClick" ThemeColor="@ThemeConstants.Button.ThemeColor.Primary"><SunfishSvgIcon Icon="@SvgIcon.Check" /><span style="margin-left: 5px;">Reorder</span></SunfishButton>
        <SunfishButton AriaLabel="Cancel Reorder" OnClick="@(() => { Visible = false; })"><SunfishSvgIcon Icon="@SvgIcon.CancelOutline" /><span style="margin-left: 5px;">Cancel</span></SunfishButton>
    </DialogButtons>
</SunfishDialog>
...
<SunfishDataGrid @ref="@GridRef"
    ...
    <GridToolBarTemplate>
        ...
        <SunfishGridColumn Field=@nameof(SampleData.ID) Editable="false" />
...
## See also
 * [Live demo: Grid Accessibility](https://demos.sunfish.dev/blazor-ui/grid/keyboard-navigation)
