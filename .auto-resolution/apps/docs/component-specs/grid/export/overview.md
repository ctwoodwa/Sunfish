...
tags: sunfish, blazor, grid, export
published: True
position: 1
components: ["grid"]
---
...
* The Grid exports only `<SunfishGridColumn>` instances. Other types of columns are not exported (for example: command, checkbox, hierarchy, group and row-drag columns).
