...
description: Use custom no data templates in the Sunfish Grid for Blazor when the component has no items to display.
slug: grid-templates-no-data
tags: sunfish, blazor, grid, templates
published: True
position: 38
components: ["grid"]
---
...
* [Live Demo: Grid - No Data Template](https://demos.sunfish.dev/blazor-ui/grid/no-data-template)
