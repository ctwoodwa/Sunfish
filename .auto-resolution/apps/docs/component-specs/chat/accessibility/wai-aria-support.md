...
position: 10
description: Learn about WAI-ARIA accessibility support in the Sunfish UI for Blazor Chat component, including ARIA roles, attributes, and screen reader compatibility.
tags: sunfish,blazor,chat,accessibility,wai-aria
published: True
---

# WAI-ARIA Support in Sunfish UI for Blazor Chat

@[template](/_contentTemplates/common/parameters-table-styles.md#table-layout)

Out of the box, the Sunfish UI for Blazor Chat provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
* [Blazor Chat Demos](https://demos.sunfish.dev/blazor-ui/chat/overview)
