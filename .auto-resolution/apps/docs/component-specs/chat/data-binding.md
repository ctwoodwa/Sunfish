...
description: Learn how to bind data to the Sunfish UI for Blazor Chat component, including message models and dynamic updates.
slug: chat-data-binding
tags: sunfish,blazor,chat,data-binding,messages
published: True
position: 2
components: ["chat"]
---
...
The Sunfish UI for Blazor Chat component supports data binding to collections of messages and provides flexible field mapping to accommodate different data models.
...
````RAZOR.skip-repl
<SunfishChat AuthorIdField="@nameof(Message.UserId)"
...
<SunfishButton ThemeColor="@ThemeConstants.Button.ThemeColor.Primary"
               OnClick="@OnAddSystemMessageClick">Add System Message</SunfishButton>
<SunfishButton ThemeColor="@ThemeConstants.Button.ThemeColor.Primary"
               OnClick="@OnClearMessagesClick">Clear All Messages</SunfishButton>
