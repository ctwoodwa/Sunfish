...
tags: sunfish,blazor,panelbar,data,bind,databind,databinding,basics
published: True
position: 0
components: ["panelbar"]
---
...
* `Icon` - The [Sunfish Font or SVG icon](slug:common-features-icons) that will be rendered in the item. Read more in the [Icons article](slug:panelbar-icons).
...
* Add one `SunfishPanelBarBinding` without a level to set the default bindings.
* Add `SunfishPanelBarBinding` for each level where you explicitly set the field bindings to your custom fields.
...
## See Also
  ...
  * [Live Demo: PanelBar Flat Data](https://demos.sunfish.dev/blazor-ui/panelbar/flat-data)
  * [Live Demo: PanelBar Hierarchical Data](https://demos.sunfish.dev/blazor-ui/panelbar/hierarchical-data)
