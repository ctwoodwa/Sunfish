...
tags: sunfish,blazor,aiprompt,ai,prompt,toolbar
published: True
position: 20
components: ["aiprompt"]
---
...
You can add multiple buttons to the Sunfish AIPrompt. To do that you should add the `<AIPromptToolBarButton>` to the `<AIPromptToolBar>`.
...
<SunfishAIPrompt OnPromptRequest="@HandlePromptRequest">
    <AIPromptToolBar>
        ...
        <AIPromptToolBarTemplateItem>
            <SunfishSplitButton OnClick="@OnSplitButtonClick">
...
* [Live Demo: AIPrompt Overview](https://demos.sunfish.dev/blazor-ui/aiprompt/overview)