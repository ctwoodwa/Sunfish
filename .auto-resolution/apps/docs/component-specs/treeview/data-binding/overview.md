...
| `Icon` | Defines a [Sunfish Font and Svg icon](slug:common-features-icons) |
...
* [Live Demo: Multiple Level Bindings](https://demos.sunfish.dev/blazor-ui/treeview/bindings)
