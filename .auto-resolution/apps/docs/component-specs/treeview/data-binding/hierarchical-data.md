...
tags: sunfish,blazor,treeview,data,bind,databind,databinding,hierarchical
published: True
position: 2
components: ["treeview"]
---
...
<SunfishTreeView Data="@HierarchicalData" @bind-ExpandedItems="@ExpandedItems">
    <TreeViewBindings>
...
## See Also
  ...
  * [Live Demo: TreeView Hierarchical Data](https://demos.sunfish.dev/blazor-ui/treeview/hierarchical-data)
