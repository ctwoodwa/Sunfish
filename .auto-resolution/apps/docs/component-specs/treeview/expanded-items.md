...
description: Expand Items in the Sunfish TreeView.
slug: treeview-expand-items
tags: sunfish,blazor,treeview,expand,items
published: True
position: 4
components: ["treeview"]
---
...
<p>
    <label>Item Id: <SunfishNumericTextBox @bind-Value="@ItemToExpand" Width="80px" /></label>
    <SunfishButton OnClick="@ExpandItem">Expand Item @ItemToExpand</SunfishButton>
</p>
<p>
    <SunfishButton OnClick="@ExpandRoot">Expand Root Items</SunfishButton>
    <SunfishButton OnClick="@ExpandAll">Expand All</SunfishButton>
    <SunfishButton OnClick="@CollapseAll">Collapse All</SunfishButton>
</p>
