...
tags: sunfish,blazor,button,radio,radiobutton,appearance
published: True
position: 35
...
Change the size of the radio buttons by setting the `Size` parameter to a member of the `Sunfish.Blazor.ThemeConstants.Button.Size` class:
