...
tags: sunfish,blazor,multiselect,templates
published: True
position: 20
...
<SunfishMultiSelect Data="@MultiSelectData"
    ...
    <TagTemplate>
        <SunfishSvgIcon Icon="@context.Icon"></SunfishSvgIcon>
        @context.Title
    </TagTemplate>
    <SummaryTagTemplate>
...
## See Also
  ...
  * [Live Demo: MultiSelect Templates](https://demos.sunfish.dev/blazor-ui/multiselect/templates)
