...
tags: sunfish,blazor,dockmanager,overview
published: True
position: 0
...
1. Add the `SunfishDockManager` tag.
...
>caption Sunfish Blazor DockManager

````RAZOR
<SunfishDockManager Height="90vh">
    <DockManagerPanes>
...
The following table lists the Dock Manager parameters. Also check the [DockManager API Reference](slug:Sunfish.Blazor.Components.SunfishDockManager) for a full list of all properties, methods and events.

@[template](/_contentTemplates/common/parameters-table-styles.md#table-layout)

| Parameter | Type and Default&nbsp;Value | Description |
| --- | --- | --- |
| ChildContent | RenderFragment | Child content containing SunfishDockPane declarations. |
...
| Method | Description |
| --- | --- |
| `GetState` | Returns the current state of the Dock Manager as a [`DockManagerState` object](slug:Sunfish.Blazor.Components.DockManagerState). |
...
<SunfishButton OnClick="@GetDockManagerState">Get DockManager State</SunfishButton>
...
* [DockManager API](slug:Sunfish.Blazor.Components.SunfishDockManager)
* [Live Demo: DockManager](https://demos.sunfish.dev/blazor-ui/dockmanager/overview)
