...
tags: sunfish,blazor,promptbox,modes,singleline,multiline,auto
published: True
position: 15
...
<div class="d-flex flex-column gap-4">
    <div>
        ...
        <SunfishPromptBox @bind-Value="@SingleLinePrompt"
    ...
    <div>
        ...
        <SunfishPromptBox @bind-Value="@MultiLinePrompt"
    ...
    <div>
        <h4>Auto Mode</h4>
        <SunfishPromptBox @bind-Value="@AutoPrompt"
