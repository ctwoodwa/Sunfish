...
tags: sunfish,blazor,Color,Palette,events
published: true
position: 50
...
This article explains the events available in the Sunfish Color Palette for Blazor:
...
<SunfishColorPalette @bind-Value="@MyColor" OnChange="@OnChangeHandler">
</SunfishColorPalette>
...
<SunfishColorPalette Value="@MyColor" ValueChanged="@ValueChangedHandler">
</SunfishColorPalette>
...
<SunfishColorPalette @bind-Value="@MyColor" OnBlur="@OnBlurHandler">
</SunfishColorPalette>
