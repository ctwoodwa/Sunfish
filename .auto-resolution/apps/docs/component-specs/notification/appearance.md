...
tags: sunfish,blazor,notification,appearance
published: True
position: 5
...
The `AnimationType` parameter controls the way the Notification will appear on the screen. It takes a member of the `Sunfish.Blazor.AnimationType` enum:
...
You can see them in action in the [Notification Animation](https://demos.sunfish.dev/blazor-ui/notification/animation) Live Demo.
...
<SunfishButton OnClick="@AddNotification">Add a basic notification</SunfishButton>

<SunfishNotification @ref="@NotificationReference" AnimationType="@AnimationType.ZoomOut"></SunfishNotification>
...
You can control the Size of the Notification by using CSS. To make the cascading of the styles easier and target a single instance of the component you should use the `Class` parameter exposed in the `<SunfishNotification>` tag.

>caption Change the Notification width and height

````RAZOR
<SunfishNotification @ref="@NotificationRef1"
                     Class="large-notification-center">
</SunfishNotification>

<SunfishNotification @ref="@NotificationRef2"
                     Class="large-notification-top">
</SunfishNotification>

Show a Notification and the content will be ...

<SunfishButton OnClick="@( () => ShowNotification(NotificationRef1, "Vertically centered text") )">
    Vertically Centered
</SunfishButton>

<SunfishButton OnClick="@( () => ShowNotification(NotificationRef2, "Text at the top") )">
    At the Top
</SunfishButton>
...
@code {
    private SunfishNotification NotificationRef1 { get; set; }

    private SunfishNotification NotificationRef2 { get; set; }

    private void ShowNotification(SunfishNotification notifRef, string text)
    {
...
The color of the notification popup is easily controlled through the `ThemeColor` parameter. You can set it to a member of the `Sunfish.Blazor.ThemeColor` class:
...
These predefined options match the main [Sunfish Theme](slug:themes-overview) and you can see that in action in the [Notification Appearance](https://demos.sunfish.dev/blazor-ui/notification/appearance) Live Demo.
...
<SunfishButton OnClick="@AddColoredNotifications">Add colored notifications</SunfishButton>
...
>caption Custom Notification color without customizing the Sunfish Theme
...
<SunfishButton OnClick="@AddNotification">Add a notification</SunfishButton>

<SunfishNotification @ref="@NotificationReference"></SunfishNotification>
...
<SunfishButton OnClick="@AddBasicNotification">Add a basic notification</SunfishButton>
<SunfishButton OnClick="@AddZIndexNotification">Add a notification with a high z-index</SunfishButton>

<SunfishNotification Class="high-zindex" @ref="@HighZIndexNotification"></SunfishNotification>

<SunfishNotification @ref="@BasicNotification"></SunfishNotification>
...
@code {
    SunfishNotification HighZIndexNotification { get; set; }
    SunfishNotification BasicNotification { get; set; }
...
## See Also
  ...
  * [Live Demo: Notification Appearance](https://demos.sunfish.dev/blazor-ui/notification/appearance)
  * [Live Demo: Notification Animation](https://demos.sunfish.dev/blazor-ui/notification/animation)
