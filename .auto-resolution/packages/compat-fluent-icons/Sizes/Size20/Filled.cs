...
/// <c>Filled</c> (solid) variant. Mirrors Fluent's
/// <c>Microsoft.FluentUI.AspNetCore.Components.Icons.Filled.Size20.*</c> shape so
/// consumers can flip their <c>using</c> directives and keep <c>new Size20.Filled.Home()</c>
...
///
/// Filled variants share the same kebab-case name as their Regular counterparts — the
/// variant distinction is carried by the nested-class path only. The active Sunfish
/// provider may or may not differentiate filled vs. regular visually.
///
